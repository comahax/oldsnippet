			...
			<div class="listboxlist">
				<table class = "tb02" width="100%">
					<tr>
						...
						<td><textarea name="apply.description" class="textarea_01" id="apply.description">${apply.description}</textarea>&nbsp;<font color="#FF0000">*</font></td>
					</tr>
					<tr>
...
<script type="text/javascript" src="${ctx}/js/biz/basic/node/quit.js"></script> 
