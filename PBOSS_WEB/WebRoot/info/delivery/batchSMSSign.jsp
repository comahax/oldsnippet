...
<s:form action="/delivery/batchSMSSign.do" method="POST" id="frmQuery" onsubmit="return doSubmit();">
	<input type="hidden" name="parameter.type" id="" value="2"/>
	<div class="listboxtitle">批量补发签收短信</div>
