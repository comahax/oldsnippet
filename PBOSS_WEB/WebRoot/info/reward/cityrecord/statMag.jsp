...
<div class="column">
	<div class="listboxtitle">网点信息</div>
	<s:if test="parameter.starlevel !=null && parameter.starlevel !=''">
    <table class = "tb_comn" width="100%">
    	<tr align="center">
    		<td>网点编码：<s:property value="parameter.wayid"/>	</td>
    		<td>网点名称：<s:property value="parameter.wayname"/></td>
    		<td>星级：<s:property value="parameter.starlevel"/>	</td>
    	</tr>
    </table>
    </s:if>
</div>
...
<div class="column">
   ...
   <div class="reminder">
   	   <p>1.查询条件中<font color='red'>“渠道编码”必填</font>。</p>
       <s:if test="!parameter.supportPaymonth">
       <p>2.查询条件中<font color='red'>“结算月份”</font>必须为<font color='red'>6位有效年月，必填</font>，如201109。</p>
       </s:if>
       <s:else>
       <p>2.查询条件中<font color='red'>“结算月份”、“付款月份”、“业务发生月”</font>必须为<font color='red'>6位有效年月，不能同时为空</font>，如201109。</p>
       </s:else>
   </div>
</div>
