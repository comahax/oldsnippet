...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/managerView/adjustmentAjax.do" method="POST" id="frmQuery">
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/adjustment/adjustmentstatMag.js"></script>
