...
<body>
	<div class="divspan">
			<s:form action="/gdView/paymentLtypePopAjax.do" method="POST" id="frmQuery">
			<div class="listboxtitle">查询条件</div>
			<table class="tb02" width="100%">
 <tr>
 	<td class="input_label">所属地市：</td>
 	<td><s:select list="cityMap" name="cityid" id="cityid"/></td>
	<td class="input_label">大类名称：</td>
	<td>
	<input name="ltype" id="ltype" class="text_01" onFocus="shover(this,'text_01_02')" onBlur="shover(this,'text_01')" 
				   value="${ltype}" size="22" maxlength="22" />
	</td>
</tr>
<tr>
	...
	<td colspan="5" align="left">
		<input name="btnQuery" type="button" id="btnQuery" value="查询" class="btn_blue_75" onMouseOver="shover(this,'btn_blue_75_02')" onMouseOut="shover(this,'btn_blue_75')"/>
          ...
          <div class="column">
                 ...
                 <div class="reminder">可以根据大类名称模糊查询；默认查询某地市时，结果会包括省的数据 </div>
          </div>
	</div>
</body>
<%@include file="/common/meta_js.jsp"%>
<script type="text/javascript" src="${ctx}/js/jQuery/table/jquery.table.js" ></script>
<script type="text/javascript" src="${ctx}/js/biz/info/reward/payment/ltypeselect.js"></script>
