...
<body>
	<div class="divspan">
			<s:form action="/gdView/paymentWayPopAjax.do" method="POST" id="frmQuery">
...
<tr>
	...
	<td class="input_label" clospan="2">&nbsp;</td>
</tr>
			</table>
			</s:form>
          ...
          <div class="column">
                ...
                <div class="reminder">可以根据渠道名称模糊查询；默认查询某地市时，结果会包括省的数据。 </div>
          </div>
	</div>
</body>
<%@include file="/common/meta_js.jsp"%>
<script type="text/javascript" src="${ctx}/js/jQuery/table/jquery.table.js" ></script>
<script type="text/javascript" src="${ctx}/js/biz/info/reward/payment/wayselect.js"></script>
