...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/reward/rewardAdSucAjax.do" method="POST" id="frmQuery"> 
            ...
            <table class="tb02" width="100%">
			  <tr>
				...
				<td>
					<s:select list="dictItem" cssClass="select_3L" name="parameter.rewardtype" id="parameter.rewardtype"/></select>	
				</td> 
			 </tr>
			 <tr> 
				<td class="input_label" align="right">结算月份：</td>
				<td> 
					<select name="parameter.rewardmonth" class="select_3L" id="rewardmonth" orgval="${parameter.rewardmonth}"></select> <font color='red'>*</font> </td>
		  ...
		  <tr> <td colspan="8"  align="center">
            ...
            <div class="column">
                 <div class="listboxtitle">功能说明：</div>
                   <div class="reminder">
      				  <p>1.统计各业务<font color='red'>终端预发计酬成功明细</font>。</p>
    				</div>
               </div>
               <div class="column">
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardadsuc/rewardadsucstat.js"></script>
