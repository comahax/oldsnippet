...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/reward/rewardTdFailAjax.do" method="POST" id="frmQuery"> 
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardtdfail/rewardtdfailstat.js"></script> 
