...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/gdView/rewardTdFailAjax.do" method="POST" id="frmQuery"> 
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardtdfail/rewardtdfailGdstat.js"></script> 
