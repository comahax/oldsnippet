...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/reward/rewardTdRecordAjax.do" method="POST" id="frmQuery"> 
            ...
            <div class="column">
                 <div class="listboxtitle">功能说明：</div>
                   <div class="reminder">
      				  <p>1.统计各业务<font color='red'>终端计酬成功数据汇总</font>。</p>
    				</div>
               </div>
               <div class="column">
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardtdrecord/rewardtdrecordstat.js"></script>
