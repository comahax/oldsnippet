...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/reward/rewardTdSucAjax.do" method="POST" id="frmQuery"> 
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardtdsuc/rewardtdsucstat.js"></script>
