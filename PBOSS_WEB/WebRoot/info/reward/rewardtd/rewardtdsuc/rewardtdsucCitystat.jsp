...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/cityView/rewardTdSucAjax.do" method="POST" id="frmQuery"> 
            ...
            <table class="tb02" width="100%">
			 ...
			 <tr> 
				...
				<td class="input_label" align="right">补算月份：</td>
				<td> 
		  ...
		  <tr>
            ...
            <div class="column">
                 <div class="listboxtitle">功能说明：</div>
                   <div class="reminder">
      				  <p>1.统计各业务<font color='red'>终端计酬成功明细</font>。</p>
    				</div>
               </div>
               <div class="column">
                 <div class="listboxtitle">温馨提醒：</div>
                    <div class="reminder">
				       <p>1.查询条件中<font color='red'>“结算月份”、“补算月份” 不能同时为空</font>。
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/rewardtdsuc/rewardtdsucCitystat.js"></script>
