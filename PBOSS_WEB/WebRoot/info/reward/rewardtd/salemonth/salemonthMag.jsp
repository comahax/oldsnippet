...
<%@ include file="/common/include/inc_menu.jsp"%>
        <div class="context">
			...
			<s:form action="/managerView/saleMonthAjax.do" method="POST" id="frmQuery"> 
...
<script type="text/javascript" src="${ctx}/js/biz/info/reward/rewardtd/salemonth/saleMonthMag.js"></script> 
