...
<tr>
	...
	<td colspan="5" align="left">
		...
		<input name="btnRest" type="reset" id="btnQuery" value="重置" class="btn_blue_75" />
			...
			<div class="listboxtitle">店员选择列表</div>
...
//<!--
// 查询显示列信息
var showCols = ${ShowColsPopupTab};//取后台列设置类数组，对应如下  //dataKey,key,name,width
//表格配置数组
var optin = {
