...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/registernewcntd/regAjax.do" method="POST" id="frmQuery">
            ...
            <br>
            <input type="button" class="btn_blue"  onclick="location='/registernewcnt/list.do'" value="返回新业务销售汇总查询" />
            <!--帮助信息开始-->
            <div class="column">
...
<script type="text/javascript" src="${ctx}/js/biz/info/registernewcnt/registernewList.js"></script>
