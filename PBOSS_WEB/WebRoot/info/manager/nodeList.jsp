...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/managerView/Ajax_nodeList.do" method="POST" id="frmQuery">
...
<form name="doQuit" action="/assistant/Quit.do" method="post">
 ...
 <form name="doAction" method="post">
 	<input type="hidden" name="wayid" id="wayid">
 </form>
</body>
...
<script type="text/javascript" src="${ctx}/js/info/manager/nodeList.js"></script>
