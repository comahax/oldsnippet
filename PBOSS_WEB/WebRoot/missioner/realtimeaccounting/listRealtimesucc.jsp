...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/missioner/realtimesuccAjax.do" method="POST" id="frmQuery">
            	...
            	<tr>
            		<td class="input_label">推荐业务名称：</td>
					<td>
...
<script type="text/javascript" src="${ctx}/js/biz/info/missioner/realtimeaccounting/realtimesucc.js"></script>
