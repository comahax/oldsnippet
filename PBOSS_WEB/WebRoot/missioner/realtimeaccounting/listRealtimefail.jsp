...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/missioner/realtimefailAjax.do" method="POST" id="frmQuery">
...
<script type="text/javascript" src="${ctx}/js/biz/info/missioner/realtimeaccounting/realtimefail.js"></script>
