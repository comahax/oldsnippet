...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/missioner/listAgency.do" method="POST" id="frmQuery">
            	...
            	<tr>
					...
					<td>
						<s:textfield cssClass="style_input" name="parameter.oprcode" id="oprcode"/>
					</td>
					<td class="input_label">成员属性：</td>
					<td>
						<s:select list="empattr2" cssStyle="width:130px" name="parameter.empattr2" id="empattr2"></s:select>
					</td>
				</tr>
...
<script type="text/javascript" src="${ctx}/js/biz/info/missioner/recommend/successListAgency.js"></script>
<SCRIPT type="text/javascript">
//<!--
// 查询显示列信息
var showCols = ${ShowCols2};//取后台列设置类数组，对应如下  //dataKey,key,name,width
//表格配置数组
var optin = {
