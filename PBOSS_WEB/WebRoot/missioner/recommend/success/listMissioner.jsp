...
<body>
	...
	<div class="divspan">
        ...
        <div class="context">
			...
			<s:form action="/missioner/listMissioner.do" method="POST" id="frmQuery">
				<div class="listboxtitle">查询条件</div>
            	<table class="tb02" width="100%">
            	
            	<tr>
					<td class="input_label">所属代理商编码：</td>
					<td>
						<s:textfield cssClass="style_input" name="parameter.wayid" id="wayid"/>
					</td>
					<td class="input_label">所属代理商名称：</td>
					<td>
...
<script type="text/javascript" src="${ctx}/js/biz/info/missioner/recommend/successListMissioner.js"></script>
<SCRIPT type="text/javascript">
//<!--
// 查询显示列信息
var showCols = ${ShowCols1};//取后台列设置类数组，对应如下  //dataKey,key,name,width
//表格配置数组
var optin = {
