...
<input type="hidden" name="parameter.type" id="advType" value="<%=CPDictionary.KNOWLEDGE %>" />
</s:form>
...
<script type="text/javascript" src="${ctx}/js/biz/communi/knowledge/knowledgeInfos.js"></script>
