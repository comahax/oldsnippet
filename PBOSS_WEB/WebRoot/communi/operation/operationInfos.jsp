...
<input type="hidden" name="parameter.type" id="advType" value="<%=CPDictionary.OPERATIONINFO %>" />
</s:form>
...
<script type="text/javascript" src="${ctx}/js/biz/communi/operation/operationInfos.js"></script>
<SCRIPT type="text/javascript">
<!--
// 查询显示列信息
var showCols = ${afficheColsString};//取后台列设置类数组，对应如下  //dataKey,key,name,width
//表格配置数组
var optin = {
