...
<input type="hidden" id="advType" name="parameter.type" value="<%=CPDictionary.AFFICHE %>" />
</s:form>
...
<script type="text/javascript" src="${ctx}/js/biz/communi/affiche/afficheInfos.js"></script>
