...
/**
 * ChBbcWebfail entity. @author MyEclipse Persistence Tools
 */

public class BbcWebFail extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public BbcWebFail(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public BbcWebFail(Long seq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime,
