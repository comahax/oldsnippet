...
import com.gmcc.pboss.biz.info.reward.dao.BbcWebeGflDao;
import com.gmcc.pboss.biz.info.reward.model.BbcWebeGfl;
import com.gmcc.pboss.biz.info.reward.support.RewardFailQueryParameter;

public class BbcWebeGflDaoHibernate extends AbstractFailDaoHibernate implements BbcWebeGflDao {

	public BbcWebeGflDaoHibernate() {
		super(BbcWebeGfl.class);
	}
	...
	final String lsql = "SELECT " + fields + " FROM CH_BBC_WEBEGFL " +
			"WHERE adtflag in (:adtflag,:adtflag2) and calcmonth = :calcmonth and wayid = :wayid and opnid = :opnid " +
			"UNION SELECT " + fields + " FROM CH_BBC_WEBEGFLHIS " +
					"WHERE adtflag in (:adtflag,:adtflag2) and calcmonth = :calcmonth and wayid = :wayid and opnid = :opnid";
	final String ssql = "SELECT " + fields + " FROM CH_BBC_WEBEGFL " +
