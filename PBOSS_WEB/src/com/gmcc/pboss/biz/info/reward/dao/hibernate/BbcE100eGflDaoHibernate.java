...
import com.gmcc.pboss.biz.info.reward.dao.BbcE100eGflDao;
import com.gmcc.pboss.biz.info.reward.model.BbcE100eGfl;
import com.gmcc.pboss.biz.info.reward.support.RewardFailQueryParameter;

public class BbcE100eGflDaoHibernate extends AbstractFailDaoHibernate implements BbcE100eGflDao {

	public BbcE100eGflDaoHibernate() {
		super(BbcE100eGfl.class);
	}
	...
	final String lsql = "SELECT " + fields + " FROM CH_BBC_E100EGFL " +
			"WHERE adtflag in (:adtflag,:adtflag2) and calcmonth = :calcmonth and wayid = :wayid and opnid = :opnid " +
			"UNION SELECT " + fields + " FROM CH_BBC_E100EGFLHIS " +
					"WHERE adtflag in (:adtflag,:adtflag2) and calcmonth = :calcmonth and wayid = :wayid and opnid = :opnid";
	
	final String ssql = "SELECT " + fields + " FROM CH_BBC_E100EGFL " +
