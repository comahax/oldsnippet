...
/**
 * ChBbcSellfail entity. @author MyEclipse Persistence Tools
 */

public class BbcSellFail extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public BbcSellFail(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public BbcSellFail(Long seq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime,
