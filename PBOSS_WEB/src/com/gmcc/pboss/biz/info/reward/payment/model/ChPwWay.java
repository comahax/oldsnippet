...
public class ChPwWay {
	...
	/** minimal constructor */
	public ChPwWay(String wayid) {
		this.wayid = wayid;
	}

	/** full constructor */
	public ChPwWay(String wayid, String shortname, String svbrchcode,
			String svccode, String mareacode, Byte buztypecode,
			Byte adtypecode, String address, String logiscode, String latitude,
			String longtitude, String adacode, String waymagcode,
			Byte catetype, Byte formtype, Date starttime, Integer buzarea,
			Byte mainlayer, Byte sublayer, String buzphoneno, String wayname,
			Byte cooperator, String waytype, String waysubtype,
			String custtype, String upperwayid, String busicode,
			String countyid, String cityid, String centerid, Short citylevel,
			Short waylevel, String bchlevel, String function, String miscode,
			Date createtime, Date disabletime, Short waystate,
			String runbyself, String depotdet, String isshare,
			Long alarmbizamount, Byte prtsource, Byte isconnected,
			Byte connecttype, Byte runmode, Byte iscoreway, Byte starlevel,
			Byte pt, String chainhead, Byte signstatus, Short empnumber,
			Short magnumber, Short terminumber, Date updatedate,
			Byte isstraitprd, Byte taxtype) {
		this.wayid = wayid;
