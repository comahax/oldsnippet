...
/**
 * ChAdtSimfail entity. @author MyEclipse Persistence Tools
 */

public class SimFail extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public SimFail(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public SimFail(Long seq, Long fileseq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Boolean brand,
