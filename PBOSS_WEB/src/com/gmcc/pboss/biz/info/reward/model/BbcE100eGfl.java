...
/**
 * ChBbcE100egfl entity. @author MyEclipse Persistence Tools
 */

public class BbcE100eGfl extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public BbcE100eGfl(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public BbcE100eGfl(Long seq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime,
