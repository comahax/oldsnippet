...
/**
 * ChBbcWebegfl entity. @author MyEclipse Persistence Tools
 */

public class BbcWebeGfl extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public BbcWebeGfl(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public BbcWebeGfl(Long seq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime,
