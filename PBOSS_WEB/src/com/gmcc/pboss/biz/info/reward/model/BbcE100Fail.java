...
/**
 * ChBbcE100fail entity. @author MyEclipse Persistence Tools
 */

public class BbcE100Fail extends DefaultSetFailModelSetParameter implements FailModelSetParameter, java.io.Serializable {
	...
	/** minimal constructor */
	public BbcE100Fail(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public BbcE100Fail(Long seq, String cityid, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime,
