...
/**
 * ChPwEmployee entity. @author MyEclipse Persistence Tools
 */
...
public class Employee implements java.io.Serializable {
	...
	/** full constructor */
	public Employee(String employeeid, String oprcode, String employeename, Date birthday, Short sex, Short edulevel, String nativehome, Short polivisage,
			String department, String servoffice, Long station, Short joblevel, Date intime, Short worktime, Short hereworktime, Short employtype,
			String company, String telephone, String officetel, Date outtime, String outresult, String homeaddr, String cardid, String wayid, String waytype,
			String pvtemail, String ofcphone, String ofcemail, String speciality, String cityid, String countyid, String svccode, String posittype,
			Byte contacttype, Byte empstatus, String actbank, String actno, String actname, String actpid, Double bail, String gradschool, Date gradtime,
			Byte ismarried, Byte outreason, String trainlevel, String hobby, String character, String asses, String workhistry, String prizeorpunish,
			String empass, Byte right, Byte isnet, String netpass, Byte isopen, String selectmobile) {
		this.employeeid = employeeid;
	...
	public WayAccount getWayAccount() {
		return wayAccount;
	}

	public void setWayAccount(WayAccount wayAccount) {
	...
	/**
	 * @param cooperator the cooperator to set
	 */
	public void setCooperator(ChDstCooperator cooperator) {
