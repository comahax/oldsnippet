...
import com.gmcc.pboss.biz.info.salesDetail.support.RegistersimQueryParamProcessor;
...
public class RegistersimServiceImpl extends BaseServiceImpl implements
		RegistersimService {
	/**
	 * 构造器：给ServiceCode与ServiceName赋值
	 */
	public RegistersimServiceImpl(){
		super();
		this.serviceCode = ServiceCode.REGISTER_SIM_QUERY;
		this.serviceName = "套卡销售明细查询";
	...
	public ServiceResult query(LoginMember member, QueryParameter parameter) {		
		...
		//查询条件处理器
		this.setProcessor(new RegistersimQueryParamProcessor());
