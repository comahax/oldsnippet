...
public class AgencyQueryParamProcessor extends DefaultHqlQueryProcessor
	...
	public String getHql(QueryParameter parameter) {
		...
		hql.append(" and d.wayid =:wayid " );//代理商
		
		if(p.getOprcode() != null && !"".equals(p.getOprcode())){//专员号码
			hql.append(" and d.oprcode =:oprcode " );
		}
		
		if(p.getEmpattr2() != null && !"".equals(p.getEmpattr2())){//成员属性
		...
		hql.append(" and v.wayid =:wayid " );//代理商
	...
	public void process(Query query, QueryParameter parameter) {
		...
		query.setString("wayid", p.getWayidAgency());//代理商
