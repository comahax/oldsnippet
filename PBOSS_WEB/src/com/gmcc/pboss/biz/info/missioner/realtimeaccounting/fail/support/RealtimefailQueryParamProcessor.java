...
public class RealtimefailQueryParamProcessor extends DefaultHqlQueryProcessor
		implements QueryParameterProcessor {

	@Override
	public String getHql(QueryParameter parameter) {
		// TODO Auto-generated method stub
		RealtimefailQueryParameter param = (RealtimefailQueryParameter)parameter;
		StringBuilder sb = new StringBuilder();
		sb.append("select s.seq,s.oprcode,s.wayid,s.mobile,o.name,s.opnid,to_char(s.oprtime,'yyyy-MM-dd')");
		sb.append(" from ch_bbc_operation o,ch_bbc_realtimefail s");
