package com.gmcc.pboss.model.reward.chbbcrealtimefail;

import java.util.Date;

import com.gmcc.pboss.common.bean.BaseModel;

public class Chbbcrealtimefail  extends BaseModel {
    // Fields    
     private Long seq;
    ...
    /** default constructor */
    public Chbbcrealtimefail() {
    }

	/** minimal constructor */
    public Chbbcrealtimefail(Long seq) {
        this.seq = seq;
    }
    
    /** full constructor */
    public Chbbcrealtimefail(Long seq, String opnid, String wayid, String oprcode, Date oprtime, String mobile, Double busivalue, Date creattime, String src, String calcopnid, String calcmonth, String ruleid, String srcseq, Byte ossrc, String adtremark) {
        this.seq = seq;
        this.opnid = opnid;
        this.wayid = wayid;
