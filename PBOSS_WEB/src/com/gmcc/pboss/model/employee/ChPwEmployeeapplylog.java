...
/**
 * ChPwEmployeeapplylog entity. @author MyEclipse Persistence Tools
 */

public class ChPwEmployeeapplylog extends
	...
	/** default constructor */
	public ChPwEmployeeapplylog() {
	}

	/** minimal constructor */
	public ChPwEmployeeapplylog(Long applyno, String wayid) {
		this.applyno = applyno;
		this.wayid = wayid;
	}

	/** full constructor */
	public ChPwEmployeeapplylog(Date opntime, String opncode, String oprtype,
			Long applyno, Date optime, Byte auditstatus, String description,
