...
/**
 * ChPwWayapplylog entity. @author MyEclipse Persistence Tools
 */

public class ChPwWayapplylog extends com.gmcc.pboss.common.bean.CodeReverse
	...
	/** default constructor */
	public ChPwWayapplylog() {
	}

	/** minimal constructor */
	public ChPwWayapplylog(Long logid) {
		this.logid = logid;
	}

	/** full constructor */
	public ChPwWayapplylog(Long logid, Date opntime, String opncode,
			String oprtype, Long applyno, Date optime, Byte auditstatus,
			String description, String wayid, String wayname,
			String waysubtype, String upperwayid, Byte starlevel, Byte pt,
			Short waystate, String cityid, String countyid, String svccode,
			String mareacode, Byte isstraitprd, Byte adtypecode,
			String adacode, Byte formtype, Date starttime, Integer buzarea,
			String logiscode, String waymagcode, String bchlevel,
			String officetel, Long alarmbizamount, String address,
			String latitude, String longtitude, String principal,
			String principaltel, String principalphone, String principalemail,
			String sendaddr, String acctno, String acctname, String bankname,
			String acctfid, String deacctno, String deacctname,
			String debankname, Short accttype, Date intime, Byte catetype,
			String chainhead, String recpers, String recconntel,
			String reccertno, Byte signstatus, String provcode, Byte bailtype,
			Short servbound, String compactno, String compactname,
			Date begintime, Date endtime, Date signtime, Byte compacttype,
			String licenceno, Double bail, Double baillwrlmt, Date licvalidate,
			Byte bailstatus, Boolean isb2m, String smsmobileno) {
		this.logid = logid;
