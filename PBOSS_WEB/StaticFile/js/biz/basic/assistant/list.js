function doLoadEmployee(o){
	...
	document.doAction.action = "/assistant/Load.do";
	document.doAction.submit();
	//document.doLoad.submit();
}
function doQuitEmployee(o){
	f_setValueById("employeeid",o);
	document.doAction.action = "/assistant/Quit.do";
	document.doAction.submit();
	//document.doQuit.submit();
}
...
var fmtLink = function(elCell, oRecord, oData,oColumnSet) {
	...
	if(oColumnSet.key=="oper"){
		rtn = "<a href=\"javascript:doLoadEmployee('"+ o +"')\">查看</a>|" + 
			  "<a href=\"javascript:doQuitEmployee('"+ o +"')\">申请退出</a>";
	}
	return rtn;
}
