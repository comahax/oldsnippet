...
var fmtLink = function(elCell, oRecord, oData,oColumnSet) { 
	...
	if(oColumnSet.key=="title"){
		rtn = "<a href=\"javascript:f_openDetl('"+ contextRootPath +"/interlocution/showInterlocution.do?parameter.advinfoid="+
		 oRecord.advinfoid +"&parameter.type="+$("#advType").val()+"','我的提问');\" >"+ oData +"</a>";
	}
