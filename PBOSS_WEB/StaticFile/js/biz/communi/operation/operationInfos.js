...
var fmtLink = function(elCell, oRecord, oData,oColumnSet) { 
	...
	if(oColumnSet.key == "title"){
		rtn = "<a href=\"javascript:f_openDetl('"+ contextRootPath +"/communi/showOperation.do?parameter.advinfoid="+
		 oRecord.advinfoid +"&parameter.type="+$("#advType").val()+"','业务信息');\" >"+ oData +"</a>";
	}
