...
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    */
    ...
    /**
     * ï¿½ï¿½ï¿½Ø¶ï¿½ï¿½Ö·ï¿½ï¿½ï¿½ï¿½Ø¶ï¿½ï¿½Ö¸ï¿½ï¿½Ö¸ï¿½ï¿½ï¿½ï¿½ï¿½ï¿\uFFFD
    ...
    /**
     *ï¿½Ð¶ï¿½Ò»ï¿½ï¿½ï¿½Ö·ï¿½ï¿½Ç·ï¿½Îªnullï¿½ï¿½ï¿½Ç¿ï¿½ï¿½Ö·ï¿½<p>
     *
    ...
    /**
     * ï¿½ï¿½ï¿½Ö·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ö¸ï¿½ï¿½ï¿½ï¿½ï¿½È·ï¿½Î§ï¿½ï¿\uFFFD
    ...
    /**
     * Ä£ï¿½ï¿½Æ¥ï¿½ä£¬desÎªÇ°ï¿½ï¿½ï¿½Ð£ï¿½ï¿½ï¿½ï¿½ï¿½Ê½
     * @param src String
     * @param dec String
     * @return boolean
     */
    public static boolean blurEquals(String src, String dec) {
      ...
      if (dec.startsWith("%") && dec.endsWith("%")) { //Ç°ï¿½ï¿½ï¿½Ð£ï¿½
    ...
    /**
     * ï¿½ï¿½ï¿½Ö·ï¿½ï¿½ISOï¿½ï¿½Ê½×ªï¿½ï¿½Îªgb2312ï¿½ï¿½Ê½
     * @param str
     * @return
     */
    ...
    /**
     * ï¿½ï¿½ï¿½Ö·ï¿½ï¿½gb2312ï¿½ï¿½Ê½×ªï¿½ï¿½ÎªISOï¿½ï¿½Ê½
     * @param str
     * @return
     */
...
//    		throw new Exception("ÊÖ»úºÅ°üº¬×ÖÄ¸£¡");
    	}
    	return result;
    }
    
    /**
     * ÖØÃüÃûisValuedString,Í¬apacheÒ»ÖÂ
     * @param str
     * @return
     * @author Canigar
     */
	...
	public static String[] split(String str, String split) {
		...
		return StringSplit.split(newStr, "|");
	}
	
	private static String setNewSbatch(String lastSbatch) {
		String newSbatch = "";
		String sbatchSeq = "000001";
		String yyyymmdd = DateUtil.getDateYMD();
		if (StringUtils.isNotEmpty(lastSbatch)) {
			if(lastSbatch.length() == 14){
				String sbatchYmd = lastSbatch.substring(0, 8);
				if(sbatchYmd.equals(yyyymmdd)){
	...
	public static void main(String[] args) {
		String lastSbatch = "20150919000005";
		System.out.println(setNewSbatch(lastSbatch));
	}
  }
