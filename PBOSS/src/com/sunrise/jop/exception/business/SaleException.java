...
public class SaleException extends RuntimeException {
	...
	private Long montimes; // 月订购次数
	
	private Long monmaxtimes; // 月最大订购次数

	private String starlevelname; // 星级
	
	private Object rtnObject;	//回传action的对象（可以为List、Map等集合）
	...
	public void setRtnObject(Object rtnObject) {
