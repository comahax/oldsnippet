...
public class WayacctlogVO extends BaseVO implements Serializable {
    ...
    /** minimal constructor */
    public WayacctlogVO(java.lang.Long logid, java.util.Date optime, java.lang.String oprcode, java.lang.String oprtype) {
        this.logid = logid;
        this.optime = optime;
        this.oprcode = oprcode;
        this.oprtype = oprtype;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof WayacctlogVO) ) return false;
