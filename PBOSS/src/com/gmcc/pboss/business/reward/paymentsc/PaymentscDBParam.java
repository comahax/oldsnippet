 ...
 * @version 1.0
 */
public class PaymentscDBParam extends DBQueryParam {
	...
	private String _se_settleperiods;
	...
	public String get_se_settleperiods() {
		return _se_settleperiods;
	}

	public void set_se_settleperiods(String _se_settleperiods) {
		this._se_settleperiods = _se_settleperiods;
	}

	public String get_se_paysum() {
		return _se_paysum;
	}

	public void set_se_paysum(String _se_paysum) {
		this._se_paysum = _se_paysum;
	}
