 ...
 * @version 1.0
 */
public class ActivedetailDBParam extends DBQueryParam {
    ...
    private String _dnm_acttime;
    private String _dnl_acttime;
    private String _se_comcategory;
    private String _snm_stocktime;
    private String _snl_stocktime;
    private String _dnm_createtime;
    private String _dnl_createtime;
    private String _dnm_statisticstime;
    private String _dnl_statisticstime;
    ...
    public String get_se_upperwayid() {
        return this._se_upperwayid;
    }
    /**
     * @param _sk_companyname The _se_upperwayid to set.
     */
	...
	/**
     * @return Returns the _se_waymagcode.
     */
    public String get_se_waymagcode() {
        return this._se_waymagcode;
    }
    /**
     * @param _sk_companyname The _se_waymagcode to set.
     */
	...
	/**
     * @return Returns the _dnm_acttime.
     */
    public String get_dnm_acttime() {
        return this._dnm_acttime;
    }
    /**
     * @param _sk_companyname The _dnm_acttime to set.
     */
    public void set_dnm_acttime(String _dnm_acttime) {
        this._dnm_acttime = _dnm_acttime;
    }

	/**
     * @return Returns the _dnl_acttime.
     */
    public String get_dnl_acttime() {
        return this._dnl_acttime;
    }
    /**
     * @param _sk_companyname The _dnl_acttime to set.
     */
    public void set_dnl_acttime(String _dnl_acttime) {
        this._dnl_acttime = _dnl_acttime;
    }
	...
	/**
     * @return Returns the _snm_stocktime.
     */
    public String get_snm_stocktime() {
        return this._snm_stocktime;
    }
    /**
     * @param _sk_companyname The _snm_stocktime to set.
     */
    public void set_snm_stocktime(String _snm_stocktime) {
        this._snm_stocktime = _snm_stocktime;
    }

	/**
     * @return Returns the _snl_stocktime.
     */
    public String get_snl_stocktime() {
        return this._snl_stocktime;
    }
    /**
     * @param _sk_companyname The _snl_stocktime to set.
     */
    public void set_snl_stocktime(String _snl_stocktime) {
        this._snl_stocktime = _snl_stocktime;
    }
	...
	/**
     * @return Returns the _dnm_statisticstime.
     */
    public String get_dnm_statisticstime() {
        return this._dnm_statisticstime;
    }
    /**
     * @param _sk_companyname The _dnm_statisticstime to set.
     */
    public void set_dnm_statisticstime(String _dnm_statisticstime) {
        this._dnm_statisticstime = _dnm_statisticstime;
    }

	/**
     * @return Returns the _dnl_statisticstime.
     */
    public String get_dnl_statisticstime() {
        return this._dnl_statisticstime;
    }
    /**
     * @param _sk_companyname The _dnl_statisticstime to set.
     */
    public void set_dnl_statisticstime(String _dnl_statisticstime) {
        this._dnl_statisticstime = _dnl_statisticstime;
    }
