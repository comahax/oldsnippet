...
public class AlarmsetTaskBean extends BaseBatchTaskBean {

	public AlarmsetTaskBean() throws Exception {
		super.setBatchName("套卡库存预警设置批量导入");
		super.setOprtype("导入");
		super.setWriteLog(true);
	}

	protected String doStart() {
		return "套卡库存预警设置批量导入结果  \r\n";
	}
	...
	protected ResultVO processLine(String line, int rowCount) {
		...
		try {
			...
			String s [] = items[2].split(",");//"套卡品牌不正确";
			...
			orderuplimitVO.setBrand(items[2]);
			...
			orderuplimitVO.setRestype("COMRESSMP");
			...
			param3.set_se_brand(items[2]);
			param3.set_se_limitmode("STOCKALARM");
			param3.set_se_restype("COMRESSMP");
