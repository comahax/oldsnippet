...
public class SalesmplistTaskBean extends BaseBatchTaskBean {

	public SalesmplistTaskBean() throws Exception {
		super.setBatchName("网点套卡销售量统计批量导出");
		super.setOprtype("导出");
	...
	protected String doStart() {
		return "序号|分公司|服务销售中心|微区域|网点编码|网点名称|星级|品牌|商品种类|销售数量|上级渠道|所属渠道经理\r\n";
	}
	...
	public void doProcessFile(String fileInPath, String fileOutPath)
		...
		try {
			...
			DataPackage dp = snptbo.doQuerySalesSmplistBatchExp(params);
			...
			for (int i = 0; i < list.size(); i++) {
				...
				fos.write((i+1) + "|" + Code2NameUtils.code2Name("#CNTYCOMPANY", (vo.getCountyid() == null ? "" : vo.getCountyid()), user.getCityid())
					...
					+ "|" + (vo.getWaymagcode() == null ? "" : vo.getWaymagcode()) + "\r\n");
			}
