...
public class SalerecordsmpTaskBean extends BaseBatchTaskBean {

	public SalerecordsmpTaskBean() throws Exception {
		super.setBatchName("网点套卡销售量明细批量导出");
		super.setOprtype("导出");
	...
	protected String doStart() {
		return "序号|套卡号码|销售时间|分公司|服务销售中心|微区域|订单编码|网点编码|网点名称|星级|品牌|商品种类|SIM卡号|上级渠道|所属渠道经理\r\n";
	}
