...
import com.huawei.boss.webservice.loginauth.LoginAuthService;
...
public class NewLoginCheck extends AbstractLoginCheck {
	public static final Logger log = Logger.getLogger(NewLoginCheck.class);
	/**
	 * 登陆方式查询
	 * 入参:
