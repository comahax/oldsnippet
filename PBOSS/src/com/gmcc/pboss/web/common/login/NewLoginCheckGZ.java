...
import com.huawei.boss.webservice.loginauth.LoginAuthServiceGZ;
...
public class NewLoginCheckGZ extends AbstractLoginCheck {
	public static final Logger log = Logger.getLogger(NewLoginCheckGZ.class);
	/**
	 * 登陆方式查询
	 * 入参:
	...
	public Result doQueryUserType(User user) throws Exception {
		...
		LoginAuthServiceGZ service=new LoginAuthServiceGZ();
