...
import com.huawei.boss.webservice.loginauth.LoginAuthServiceDG;
...
public class NewLoginCheckDG extends AbstractLoginCheck {
	public static final Logger log = Logger.getLogger(NewLoginCheckDG.class);
	/**
	 * 登陆方式查询
	 * 入参:
	...
	public Result doQueryUserType(User user) throws Exception {
		...
		LoginAuthServiceDG service=new LoginAuthServiceDG();
