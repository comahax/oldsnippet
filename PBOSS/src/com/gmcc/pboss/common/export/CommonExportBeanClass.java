...
import com.gmcc.pboss.web.sales.orderlog.OrderlogAction;
 ...
 * 
 */
public class CommonExportBeanClass extends ExportDataCreator {
	...
	public final static int EXCELOUT_PAGE_SIZE = 10000;

	public CommonExportBeanClass(User user) {
		super(user);
	}
	...
	public void buildExcelPage(BaseVO actionForm, HttpServletRequest request,
			HttpServletResponse response, User user, OrderlogAction action)
			throws Exception {
