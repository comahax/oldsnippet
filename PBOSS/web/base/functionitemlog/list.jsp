...
<s:form action="functionitemlog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/base/functionitemlog_list.do');">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('rltguiobjid')"><s:text name="rltguiobjid"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('addedinfo')"><s:text name="addedinfo"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('tiptext')"><s:text name="tiptext"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('subsystemid')"><s:text name="subsystemid"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('guitype')"><s:text name="guitype"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('recdefid')"><s:text name="recdefid"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                    ...
                    <td><s:property value="logid"/></td>
                     ...
                     <td><s:property value="rltguiobjid" /></td>
                     <td><s:property value="addedinfo" /></td>
                     <td><s:property value="tiptext" /></td>
                     <td><s:property value="subsystemid" /></td>
                     <td><s:property value="guitype" /></td>
                     <td><s:property value="recdefid" /></td>
                     <td><s:property value="sortorder" /></td>
                     <td><s:property value="createdate" /></td>
                     <td><s:date name="statusdate" format="yyyy-MM-dd HH:mm:ss "/></td>
