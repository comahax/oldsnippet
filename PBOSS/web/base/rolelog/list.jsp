...
<s:form action="rolelog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/base/rolelog_list.do');">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('rolename')"><s:text name="rolename"/></j:orderByImg>                 
                </td>
                <td>
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('isback')"><s:text name="isback"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><j:code2Name definition="$IM_YESNO10" code="ispublic" /></td>
                     ...
                     <td><j:code2Name definition="$IM_YESNO10" code="isback" /></td>
