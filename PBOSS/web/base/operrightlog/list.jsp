...
<s:form action="operrightlog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/base/operrightlog_list.do');">
                   </s:i18n>
				</td>
			</tr>
		</table>
