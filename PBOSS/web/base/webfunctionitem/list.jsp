...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doTxt(){
        	formList.action="<%=contextPath%>/base/webfunctionitem_txt.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/base/webfunctionitem_doListByParent.do";
        }
        function doExcel(){
        	formList.action="<%=contextPath%>/base/webfunctionitem_excel.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/base/webfunctionitem_doListByParent.do";
        }
    </script>
...
<s:form action="webfunctionitem_doListByParent.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	<%//????????????Action?á????????????·???%>
			...
			<tr>
                <td align=right>
                	...
                	<%--<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/base/webfunctionitem_list.do');">
                	--%>
                	<j:purChk permid="<%=ID_ADD%>">
                    <%--
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/base/webfunctionitem_new.do?')"  />
                    --%>
                    ...
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/base/webfunctionitem_delete.do')"> -->
                    </j:purChk>
                   </s:i18n>
                </td>
           </tr>
            ...
            <s:iterator value="dp.datas">
            	...
            	<s:if test="funcid != param._se_parentid">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><a href='<s:url action="webfunctionitem_edit.do">
