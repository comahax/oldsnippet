...
<s:form action="smsobjectlog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/base/smsobjectlog_list.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/base/smsobjectlog_new.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/base/smsobjectlog_delete.do')">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('objecttype')"><s:text name="objecttype"/></j:orderByImg>                 
                </td>
                <td>
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('busitype')"><s:text name="busitype"/></j:orderByImg>                 
                </td>
            </tr>
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><a href='<s:url action="smsobjectlog_edit.do">
