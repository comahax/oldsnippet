...
<html>
	...
	<head>
        ...
        function ev_check() {
            ...
            addfield('param._sk_opername', '<s:text name="opername"/>', 'c', true, '30');
	...
	<body>
		...
		<s:form action="operator_auditRoleList.do?noDjuge=true" key="formList" cssStyle="formList"
						...
						<td>
							<s:i18n name="public">
								<input type="button" id="btnQuery" name="btnQuery"
									...
									onClick="doQuery('/base/operator_auditRoleList.do?noDjuge=true');">
