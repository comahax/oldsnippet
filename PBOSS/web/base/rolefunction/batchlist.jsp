...
<html>
	<head>
        ...
        function doQueryTree(){
        	...
        	var url = contextPath + "/base/rolefunction_batchlist.do?param._desc=0";
        ...
        function doBatchSave(){
        	if(isCheck()){
	        	var url = contextPath + "/base/rolefunction_batchsave.do";
	        	formList.action = url;
	        	formList.submit();
        	}
        }
		...
		<link type="text/css" rel="stylesheet"
			href="<%=contextPath%>/css/button.css" />
		<link type="text/css" rel="stylesheet"
	...
	<body class="list_body"
		...
		<div class="table_container">
			<s:form action="rolefunction_batchlist.do" key="formList"
									...
									<tr class="table_button_list1">
										<td>
											...
											<input type="button" id="btnQuery" name="btnQuery"
												...
												onblur="buttonout(this)" value="查询" onClick="doQueryTree();">
										</td>
									</tr>
								</table>
							</td>
							...
							<tr>
								<td colspan="2" align="right">
									<input type="button" id="btnSave" name="btnSave"
										...
										onmouseout="buttonout(this);" onfocus="buttonover(this)"
										onblur="buttonout(this)" value="授权" onclick="doBatchSave();" />
									<input type="button" id="btnReturn" name="btnReturn"
										class="button_Back" onmouseover="buttonover(this);"
										onmouseout="buttonout(this);" onfocus="buttonover(this)"
										onblur="buttonout(this)" value="返回"
										onclick="doReturn('/base/rolefunction_list.do');">
								</td>
							</tr>
						</table>
					</div>
		...
		<form action="/base/rolefunction_batchJSONlist.do" method="POST" id="frmQuery">
			<s:hidden name="param.queryAll" />
...
<script type="text/javascript" src="/js/jquery.table/jquery.table.js" ></script>
<SCRIPT type="text/javascript">
<!--
//@@声用一定要在使用之前
