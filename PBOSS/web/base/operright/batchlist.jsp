...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doQueryTree(){
        	...
        	var url = contextPath + "/base/operright_batchlist.do?param._desc=0";
        ...
        function doBatchSave(){
        	if(isCheck()){
	        	var url = contextPath + "/base/operright_batchsave.do";
	        	formList.action = url;
	        	formList.submit();
        	}
        }
...
<s:form action="operright_batchlist.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
				...
				<td>
					<table class="table_normal">
						<tr>	
			  			...
			  			<tr>
			  				<td>
			  				令牌名称:<s:textfield cssStyle="style_input" name="queryText" />
			...
			<tr>
				<td colspan="2" align="right">
					...
					<input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="返回" onclick="doReturn('/base/operright_list.do');">
				</td>
			</tr>
		</table>
	</div>
</s:form>
<form action="/base/operright_batchJSONlist.do" method="POST" id="frmQuery">
	<s:hidden name="param.queryAll" />
