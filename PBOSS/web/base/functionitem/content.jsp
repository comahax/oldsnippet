...
<s:form action="functionitem_save.do" cssStyle="formList" key="formItem"
            ...
            <tr>
                <td width="100%" align="right">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/base/functionitem_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>/>
                    </j:purChk>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/base/functionitem_doListByParent.do?param._se_parentid=<s:property value="param._se_parentid"/>')">
					</s:i18n>
                </td>
            </tr>
        </table>
