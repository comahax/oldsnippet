...
<html>
    ...
    comcateNamemap.put('<s:property value="comcategory"/>','<j:code2Name definition="$IM_FXCOMCATEGORY" code="comcategory"/>');
        ...
        function check_adjustScale(){
		 ...
		 //原来的if(parseFloat(packSizeMap.get(keys[i])) != parseFloat(totlaScaleMap.get(keys[i]).toFixed(2))){
							...
							<td width="100%" align="center">
								<s:i18n name="public">
									<input type="button" id="btnSave" name="btnNext"
										...
										onblur="buttonout(this)" value="上一步" onclick="doPrev()" />
									<input type="button" id="btnSave" name="btnNext"
										class="button4" onmouseover="buttonover(this);"
										onmouseout="buttonout(this);" onfocus="buttonover(this)"
										onblur="buttonout(this)" value="下一步" onclick="doNext()" />
								</s:i18n>
							</td>
						</tr>
					</table>
