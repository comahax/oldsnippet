...
<s:form action="simnoactinfo_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.emptyno" maxlength="15"/>
					</s:if>
					<s:else>
            ...
            <tr>
                ...
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.state" maxlength="8"/>
					</s:if>
					<s:else>
            ...
            <tr>
                <td align="right"><s:text name="changetime"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.changetime" maxlength="7"/>
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.changetime" disabled="true"/>
					</s:else>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/resource/simnoactinfo_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/resource/simnoactinfo_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
...
<script language="JavaScript">
	function ev_checkval() {
		...
		addfield('form.emptyno', '<s:text name="emptyno"/>', 'c', true, 15);
		addfield('form.state', '<s:text name="state"/>', 'c', true, 8);
		addfield('form.changetime', '<s:text name="changetime"/>', 't', true, 7);
