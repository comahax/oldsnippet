...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
            addfield('form.comclassid', '<s:text name="comclassid"/>', 'f', false, 6);
            addfield('form.comtype', '<s:text name="comtype"/>', 'f', false, 6);
...
<body>
<s:form action="comtreeshow_save.do" cssStyle="formList" key="formItem"
        ...
        <table class="table_normal">
            <tr>
                ...
                <td align="left">
			        ...
			        <s:else>
						<s:textfield cssStyle="style_input" name="form.comclassid" disabled="true"/>
						<font color=red>*</font>
			        </s:else>
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
			        ...
			        <s:else>
						<s:textfield cssStyle="style_input" name="form.comtype" disabled="true"/>
						<font color=red>*</font>
			        </s:else>
                </td>
            </tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/resource/comtreeshow_save.do')" <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/resource/comtreeshow_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
