    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
	    		...
	    		document.getElementById("importUrl").href="<%=contextPath%>/resource/comrescard_wayidImport.do?filename="+filename+"&beanname=com.gmcc.pboss.web.resource.comrescard.ComrescardWayidTaskBean";
...
<s:form action="/resource/comrescard_wayidUpload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">充值卡批量调拨</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.resource.comrescard.ComrescardWayidCheck">
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr >
                ...
                <td align="left">
					<font color=red>
						13900131039|758000000000000530|WAYF105--|
					</font>
                </td>
            </tr>
             <tr >
                ...
                <td align="left">
					...
					<font color=red>
						注意：该资源操作不能与BOSS同步，需同时在BOSS系统进行相应操作。
					</font>
                </td>
            </tr>
        </table>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.resource.comrescard.ComrescardWayidTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
