...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doExport(actionUrl){
        	...
        	formList.submit();
        	formList.action="<%=contextPath%>/resource/comrescard_stat.do";
        }
...
<s:form action="comrescard_stat.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/resource/comrescard_stat.do');">
                        
                         <input type="button" id="btnPrint" name="btnPrint" class="button_Query" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_print"/>" onClick="doPrint('/resource/comrescard_Print.do')">
                    
                    <input type="button" id="btnexport" name="btnExport" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_export"/>EXCEL" onClick="doExport('/resource/comrescard_statExportExcel.do')">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div id="printPart">
        ...
        <table class="table_style">
			...
			<s:iterator value="dp.datas">
             ...
             <tr class="table_style_content" align="center">
             <td><s:text name="total"/></td><td ></td><td ></td><td ></td><td><s:property value="dp.rowCount"/></td>
             </tr>
        </table>
        </div>
    </div>
