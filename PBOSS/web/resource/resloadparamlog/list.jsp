...
<s:form action="resloadparamlog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
                     <j:selector name="param._se_cityid" definition="#CITYCOMPANY"  condition="citycompid:${USER.cityid}" mode="selector" value="{#session.USER.cityid}" disabled="true"/>
                </td>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/resource/resloadparamlog_list.do');">
