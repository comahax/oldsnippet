    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
	    		...
	    		document.getElementById("importUrl").href="<%=contextPath%>/resource/comressmp_resuseImport.do?filename="+filename+"&beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpResuseTaskBean";
...
<s:form action="/resource/comressmp_resuseUpload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">套卡资源用途批量更新</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.resource.comressmp.ComressmpResuseCheck">
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr >
                <td align="right">资源用途:&nbsp</td>
                <td align="left">
					 <j:selector definition="$IM_FXRESUSE" name="resuse" /><font color=red>*</font>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpResuseTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
