    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
	    		...
	    		document.getElementById("importUrl").href="<%=contextPath%>/resource/comressmp_boxnumImport.do?filename="+filename+"&beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpBoxnumTaskBean";
...
<s:form action="/resource/comressmp_boxnumUpload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">套卡包号批量更新</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.resource.comressmp.ComressmpBoxnumCheck">
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpBoxnumTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
