...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
	    		...
	    		document.getElementById("importUrl").href="<%=contextPath%>/resource/comressmp_storareaImport.do?filename="+filename+"&beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpStorareaTaskBean";
	...
	$(document).ready(function(){ 
        ...
        $(":select[name='storarea']").val('<s:property value="formMap.storarea" />');
   });
    </script>
    <base target="_self">
</head>
...
<s:form action="/resource/comressmp_storareaUpload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea">批量业务</span>
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">套卡库区批量更新</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.resource.comressmp.ComressmpStorareaCheck">
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr >
                ...
                <td align="left">
					 <j:selector definition="$IM_FXSTORAREA" name="storarea" /><font color=red>*</font>
                </td>
            </tr>
            <tr >
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.resource.comressmp.ComressmpStorareaTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
