    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
	    		...
	    		document.getElementById("importUrl").href="<%=contextPath%>/resource/emptysim_wayidImport.do?filename="+filename+"&beanname=com.gmcc.pboss.web.resource.emptysim.EmptysimWayidTaskBean";
...
<s:form action="/resource/emptysim_wayidUpload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">空白SIM卡批量调拨</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.resource.emptysim.EmptysimWayidCheck">
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.resource.emptysim.EmptysimWayidTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
