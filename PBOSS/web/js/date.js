		...
		*/
		...
		strFrame='<style>';
		strFrame+='INPUT.button{BORDER-RIGHT: #006100 1px solid;BORDER-TOP: #006100 1px solid;BORDER-LEFT: #006100 1px solid;';
		strFrame+='BORDER-BOTTOM: #006100 1px solid;BACKGROUND-COLOR: #FFFFFF;font-family:宋体;}';
        ...
        // 控件边框颜色
        strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=182 height=160 bgColor="#FFFFFF" borderColorLight=#006100 borderColorDark="#ffffff"  Author="wayx">';
		...
		strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#B7D7BE style="font-size:12px;cursor: hand;color: #ffffff" ';
		...
		strFrame+='<td width=48 align=center style="font-size:12px;cursor:default" Author=meizz onmouseover="style.backgroundColor=\'#B7D7BE\'" ';
		strFrame+=' onmouseout="style.backgroundColor=\'white\'" onclick="parent.tmpSelectMonthInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';
		strFrame+='        title="点击这里选择月份"><span id=meizzMonthHead Author=meizz></span></td>';
		strFrame+='        <td width=16 bgcolor=#B7D7BE align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
		strFrame+='         onclick="parent.meizzNextM()" title="向后翻 1 月" Author=meizz><b Author=meizz>&gt;</b></td></tr>';
		strFrame+='    </table></td></tr>';
		strFrame+='  <tr Author="wayx"><td width=180 height=25 Author="wayx">';
		strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=006100 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
		strFrame+=' BORDERCOLORLIGHT=#3677b1 bgcolor=#5168C8 BORDERCOLORDARK=#FFFFFF width="100%" height=23 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
		...
		strFrame+='<td width=18 height=20 id=meizzDay'+n+' style="font-size:12px" Author=meizz onclick=parent.meizzDayClick(this.innerText,0)></td>';n++;}
		strFrame+='</tr>';}
		strFrame+='      <tr align=center Author="wayx">';
		for (i=35;i<39;i++)strFrame+='<td width=18 height=20 id=meizzDay'+i+' style="font-size:12px" Author=wayx onclick="parent.meizzDayClick(this.innerText,0)"></td>';
		...
		strFrame+='             Author=meizz align=center title="今天">&nbsp;&nbsp;<input Author=meizz style="cursor:hand"  type=button class=button value=清除 onclick="parent.clearTxt()" ';//////这里添加了清除功能
		strFrame+='             onfocus="this.blur()" title="清除" style="font-size: 12px; height: 20px; cursor:hand"></td><td ';
		...
		{ var da = eval("odatelayer.meizzDay"+i)     //书写新的一个月的日期星期排列
			...
			{ 
				//初始化边框
				da.borderColorLight="#399768";
				da.borderColorDark="#399768";
				...
				da.onmouseover=Function("this.backgroundColor='#000000';this.borderColorDark='#EDF2F8';this.borderColorLight='#EDF2F8';");
				da.onmouseout=Function("this.bgColor='#000000';this.borderColorDark='#EDF2F8';this.borderColorLight='#EDF2F8';");
			}
			else{da.innerHTML="";da.style.backgroundColor="";da.style.cursor="default";da.onmouseover=Function("this.backgroundColor='#000000';this.borderColorDark='#EDF2F8';this.borderColorLight='#EDF2F8';");
				da.onmouseout=Function("this.bgColor='#000000';this.borderColorDark='#EDF2F8';this.borderColorLight='#EDF2F8';");}
		}
		}
