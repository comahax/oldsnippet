...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function ev_check() {
         	...
         	addfield('param._ne_applyno', '<s:text name="applyno"/>', 'i', true, '14');
...
<s:form action="auditwork_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="button_Help" onclick="openword('<s:text name="titleList"/>','<s:text name="helpContentEmployee"/>')"><s:i18n name="public"><s:text name="help"/></s:i18n></span>
		</div>
	</div>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/channel/auditwork_list.do');">
                    </j:purChk>
                   </s:i18n>
				</td>
			</tr>
        ...
        <table class="table_style">
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td>
	                     <s:if test="worktype=='EMPLOYEE_ADD_AUDIT'">
	                     	店员新增审核
	                     </s:if>
	                     <s:elseif test="worktype=='EMPLOYEE_UPDATE_AUDIT'">
	                     	店员修改审核
	                     </s:elseif>
	                     <s:elseif test="worktype=='EMPLOYEE_REMOVE_AUDIT'">
	                     	店员退出审核
	                     </s:elseif>
                     </td>
                     <td>
                    	 <a href='<s:url action="employeeapply_edit.do">
