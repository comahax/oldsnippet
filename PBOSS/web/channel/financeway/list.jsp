...
<html>
	...
	<body class="list_body" onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<s:form action="financeway_list.do" key="formList" cssStyle="formList"
				...
				<div class="table_div">
					<table class="table_normal">
						<tr>
							...
							condition="waytype:EC;wayid:BANK;cityid:${dBAccessUser.cityid}"/>
							</td>
							<td align="center">
								<s:text name="wayname" />:
							</td>
						...
						<tr>
							...
							<td align="left">
							<j:selector name="param._se_waysubtype" definition="FWAYSUBTYPE" />
							</td>
							<td align="center">
							...
							<td>
								<s:i18n name="public">
									...
									<input type="button" id="btnQuery" name="btnQuery"
										...
										onClick="doQuery('/channel/financeway_list.do');">
									<input type="button" id="btnNew" name="btnNew"
										...
										onClick="doNew('/channel/financeway_new.do')">
									<input type="button" id="btnDelete" name="btnDelete"
										...
										onClick="doDelete('/channel/financeway_delete.do')">
							...
							<table class="table_style">
								...
								<s:iterator value="dp.datas">
									<tr class="table_style_content" align="center"
										...
										<td>
											<a href='<s:url action="financeway_edit.do">
										...
										<td>
											<j:code2Name definition="FWAYSUBTYPE" code="waysubtype" />
										</td>
										<td>
										...
										<td>
										 ...
										 <td> <s:date name="disabletime" format="yyyy-MM-dd" /></td>
