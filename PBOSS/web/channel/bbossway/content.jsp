...
<head>
	...
	function ev_checkval() {
		addfield('form.bbosswayid', '<s:text name="bbosswayid"/>', 'c', true, 15);
...
<s:form action="bbossway_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="param._se_bbosswayid"/>
    <s:hidden name="param._sk_bbosswayid"/>
    ...
    <div class="table_div">
        <table class="table_normal">
            <tr>
                <td align="right"><s:text name="bbosswayid"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.bbosswayid" maxlength="15"/>
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.bbosswayid" disabled="true"/>
					</s:else>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/channel/bbossway_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/channel/bbossway_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
