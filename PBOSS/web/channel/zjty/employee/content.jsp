        ...
        <table class="table_normal">
        	...
        	<table class="table_normal">
        	 ...
        	 <tr>
                ...
                <td align="left" width=250px>
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.wayid" maxlength="18" onclick="pshowSelectWay3(this,'form.wayid','','','AG','ZJTY');getCityAndCounty(this.value);"/>
					</s:if>
					<s:else>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/channel/employee_list.do?processType=ZJTY')">
					</s:i18n>
                </td>
            </tr>
        </table>
