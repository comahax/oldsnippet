...
<s:form action="/paydetail/paydetailupload.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data" >
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h">店补明细上传资料管理</span>
		</div>
	</div>
    ...
    <div class="table_div">
        <table class="table_normal">
			...
			<tr>
				...
				<td align="left"><p><font color=red>渠道编码|IMEI/号码|业务月|结算月|</font></p></td>
			</tr>
			<tr>
			...
			<tr>
					...
					<td align=left>
						<a href="<%=contextPath%>/rewards/paydetail/paydetailimport.xls">店补明细上传资料批量导入模板.xls</a>
