...
<html>
	...
	<body>
		<s:form action="ratelog_list.do" name="formList" id="formList" theme="simple">
					...
					<table id="contentTable" class="list_content_table" cellpadding="0" cellspacing="0">					
			            <s:iterator value="dp.datas">
			                 <tr>
			                     ...
			                     <td><a href='<s:url action="ratelog_edit.do">
