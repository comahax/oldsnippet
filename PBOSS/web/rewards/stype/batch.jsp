...
<html>
<head>
	<title>地市公司基础资料管理</title>
	<script language="JavaScript" type="text/JavaScript">
		function checkProcess(){
			var filename=formItem.path.value;
			if(filename != null || filename != ""){
          		formItem.buttonProcess.disabled=true;
	      		window.location.href="<%= contextPath%>/stype/stypebatch.do?filename="+filename+"&beanname=com.gmcc.pboss.web.reward.stype.StypeTaskBean";                                                                                        
			}
		}
		function upload(){
...
<s:form action="/stype/stypeupload.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data" >
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h">地市公司基础资料管理</span>
		</div>
	</div>
	    <input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    <input type="hidden" name="path" value='<s:property value="filepath"/>'>
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.reward.stype.StypeCheck">
    ...
    <div class="table_div">
        <table class="table_normal">
			...
			<tr>
				...
				<td align="left"><p><font color=red>业务类型|酬金大类|酬金小类|</font></p></td>
			</tr>
			<tr>
			...
			<tr>
					...
					<td align=left>
						<a href="<%=contextPath%>/rewards/stype/stypeimport.xls">地市公司基础资料批量导入模板.xls</a>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <s:i18n name="public">
	                        ...
	                        <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   		onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           		value="<s:text name="button_return"/>" onclick="doReturn('/stype/stype_list.do')">
                        </s:i18n>
	                    </td>
	                    </tr>
					</table>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.reward.stype.StypeTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</body>
</html>