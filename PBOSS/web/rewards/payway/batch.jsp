	...
	<script language="JavaScript" type="text/JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/payway/paywaybatch.do?filename="+filename+"&beanname=com.gmcc.pboss.web.reward.payway.PaywayTaskBean";                                                                                        
			}
		}
		function upload(){
...
<s:form action="/payway/paywayupload.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data" >
	<div class="table_top">
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.reward.payway.PaywayCheck">
    ...
    <div class="table_div">
        <table class="table_normal">
			...
			<tr>
				...
				<td align="left"><p><font color=red>收款单位|渠道编码|</font></p></td>
			</tr>
			<tr>
			...
			<tr>
					...
					<td align=left>
						<a href="<%=contextPath%>/rewards/payway/paywayimport.xls">收款单位资料批量导入模板.xls</a>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <s:i18n name="public">
	                        ...
	                        <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   		onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           		value="<s:text name="button_return"/>" onclick="doReturn('/payway/payway_list.do')">
                        </s:i18n>
	                    </td>
	                    </tr>
					</table>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.reward.payway.PaywayTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</body>
</html>