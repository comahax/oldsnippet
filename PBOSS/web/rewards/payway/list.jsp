...
<head>
	...
	function doExport(url){
		...
		formList.submit();
		formList.action = contextPath + "/payway/payway_list.do";
	}

	function doImport(){	
		formList.action = contextPath+ "/rewards/payway/batch.jsp";
  		formList.submit();
	}
</script>
</head>
...
<s:form action="payway_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/payway/payway_list.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/payway/payway_new.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/payway/payway_delete.do')">
                    ...
                    <input type="button" id="btnExport" name="btnExport"
										...
										onClick="doExport('/payway/payway_exportExcel.do')">
        ...
        <table class="table_style">
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td>
                     <a href='<s:url action="payway_edit.do">
