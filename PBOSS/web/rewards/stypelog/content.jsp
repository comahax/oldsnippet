...
<s:form action="stypelog_save.do" name="formItem" id="formItem" method="post" theme="simple">
    ...
    <table class="content_table" id="contentTable">
        <tr>
            ...
            <td class="content_table_td_right">
                <s:textfield name="form.logid" cssClass="form_text edit" maxlength="14"/>    
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content_table_td_right">
				<s:textfield name="form.stype" cssClass="form_text required edit" maxlength="128"/>
        ...
        <tr>
            ...
            <td class="content_table_td_right">
                <s:textfield name="form.ltype" cssClass="form_text edit" maxlength="128"/>    
            </td>
        </tr>
        <tr>
	...
	<div class="title_center_div" id="buttonDiv">
		<s:i18n name="public">
			<input type="button" class="form_button edit" value="<s:text name="button_save"/>"
				onclick="doSave('/reward/stypelog_save.do')"/>
			<input type="button" class="form_button" value="<s:text name="button_return"/>"
				onclick="doReturn('/reward/stypelog_list.do')">
		</s:i18n>
	</div>
</s:form>
</body>
