...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function ev_check() {
            addfield('param._ne_approvalid', '<s:text name="approvalid"/>', 'f', true, '14');
...
<s:form action="advapproval_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            <tr>
                <td align="center"><s:text name="approvalid"/>:</td>
                <td align="left">
                    <s:textfield cssStyle="style_input" name="param._ne_approvalid" />
                </td>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/communication/advapproval_list.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/communication/advapproval_new.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/communication/advapproval_delete.do')">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('approvalid')"><s:text name="approvalid"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
					 <%-- 复合主键用“|”间隔开 --%>
                     <td>
                         <input type="checkbox" name="param._selectitem" value="<s:property value="approvalid"/>" onclick="checkOne();">
                     </td>
                     <td><a href='<s:url action="advapproval_edit.do">
	                         <s:param name="param._pk" value="approvalid"/>
	                     	</s:url>'>
							<s:property value="approvalid"/>
                         </a>
					 </td>
