...
<head>
	...
	function ev_checkval() {
		...
		addfield('form.cityid', '<s:text name="cityid"/>', 'c', true, 4);
		addfield('form.objname', '<s:text name="objname"/>', 'c', true, 30);
...
<s:form action="chpwcomsrcvobj_save.do" cssStyle="formList" key="formItem"
        ...
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					...
					<s:else>
						<s:textfield cssStyle="style_input" name="form.checktime" disabled="true"/>
					</s:else>
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.cityid" maxlength="4"/>
					</s:if>
					<s:else>
            ...
            <tr>
                <td align="right"><s:text name="objname"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.objname" maxlength="30"/>
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.objname" disabled="true"/>
					</s:else>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/communication/chpwcomsrcvobj_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/communication/chpwcomsrcvobj_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
