...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.appState','审批状态','c',false,2);
			addfield('form.appContent','审批意见','c',false,128);
    ...
    <div class="table_div">
    	...
    	<div class="table_div">
	   	 ...
	   	 <div class="table_div">
			     <table class="table_normal" id="attachment_table">
			     	<tr>
		                <td align="right" width="20%">审批状态:&nbsp</td>
		                <td align="left">
			     	...
			     	<tr>
		                <td align="right" width="20%">审批意见:&nbsp</td>
		                <td align="left">
