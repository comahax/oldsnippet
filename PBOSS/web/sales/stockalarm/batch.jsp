    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
				...
				window.location.href="<%=contextPath%>/sales/stockalarmbatch.do?filename="+filename+"&beanname=com.gmcc.pboss.web.sales.stockalarm.StockalarmTaskBean";
			}
		}
...
<s:form action="/sales/stockalarmupload.do" method="POST" key="formItem"	cssStyle="formItem"	enctype="multipart/form-data" theme="simple">
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h">套卡库存预警设置（渠道)</span>
		</div>
	</div>
    <input type="hidden" name="filename" value='<s:property value="fileName"/>'>
    <input type="hidden" name="path" value='<s:property value="filepath"/>'>
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.sales.stockalarm.StockalarmCheck">
    ...
    <div class="table_div">
        <table class="table_normal">
			...
			<tr>
				...
				<td align="left"><FONT color=red>合作商编码|套卡品牌|最高库存|红色预警|黄色预警|更新途径|</FONT></td>
			</tr>
			<tr>
				<td align="right" height=25>举例说明:</td>
				<td align="left">TDZS04D123740|BrandMzone|1000|100|150|AUTO|</td>
			</tr>
			<tr>
				...
				红色预警：同上。<br>
				黄色预警：同上。<br>
				更新途径： AUTO-自动   MANUAL-人工。<br>
				<FONT color=red>提示：记录不存在时进行新增操作，存在时进行更新操作。</FONT><br>
				<FONT color=red>当品牌共享时，多个品牌用半角逗号隔开。</FONT><br>
				</td>
			</tr>
        </table>
    </div>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.sales.stockalarm.StockalarmTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</body>
</html>