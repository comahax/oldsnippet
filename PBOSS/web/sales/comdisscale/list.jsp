...
<head>
	...
	function ev_check() {
		...
		addfield('param._ne_starlevel', '<s:text name="starlevel"/>', 'l', true, '2');
		...
		addfield('param._nnm_disscale', '<s:text name="disscale"/>', 'f', true, '16');
		addfield('param._ne_disscale', '<s:text name="disscale"/>', 'f', true, '16');
		addfield('param._nnl_disscale', '<s:text name="disscale"/>', 'f', true, '16');
   ...
   function putCountyID(countyid){
     ...
     function doExcel(){
       	formList.action="<%=contextPath%>/sales/comdisscale_excel.do";
       	formList.submit();
       	formList.action="<%=contextPath%>/sales/comdisscale_list.do";
       }
     
     function doBatch(){
      	formList.action="<%=contextPath%>/sales/comdisscale_import.do";
      	formList.submit();
      }
</script>
</head>
...
<s:form action="comdisscale_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
          <tr>
                ...
                <td align="left">
                	<j:selector definition="$CH_STARLEVEL2" name="param._ne_starlevel" />
                </td>
            </tr>
            <tr>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/comdisscale_list.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/sales/comdisscale_new.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/sales/comdisscale_delete.do')">
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('disscale')"><s:text name="disscale"/></j:orderByImg>                 
                </td>
            </tr>
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                    ...
                    <td>
                     ...
                     <td><a href='<s:url action="comdisscale_edit.do">
