...
<s:form action="orderplan_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('saleplan')"><s:text name="saleplan"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('saleplan')"><s:text name="saleplanname"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><s:property value="saleplan" /></td>
                     <td><j:code2Name definition="#SPPROPOSAL" code="saleplan"/></td>
