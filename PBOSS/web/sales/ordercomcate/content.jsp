...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.orderamt', '<s:text name="orderamt"/>', 'f', true, 10);
			addfield('form.unitprice', '<s:text name="unitprice"/>', 'f', true, 16);
			addfield('form.totalprice', '<s:text name="totalprice"/>', 'f', true, 16);
...
<s:form action="ordercomcate_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="param._ne_orderamt"/>
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.orderamt" maxlength="10"/>
					</s:if>
					<s:else>
            ...
            <tr>
                <td align="right"><s:text name="unitprice"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.unitprice" maxlength="16"/>
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.unitprice" disabled="true"/>
					</s:else>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="totalprice"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.totalprice" maxlength="16"/>
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.totalprice" disabled="true"/>
					</s:else>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/sales/ordercomcate_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/sales/ordercomcate_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
