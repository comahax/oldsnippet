...
<s:form action="auditdet_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="param._ne_auditseq"/>
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                <td align="right"><s:text name="auditseq"/>:&nbsp</td>
                <td align="left">
			        <s:if test="CMD == WEB_CMD_NEW">
                        <s:textfield cssStyle="style_input" name="form.auditseq" maxlength="14"/>
                        <font color=red>*</font>
			        </s:if>
			        <s:elseif test="CMD == WEB_CMD_EDIT">
			        	<s:textfield cssStyle="style_input" name="form.auditseq" disabled="true"/>
						<font color=red>*</font>
					</s:elseif>
			        <s:else>
						<s:textfield cssStyle="style_input" name="form.auditseq" disabled="true"/>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/sales/auditdet_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/sales/auditdet_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
...
<script language="JavaScript">
	function ev_checkval() {
		...
		addfield('form.auditseq', '<s:text name="auditseq"/>', 'f', false, 14);
