...
<s:form action="/sales/uploadremove.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data">
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">订单批量作废</span>
			</s:i18n>
		</div>
	</div>
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<font color="red">订单编号|作废原因|</font>说明|
                </td>
            </tr>
            <tr>
                <td align="right">举例说明:&nbsp</td>
                <td align="left">
					<font color="red">10002408359234ABCD|主动放弃|</font>取消订购|
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnUpload" name="btnUpload" class="button_2" onmouseover="buttonover(this);" 
                           ...
                           value="上传" onclick="upload('/sales/uploadremove.do')"/>
