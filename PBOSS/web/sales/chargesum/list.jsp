...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doExcel(cmd)
        {
		    ...
		    formList.action = url;  
		    formList.submit();
		    formList.action=contextPath+"/sales/chargesum_list.do";
        }
...
<s:form action="chargesum_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/chargesum_list.do');">
                   	<input type="button" id="btnExcel" name="btnExcel" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_exportexcel"/>" onClick="doExcel('/sales/chargesum_excel.do')">
                   </s:i18n>
				</td>
			</tr>
		</table>
