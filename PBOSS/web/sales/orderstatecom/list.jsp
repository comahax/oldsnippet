...
<head>
    ...
    function doExcel(){
    	formList.action="<%=contextPath%>/sales/orderstatecom_excel.do";
    	formList.submit();
    	formList.action="<%=contextPath%>/sales/orderstatecom_list.do";
    }
...
<s:form action="orderstatecom_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
                    <j:selector definition="$IM_FXCOMCATEGORY" name="param._se_comcategory" condition="_sk_dictid:%CZ" mode="picker"/>
                </td>
            </tr>
        </table>
    </div>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="统计" onClick="doQuery('/sales/orderstatecom_list.do');">
