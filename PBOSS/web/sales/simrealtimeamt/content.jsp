...
<s:form action="simrealtimeamt_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="param._dl_uptime"/>
    <s:hidden name="param._dnm_uptime"/>
    <s:hidden name="param._de_uptime"/>
    <s:hidden name="param._dnl_uptime"/>
    <s:hidden name="param._dm_uptime"/>
    <s:hidden name="param._din_uptime"/>
    <s:hidden name="param._dnin_uptime"/>
    <s:hidden name="param._dk_uptime"/>
    <s:hidden name="param._dnk_uptime"/>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/sales/simrealtimeamt_save.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/sales/simrealtimeamt_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
