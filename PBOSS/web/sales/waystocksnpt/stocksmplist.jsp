...
<head>
	...
	function ev_check() {
		...
		addfield('param._dnm_stocktime', '<s:text name="stocktime"/>', 'dt', false, '7');
		addfield('param._dnl_stocktime', '<s:text name="stocktime"/>', 'dt', false, '7');
	...
	function openPicker(control,definition,condition) {
      ...
      function doTxt()
        {
        	formList.action="<%=contextPath%>/sales/waystocksnpt_doExportstocksmplistTxt.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/sales/waystocksnpt_stocklistsmp.do";
        }
    	...
    	function disablediv(select){
			...
			if(oDiv == "COMRESSMP"){
				...
				//document.getElementById("td_title").style.display = "";
				//document.getElementById("td_content").style.display = "";
			}else{
				formList.brand_div.disabled = true;
				//document.getElementById("td_title").style.display = "none";
				//document.getElementById("td_content").style.display = "none";
			}
		}
</script>
</head>
...
<s:form action="waystocksnpt_stocklistsmp.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h"><s:text name="titleStocklistsmp"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/waystocksnpt_stocklistsmp.do');">
                  
                   <input type="button" id="btnExport" name="btnExport" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="导出Excel" onClick="doQuery('/sales/waystocksnpt_exportstocksmplist.do');">
                  ...
                  <input type="button" id="btnExportbatch" name="btnExportbatch" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="批量导出" onClick="location.href='<%=contextPath%>/sales/waystocksnpt/stocklistsmpbatchexport.jsp'">
				 </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <s:if test="stocklistsmpFlag == 'true'">
                <td id="td_title">
                    <s:text name="brand"/>                 
                </td>
                </s:if>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <s:if test="stocklistsmpFlag == 'true'">
                     <td id="td_content"><j:code2Name definition="$FX_SMPBRAND" code="brand"/></td>
                     </s:if>
