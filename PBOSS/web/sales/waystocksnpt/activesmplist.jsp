...
<head>
	...
	function openPicker(control,definition,condition) {
    	...
    	function doExport(){
    		formList.action="<%=contextPath%>/sales/waystocksnpt_exportactivesmplist.do";
    		formList.submit();
    		formList.action="<%=contextPath%>/sales/waystocksnpt_activelistsmp.do";
    	}
    	
    	  function doTxt()
        {
        	formList.action="<%=contextPath%>/sales/waystocksnpt_exportactivesmplistTxt.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/sales/waystocksnpt_activelistsmp.do";
        }
</script>
...
<s:form action="waystocksnpt_activelistsmp.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h"><s:text name="titleActivelistsmp"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/waystocksnpt_activelistsmp.do');">
                    ...
                    <input type="button" id="btnExportbatch" name="btnExportbatch" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="批量导出" onClick="location.href='<%=contextPath%>/sales/waystocksnpt/activelistsmpbatchexport.jsp'">
                         </s:i18n>              
				</td>
			</tr>
		</table>
        ...
        <table class="table_style">
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><s:property value="%{getText('format.percent',{actrate*100})}" /></td>
