...
function ev_check() {
	...
	addfield('param._dnl_createtime', '<s:text name="_dnl_createtime"/>', 't', false, '7');
	addfield('param._dnm_createtime', '<s:text name="_dnm_createtime"/>', 't', false, '7');
	return checkval(window);
}

function doExport() {
	doQuery("<%=contextPath%>/sales/waystocksnpt_exportsalestatistic.do");
	formList.action="<%=contextPath%>/sales/waystocksnpt_salestatistic.do";
}

function doTxt() {
	doQuery("<%=contextPath%>/sales/waystocksnpt_exportsalestatisticTxt.do");
	formList.action="<%=contextPath%>/sales/waystocksnpt_salestatistic.do";
}
</script>
</head>
...
<s:form action="waystocksnpt_salestatistic.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
  <%//下面的控件给Action提供数据，用来分页%>
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h"><s:text name="titleSalestatistic"/></span>
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
                    <input type="text" name="param._dnl_createtime" id="_dnl_createtime" value="<s:property value="param._dnl_createtime"/>"
						onclick="WdatePicker({maxDate:'#F{$dp.$D(\'_dnm_createtime\')}'})" readonly="readonly">
					<font color=red>*</font>
                </td>            
                <td align="right"><s:text name="_dnm_createtime"/>:</td>
                <td align="left">
                    <input type="text" name="param._dnm_createtime" id="_dnm_createtime" value="<s:property value="param._dnm_createtime"/>"
                    	onclick="WdatePicker({minDate:'#F{$dp.$D(\'_dnl_createtime\')}'})" readonly="readonly"/>
                    <font color=red>*</font>
                </td>
            </tr>
            <tr>
			...
			<tr>
				...
				<s:i18n name="public">
					<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/waystocksnpt_salestatistic.do');">
