...
<head>
	...
	function ev_check() {
    	...
    	function doTxt()
        {
        	formList.action="<%=contextPath%>/sales/waystocksnpt_exportsalelistcardTxt.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/sales/waystocksnpt_salecardlist.do";
        }
</script>
</head>
...
<s:form action="waystocksnpt_salecardlist.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h"><s:text name="titleSalelistcard"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/waystocksnpt_salecardlist.do');">
                  
                    <input type="button" id="btnExport" name="btnExport" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="导出Excel" onClick="doQuery('/sales/waystocksnpt_exportsalelistcard.do');">
                    ...
                    <input type="button" id="btnExportbatch" name="btnExportbatch" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="批量导出" onClick="location.href='<%=contextPath%>/sales/waystocksnpt/salecardlistbatchexport.jsp'">
                         </s:i18n>
				</td>
			</tr>
		</table>
