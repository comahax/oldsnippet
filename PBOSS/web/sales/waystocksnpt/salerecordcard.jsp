...
<head>
	...
	function openPicker(control,definition,condition) {
    	 ...
    	 function doTxt()
        {
        	formList.action="<%=contextPath%>/sales/waystocksnpt_exportsalecardrecordTxt.do";
        	formList.submit();
        	formList.action="<%=contextPath%>/sales/waystocksnpt_salerecordcard.do";
        }
...
<s:form action="waystocksnpt_salerecordcard.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h"><s:text name="titleSalerecordcard"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/waystocksnpt_salerecordcard.do');">
                   
                    <input type="button" id="btnExport" name="btnExport" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="导出Excel" onClick="doQuery('/sales/waystocksnpt_exportsalecardrecord.do');">
				 ...
				 <input type="button" id="btnExporttxt" name="btnExporttxt" class="button_4" onmouseover="buttonover(this);"
                    ...
                    <input type="button" id="btnExportbatch" name="btnExportbatch" class="button_4" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="批量导出" onClick="location.href='<%=contextPath%>/sales/waystocksnpt/salerecordcardbatchexport.jsp'">
                         </s:i18n>
				</td>
			</tr>
		</table>
