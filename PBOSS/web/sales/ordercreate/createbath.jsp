    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(actionUrl){
			...
			if(filename != null || filename != ""){
				...
				window.location.href="<%=contextPath%>/sales/createbath.do?filename="+filename+"&beanname=com.gmcc.pboss.web.sales.ordercreate.CreateBatchTaskBean";
			}
		}
...
<s:form action="/sales/uploadcreate.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data">
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">批量订购</span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" id="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.sales.ordercreate.CreateCheck">
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<font color="red">合作商编码|地市资源代码和订购数量|</font>
                </td>
            </tr>
            <tr>
                <td align="right">举例说明:&nbsp</td>
                <td align="left">
					<font color="red">WAYFA49|a10b20c60|或者 WAYFA49|a#30,b#50,c#20|</font>
                </td>
            </tr>
            <tr>
                <td align="right">补充说明:&nbsp</td>
                <td align="left">
					文件格式中用红色标记的为必填项，文件内容无标题行
                </td>
            </tr>
        </table>
        </s:i18n>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnUpload" name="btnUpload" class="button_2" onmouseover="buttonover(this);" 
                           ...
                           value="上传" onclick="upload('/sales/uploadcreate.do')"/>
                    
                   
                    <input type="button"  id="btnDeal" name="btnDeal" class="button_2" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_deal"/>" onclick="checkProcess('/sales/createbath.do');"/>
					</s:i18n>
                </td>
            </tr>
        </table>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.sales.ordercreate.CreateBatchTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</div>
</body>
</html>
