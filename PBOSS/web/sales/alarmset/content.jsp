...
<html>
	<head>
        ...
        function ev_checkval() {
			...
			var vale = document.getElementById("alarmset_save_do_form_sysparamflag").value;
			if(vale!="1"){
	...
	<body>
		<div class="table_container">
			<s:form action="alarmset_save.do" cssStyle="formList" key="formItem"
								...
								<s:i18n name="public">
									<j:purChk permid="FX_RU_STOCKALARM">
										<input type="button" id="btnSave" name="btnSave"
											...
											onclick="doSave('/sales/alarmset_save.do')"
