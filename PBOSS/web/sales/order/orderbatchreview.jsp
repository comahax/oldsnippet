    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(){
			...
			if(filename != null || filename != ""){
				...
				window.location.href="<%=contextPath%>/sales/orderreview_import.do?filename="+filename+"&beanname=com.gmcc.pboss.web.sales.order.OrderBatchReviewTaskBean";
...
<s:form action="/sales/orderreview_upload.do" cssStyle="formItem" key="formItem" 
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">订单批量复核  </span>
			</s:i18n>
		</div>
	</div>
...
<input type="hidden" name="filename" id="filename" value='<s:property value="fileName"/>'>
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.sales.order.OrderBatchReviewCheck">
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnUpload" name="btnUpload" class="button_2" onmouseover="buttonover(this);" 
                           ...
                           value="上传" onclick="upload('/sales/orderreview_upload.do');"/>
                    
                   
                    <input type="button"  id="btnDeal" name="btnDeal" class="button_2" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_deal"/>" onclick="checkProcess('/sales/orderreview_import.do');"/>
					</s:i18n>
                </td>
            </tr>
        </table>
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.sales.order.OrderBatchReviewTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</div>
</body>
</html>
