   ...
   <input type="hidden" name="wayid" value="${USER.wayid }"/>
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h">订单批量收费  </span>
			</s:i18n>
		</div>
	</div>
    ...
    <s:i18n name="public">
         <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<font color="red">订单编号|</font>POS流水号|
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left">
					...
					订单编号：最大长度为18位的字符串。<br>
					POS流水号：最大长度为20位字符串。<br>
					<font color="blue">订单收费方式为POS时，POS流水号不允许为空，其他收费方式可留空。</font>
                </td>
            </tr>
        </table>
        </s:i18n>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnUpload" name="btnUpload" class="button_2" onmouseover="buttonover(this);" 
                           ...
                           value="上传" onclick="upload('/sales/uploadOrderCharge.do')"/>
