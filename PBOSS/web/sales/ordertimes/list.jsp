...
<s:form action="ordertimes_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            <tr>
                <td align="center"><s:text name="objectcode1"/>:</td>
                <td align="left">
                    <j:selector name="param._se_objectcode" definition="$CH_STARLEVEL"/>
                </td>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('objectcode')"><s:text name="objectcode1"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><a href='<s:url action="ordertimes_edit.do">
	                     	...
	                     	</s:url>&otlimitType=APPSTAR'>
							<s:property value="recid"/>
                         </a>
					 </td>
                     <td><j:code2Name code="objectcode" definition="$CH_STARLEVEL"/></td>
