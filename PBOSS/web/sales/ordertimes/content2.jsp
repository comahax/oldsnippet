...
<head>
    ...
    <script language="JavaScript">
		function ev_checkval() {
			addfield('form.objectcode', '<s:text name="objectcode2"/>', 'c', false, 18);
...
<s:form action="ordertimes_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="form.objtype" value="APPWAY"/>
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                <td align="right"><s:text name="objectcode2"/>:&nbsp</td>
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<s:textfield cssStyle="style_input" name="form.objectcode" /><input type="button" value="..." class="picker_button" onclick="pshowSelectWay3(this,'form.objectcode','','','AG');this.value='...';" />
					</s:if>
					<s:else>
						<s:textfield cssStyle="style_input" name="form.objectcode" disabled="true"/><input type="button" value="..." class="picker_button" onclick="pshowSelectWay3(this,'form.objectcode','','','AG');this.value='...';" disabled="true"/>
					</s:else>
					<font color=red>*</font>
                </td>
            </tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/sales/ordertimes_list.do?otlimitType=APPWAY')">
					</s:i18n>
                </td>
            </tr>
        </table>
