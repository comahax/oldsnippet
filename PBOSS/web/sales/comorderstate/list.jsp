...
<s:form action="comorderstate_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            <tr>
                ...
                <td align="left">
                	<j:selector definition="$FX_COMORDERSTATE" mode="selector" name="param._se_orderstate"/>
                </td>
            </tr>
        </table>
    </div>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/comorderstate_list.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/sales/comorderstate_new.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/sales/comorderstate_delete.do')">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
               	<s:i18n name="public">
                <td width="4%" title="<s:text name="list_title_select"/>">
                ...
                <td width="20%">
                    <j:orderByImg href="javascript:doOrderby('msgcontent')"><s:text name="msgcontent"/></j:orderByImg>                 
                </td>
                <td width="20%">
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><a href='<s:url action="comorderstate_edit.do">
                     ...
                     <td><j:code2Name definition="$FX_COMORDERSTATE" code="orderstate"/></td>
                     <td>
	                     <span STYLE="overflow:hidden; text-overflow:ellipsis; white-space:nowrap;width:150px" title="<s:property value="msgcontent"/>"/>
	                     	<s:property value="msgcontent" />
	                     </span>
                     </td>
                     <td>
                     	<span STYLE="overflow:hidden; text-overflow:ellipsis; white-space:nowrap;width:150px" title="<s:property value="memo"/>"/>
