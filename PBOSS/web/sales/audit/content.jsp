...
<s:form action="audit_save.do" cssStyle="formList" key="formItem"
    ...
    <s:hidden name="param._se_presenter"/>
    <s:hidden name="param._se_auditor"/>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/sales/audit_save.do')"
