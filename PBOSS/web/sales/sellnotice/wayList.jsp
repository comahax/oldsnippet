...
<s:form action="sellnotice_wayList.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h"><s:text name="titleListWay"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/sellnotice_wayList.do');">
...
<script language="JavaScript" type="text/JavaScript">
	function doExport(){
		formList.action="<%=contextPath%>/sales/sellnotice_wayExcel.do";
    	formList.submit();
    	formList.action="<%=contextPath%>/sales/sellnotice_wayList.do";
	}
	function ev_check() {
