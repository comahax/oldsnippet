...
<s:form action="sellnotice_countyList.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_xi">></span>
			<span class="table_toparea_h"><s:text name="titleListCounty"/></span>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/sellnotice_countyList.do');">
...
<script language="JavaScript" type="text/JavaScript">
	function doExport(){
		formList.action="<%=contextPath%>/sales/sellnotice_countyExcel.do";
    	formList.submit();
    	formList.action="<%=contextPath%>/sales/sellnotice_countyList.do";
	}
	function ev_check() {
