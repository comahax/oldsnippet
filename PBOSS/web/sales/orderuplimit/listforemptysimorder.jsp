...
<s:form action="orderuplimit_listforemptysimorder.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left"> 
                    <s:select name="param._se_comcategory" id="cust" list="#request.emptysimtypeList" theme="simple" headerKey="" headerValue=""  listKey="comcategory" listValue="dictname" />
                </td>
                <td></td>
                <td></td>
            </tr>
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/orderuplimit_listforemptysimorder.do');">
                	
                    <input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_new"/>" onClick="doNew('/sales/orderuplimit_newforemptysimorder.do')">
                    
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete('/sales/orderuplimit_delete.do?forwhat=emptysimorder')">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('monlimit')"><s:text name="monlimit"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('daylimit')"><s:text name="daylimit"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('oncelimit')"><s:text name="oncelimit"/></j:orderByImg>                 
                </td>
            </tr>
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><a href='<s:url action="orderuplimit_doEditforemptysimorder.do">
                     ...
                     <td><s:property value="monlimit" /></td>
                     <td><s:property value="daylimit" /></td>
                     <td><s:property value="oncelimit" /></td>
                 </tr>
             </s:iterator>
        </table>
        </div>
