...
<s:form action="orderuplimit_saveforcard.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:if test="CMD != WEB_CMD_SAVE">
						<j:selector name="form.comcategory" definition="$CARDCOMCATEGORY" />
					</s:if>
					<s:else>
						<j:selector name="form.comcategory" definition="$CARDCOMCATEGORY" disabled="true" />
					</s:else>
					<font color=red>*</font>
                </td>
            </tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/sales/orderuplimit_saveforcard.do')"
                           <s:if test="CMD == WEB_CMD_SAVE">disabled = "true"</s:if>
                           />
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/sales/orderuplimit_listforcard.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
