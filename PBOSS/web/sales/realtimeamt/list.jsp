...
<s:form action="realtimeamt_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/sales/realtimeamt_list.do');">
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            ...
            <s:iterator value="realtimeamtList">
