	...
	<script language="JavaScript" type="text/JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/sales/waystockrecord_exp.do?filename="+filename+"&beanname=com.gmcc.pboss.web.sales.waystockrecord.WaystockrecordTaskBean";
			}
		}
		function doReturn() {
	     	formItem.action = "<%=contextPath%>/sales/waystockrecord_list.do"; 
		    formItem.submit();
		}
		function upload(){
			formItem.action="<%=contextPath%>/sales/waystockrecord_upload.do";
...
<s:form action="/sales/waystockrecord_upload.do" cssStyle="formItem" key="formItem" method="post" theme="simple" enctype ="multipart/form-data" onSubmit="return upload();" >
	<div class="table_top">
		...
		<div class="table_toparea_w">
			...
			<span class="table_toparea_h">网点库存量明细批量导出</span>
		</div>
	</div>
...
<iframe src="<%=contextPath%>/sales/waystocksnpt/exportStatus.jsp?beanname=com.gmcc.pboss.web.sales.waystockrecord.WaystockrecordTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</body>
</html>