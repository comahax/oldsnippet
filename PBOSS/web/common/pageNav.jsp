...
<table class=" page_table">
	<tr valign=middle>
		...
		<td align=right style="font-size:12px;">
			<s:if test="(dp.rowCount>0)">
				<s:text name="button_total_page" />
				<font color="red"><s:property value="dp.rowCount" /></font>
				<s:text name="button_rowcount" />
			</s:if>
			&nbsp;
			...
			<input name="param.goto_page" type="text" class="style_input" size="2" ID="goto_page" value="<s:property value="dp.pageNo" />">
			<s:text name="button_page" /><a href="javascript:gotoPage();"><img src="images/go.gif" alt="<s:text name="button_goto_page" />" class="move" width="16" height="14" border="0"></a>
		</td>
	</tr>
</table>
</s:i18n>