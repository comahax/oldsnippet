					...
					<div class="table_div">
						<table class="table_normal">
							...
							<tr>
								...
								<td align=left>
									商品类型查询：<j:selector name="comcategory" definition="$IM_FXCOMCATEGORY" mode="picker"/>
								</td>
							</tr>
						</table>
					</div>
									...
									<tr>
										<td align=right>
											<input type="button" id="btnBatch" name="btnBatch"
												...
												onblur="buttonout(this)" value="上传" onClick="doUpload();">
											<input type="button" id="buttonProcess" name="buttonProcess"
												class="button_New" onmouseover="buttonover(this);"
												onmouseout="buttonout(this);" onfocus="buttonover(this)"
												onblur="buttonout(this)"
												onclick="checkProcess(document.all['pk'].value)" value="导入">
