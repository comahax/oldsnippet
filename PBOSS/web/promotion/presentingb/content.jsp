...
<head>
    ...
    <script language="JavaScript">
        ...
        function doSave(str){
        	...
        	if(ret){
        		enable();
        		formItem.action ="<%=contextPath%>/promotion/presentingb_save.do?pk1="+str;
   				formItem.submit();
   			}else{
   				return false;
   			}
        ...
        function doReturn(str, str1) {
   		 	formItem.action ="<%=contextPath%>/promotion/presentingb_list.do?pk="+str + "&pk1=" + str1;
   			formItem.submit();
		}
    </script>
</head>
...
<s:form action="presentingb_save.do" cssStyle="formList" key="formItem"
        ...
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
			        ...
			        <s:elseif test="CMD == WEB_CMD_EDIT">
			        	<j:selector definition="$IM_FXCOMCATEGORY" name="form.comcategory" mode="picker" cssStyle="style_input" disabled="true"/>
                        <font color=red>*</font>
			        </s:elseif>
			        <s:else>
						<j:selector definition="$IM_FXCOMCATEGORY" name="form.comcategory" mode="picker" cssStyle="style_input" disabled="true"/>
            ...
            <tr>
                ...
                <s:if test="CMD==WEB_CMD_NEW">
               	...
               	<s:else>
               		<s:textfield cssStyle="style_input" name="form.pquantity" maxlength="3" disabled="true"/>
               		<font color=red>*</font>
               	</s:else>
                </td>
            </tr>
