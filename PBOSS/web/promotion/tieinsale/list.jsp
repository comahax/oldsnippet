...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function ev_check() {
            ...
            addfield('param._se_tcomcategory', '<s:text name="tcomcategory"/>', 'c', true, '32');
        ...
        function doNew(str) {
   		 	formList.action ="<%=contextPath%>/promotion/tieinsale_new.do?pk=" + str;
   			formList.submit();
		}
		
		function doEdit(str) {
   		 	formList.action ="<%=contextPath%>/promotion/tieinsale_edit.do?pk=" + str;
   			formList.submit();
		}
		...
		function doDelete(str, str1){
    		...
    		if (forincheck(TO,sis,msgConfirmDelete)){    
				formList.action ="<%=contextPath%>/promotion/tieinsale_delete.do?pk="+ str + "&pk1=" + str1;
				formList.submit();
			}else{
				formList.action ="<%=contextPath%>/promotion/tieinsale_list.do?pk="+ str + "&pk1=" + str1;
				formList.submit();
			}
		}
...
<s:form action="tieinsale_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="table_normal">
            <tr>
                ...
                <td align="center"><s:text name="tcomcategory"/>:</td>
                <td align="left">
                    <j:selector definition="$IM_FXCOMCATEGORY" name="param._se_tcomcategory" mode="picker" cssStyle="style_input" />
                </td>
            </tr>
        </table>
    </div>
			...
			<tr>
				<td>
                    ...
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete(document.all['form.ruleid'].value, document.all['form.pid'].value); loadforiframe();" disabled="true">
                    </s:if>
                    <s:else>
                    	<input type="button" id="btnNew" name="btnNew" class="button_New" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                    ...
                    <input type="button" id="btnDelete" name="btnDelete" class="button_Delete" onmouseover="buttonover(this);"
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="<s:text name="button_delete"/>" onClick="doDelete(document.all['form.ruleid'].value, document.all['form.pid'].value); loadforiframe();">
                    </s:else>   
                    <input type="button" id="btnReturn" name="btnReturn" class="button_6" onmouseover="buttonover(this);" 
                    	onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                        value="返回方案规则" onclick="doReturn(document.all['form.pid'].value)">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
               	<s:i18n name="public">
                <td width="20px" title="<s:text name="list_title_select"/>">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('tcomcategory')"><s:text name="tcomcategory"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('tquantity')"><s:text name="tquantity"/></j:orderByImg>                 
                </td>
            </tr>
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <s:else>
                     <a href='<s:url action="tieinsale_edit.do">
                     ...
                     <td><j:code2Name definition="$IM_FXCOMCATEGORY" code="tcomcategory" /></td>
                     <td><s:property value="tquantity" /></td>
                 </tr>
             </s:iterator>
        </table>
        </div>
