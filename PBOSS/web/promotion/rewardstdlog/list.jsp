...
<s:form action="rewardstdlog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/promotion/rewardstdlog_list.do');">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('reward')"><s:text name="reward"/></j:orderByImg>                 
                </td>
            </tr>
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><j:code2Name definition='$IM_FXCOMCATEGORY'
												code="comcategory" /></td>
                     <td><s:property value="%{getText('format.double',{reward})}" /></td>
                 </tr>
             </s:iterator>
        </table>
        </div>
