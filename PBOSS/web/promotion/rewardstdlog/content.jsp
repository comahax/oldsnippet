...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.reward', '<s:text name="reward"/>', 'f', true, 16);
...
<s:form action="rewardstdlog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.reward" maxlength="16"/>
                </td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/rewardstdlog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/rewardstdlog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
