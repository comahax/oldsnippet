...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.tcomcategory', '<s:text name="tcomcategory"/>', 'c', true, 32);
			addfield('form.tquantity', '<s:text name="tquantity"/>', 'f', true, 3);
...
<s:form action="tieinsalelog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.tcomcategory" maxlength="32"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/tieinsalelog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/tieinsalelog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
