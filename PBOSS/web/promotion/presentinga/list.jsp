...
<html>
	<head>
        ...
        function doNew(str) {
   		 	formList.action ="<%=contextPath%>/promotion/presentinga_new.do?pk=" + str;
   			formList.submit();
		}
		
		function doEdit(str) {
   		 	formList.action ="<%=contextPath%>/promotion/presentinga_edit.do?pk=" + str;
   			formList.submit();
		}
		...
		function doDelete(str, str1){
			...
			formList.action ="<%=contextPath%>/promotion/presentinga_delete.do?pk=" + str + "&pk1=" + str1;
			formList.submit();
			}else{
			formList.action ="<%=contextPath%>/promotion/presentinga_list.do?pk=" + str + "&pk1=" + str1;
			formList.submit();
			}
		}
	...
	<body class="list_body"
		...
		<div class="table_container">
			<s:form action="presentinga_list.do" key="formList"
				...
				<div class="table_div">
					<table class="table_normal">
						<tr>
							...
							<td align="center">
								<s:text name="pcomcategory" />
								:
							</td>
							<td align="left">
								<j:selector definition="$IM_FXCOMCATEGORY" mode="picker"
									name="param._se_pcomcategory" cssStyle="style_input" />
							</td>
						</tr>
					</table>
				</div>
							...
							<td>
								<s:i18n name="public">
									<input type="button" id="btnQuery" name="btnQuery"
										...
										onClick="doQuery(document.all['form.ruleid'].value, document.all['form.pid'].value);">
									...
									<input type="button" id="btnDelete" name="btnDelete"
										...
										onClick="doDelete(document.all['form.ruleid'].value, document.all['form.pid'].value);" disabled="true">
									</s:if>
									<s:else>
										<input type="button" id="btnNew" name="btnNew"
										class="button_New" onmouseover="buttonover(this);"
									...
									<input type="button" id="btnDelete" name="btnDelete"
										...
										onblur="buttonout(this)"
										value="<s:text name="button_delete"/>"
										onClick="doDelete(document.all['form.ruleid'].value, document.all['form.pid'].value);">
									</s:else>
						...
						<div class="table_LongTable">
							<table class="table_style">
								<tr class="table_style_head">
									...
									<td>
										<j:orderByImg href="javascript:doOrderby('quantity')">
											<s:text name="quantity" />
										</j:orderByImg>
									</td>
									<td>
										<j:orderByImg href="javascript:doOrderby('pcomcategory')">
											<s:text name="pcomcategory" />
										</j:orderByImg>
									</td>
									<td>
										<j:orderByImg href="javascript:doOrderby('pquantity')">
											<s:text name="pquantity" />
										</j:orderByImg>
									</td>
								</tr>
								<s:iterator value="dp.datas">
									<tr class="table_style_content" align="center"
										...
										<td>
											...
											<s:else>
												<a
												href='<s:url action="presentinga_edit.do">
