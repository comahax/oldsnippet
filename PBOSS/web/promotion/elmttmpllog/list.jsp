...
<s:form action="elmttmpllog_list.do" key="formList" cssStyle="formList" theme="simple" onsubmit="return ev_check();">
			...
			<tr>
				<td>
                	...
                	<input type="button" id="btnQuery" name="btnQuery" class="button_Query" onmouseover="buttonover(this);"
                        ...
                        value="<s:text name="button_search"/>" onClick="doQuery('/promotion/elmttmpllog_list.do');">
                   </s:i18n>
				</td>
			</tr>
		</table>
    ...
    <div class="table_div">
        ...
        <table class="table_style">
            <tr class="table_style_head">
                ...
                <td>
                    <j:orderByImg href="javascript:doOrderby('tmplname')"><s:text name="tmplname"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('gatheringmode')"><s:text name="gatheringmode"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('columnsinfo')"><s:text name="columnsinfo"/></j:orderByImg>                 
                </td>
                <td>
                    <j:orderByImg href="javascript:doOrderby('gatheringlogic')"><s:text name="gatheringlogic"/></j:orderByImg>                 
                </td>
                <td>
            ...
            <s:iterator value="dp.datas">
                 <tr class="table_style_content" align="center" onMouseMove="this.bgColor='F0F5F9'" onMouseOut="this.bgColor='#ffffff'">
                     ...
                     <td><s:property value="tmplid" /></td>
                     <td><s:property value="tmplname" /></td>
                     <td><j:code2Name definition="$CH_GATHERINGMODE"
												code="gatheringmode" /></td>
                     <td><s:property value="columnsinfo" /></td>
                     <td><s:property value="gatheringlogic" /></td>
                     <td><j:code2Name definition="$CH_KHSTATE" code="state" /></td>
