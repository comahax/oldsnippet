...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.tmplid', '<s:text name="tmplid"/>', 'f', true, 6);
			addfield('form.tmplname', '<s:text name="tmplname"/>', 'c', true, 50);
			addfield('form.gatheringmode', '<s:text name="gatheringmode"/>', 'c', true, 32);
			addfield('form.columnsinfo', '<s:text name="columnsinfo"/>', 'c', true, 64);
			addfield('form.gatheringlogic', '<s:text name="gatheringlogic"/>', 'c', true, 1024);
...
<s:form action="elmttmpllog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.tmplid" maxlength="6"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="tmplname"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.tmplname" maxlength="50"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="gatheringmode"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.gatheringmode" maxlength="32"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="columnsinfo"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.columnsinfo" maxlength="64"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="gatheringlogic"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.gatheringlogic" maxlength="1024"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/elmttmpllog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/elmttmpllog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
