    ...
    <script language="JavaScript" type="text/JavaScript">
	    function checkProcess(str){
			...
			if(filename != null || filename != ""){
				...
				window.location.href="<%=contextPath%>/promotion/ppzlnres_import.do?filename="+filename+"&beanname=com.gmcc.pboss.web.promotion.ppzlnres.PpzlnresTaskBean&pk="+str;
			}
		}
		...
		{
			var str='<%=pk%>';
			formItem.action="<%=contextPath%>/promotion/ppzlnres_upload.do?pk="+str;
			formItem.submit();
		}
		
		function doReturn(str) {
   		 	formItem.action ="<%=contextPath%>/promotion/ppzlnres_list.do?param._pk="+str;
   			formItem.submit();
		}
...
<s:form action="/promotion/ppzlnres_upload.do" method="POST" key="formItem"	cssStyle="formItem"	enctype="multipart/form-data" theme="simple">
	<div class="table_top">
    ...
    <input type="hidden" name="iCheckFormat" value="com.gmcc.pboss.web.promotion.ppzlnres.PpzlnresCheck">
...
<iframe src="<%=contextPath%>/common/commonStatus.jsp?beanname=com.gmcc.pboss.web.promotion.ppzlnres.PpzlnresTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
</iframe>
</div>
</body>
</html>