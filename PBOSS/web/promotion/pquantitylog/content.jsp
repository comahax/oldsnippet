...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.incratio', '<s:text name="incratio"/>', 'f', true, 3);
...
<s:form action="pquantitylog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                <td align="right"><s:text name="incat"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.incat" maxlength="32"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="incratio"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.incratio" maxlength="3"/>
                </td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/pquantitylog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/pquantitylog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
