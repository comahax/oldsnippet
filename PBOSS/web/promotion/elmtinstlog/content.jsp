...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.instid', '<s:text name="instid"/>', 'f', true, 6);
			addfield('form.instname', '<s:text name="instname"/>', 'c', true, 50);
			addfield('form.tmplid', '<s:text name="tmplid"/>', 'f', true, 6);
			addfield('form.params', '<s:text name="params"/>', 'c', true, 512);
...
<s:form action="elmtinstlog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                <td align="right"><s:text name="instid"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.instid" maxlength="6"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="instname"/>:&nbsp</td>
                <td align="left">
            ...
            <tr>
                ...
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.params" maxlength="512"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/elmtinstlog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/elmtinstlog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
