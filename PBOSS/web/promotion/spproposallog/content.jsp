...
<head>
    ...
    <script language="JavaScript">
        function ev_checkval() {
			...
			addfield('form.pname', '<s:text name="pname"/>', 'c', true, 50);
			addfield('form.ptype', '<s:text name="ptype"/>', 'c', true, 32);
			addfield('form.pstarttime', '<s:text name="pstarttime"/>', 't', true, 7);
			addfield('form.pendtime', '<s:text name="pendtime"/>', 't', true, 7);
			addfield('form.pfrtmode', '<s:text name="pfrtmode"/>', 'c', true, 32);
...
<s:form action="spproposallog_save.do" cssStyle="formList" key="formItem"
    ...
    <div class="table_div">
        <table class="table_normal">
            ...
            <tr>
                ...
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.pname" maxlength="50"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="ptype"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.ptype" maxlength="32"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="pstarttime"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.pstarttime" maxlength="7"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="pendtime"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.pendtime" maxlength="7"/>
                </td>
            </tr>
            <tr>
                <td align="right"><s:text name="pfrtmode"/>:&nbsp</td>
                <td align="left">
					<s:textfield cssStyle="style_input" name="form.pfrtmode" maxlength="32"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" align="center">
                    ...
                    <input type="button" id="btnSave" name="btnSave" class="button_Save" onmouseover="buttonover(this);" 
                           ...
                           value="<s:text name="button_save"/>" onclick="doSave('/promotion/spproposallog_save.do')"/>
                    <input type="button" id="btnReturn" name="btnReturn" class="button_Back" onmouseover="buttonover(this);" 
                    	   onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<s:text name="button_return"/>" onclick="doReturn('/promotion/spproposallog_list.do')">
					</s:i18n>
                </td>
            </tr>
        </table>
