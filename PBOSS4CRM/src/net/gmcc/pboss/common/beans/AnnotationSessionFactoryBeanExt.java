package net.gmcc.pboss.common.beans;
...
public class AnnotationSessionFactoryBeanExt extends
		AnnotationSessionFactoryBean {
	private static final Logger logger = LoggerFactory
			.getLogger(AnnotationSessionFactoryBeanExt.class);
	/**
		...
		try {
			for (String regex : excludedClassesRegexPatterns) { // Test each
				...
				if (matcher.matches(className, pattern)) {
					logger.debug(
							"class [{}], matches [{}], so it is excluded.",
	...
	/**
	 * @param excludedClassesRegexPatterns
