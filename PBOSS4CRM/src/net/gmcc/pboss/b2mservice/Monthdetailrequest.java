...
@XmlRootElement(name = "monthdetailrequest")
public class Monthdetailrequest {

    @XmlElement(required = true)
    protected Msgreqheader msgreqheader;
    @XmlElement(required = true)
    protected Monthdetailrequest.Msgbody msgbody;
     ...
     * @return
     *     possible object is
     *     {@link Monthdetailrequest.Msgbody }
     *     
     */
    public Monthdetailrequest.Msgbody getMsgbody() {
        return msgbody;
    }
     ...
     *     
     */
    public void setMsgbody(Monthdetailrequest.Msgbody value) {
        this.msgbody = value;
    }
