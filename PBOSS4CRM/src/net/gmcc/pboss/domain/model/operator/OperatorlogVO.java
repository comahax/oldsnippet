...
@Table(name = "SA_SO_OPERATORLOG")//, schema = "PBOSS"
public class OperatorlogVO implements java.io.Serializable {
	...
	/** minimal constructor */
	public OperatorlogVO(Date optime, String oprcode, String oprtype) {
		this.optime = optime;
	...
	/** full constructor */
	public OperatorlogVO(Date optime, String oprcode, String oprtype,
			String success, String operid, Integer region, String opername,
	...
	@SequenceGenerator(name = "SeqGenerator", sequenceName = "SA_SO_OPERATORLOG_SEQ", allocationSize=1)
