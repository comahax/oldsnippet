package net.gmcc.pboss.domain.model.realtimesucc;
...
/**
 * Realtimesucc entity. @author MyEclipse Persistence Tools
 */
@Entity
@Inheritance(strategy=InheritanceType.TABLE_PER_CLASS)
@Table(name = "CH_BBC_REALTIMESUCC")//, schema = "PBOSS_ZS"
public class RealtimesuccVO implements java.io.Serializable {
	...
	/** default constructor */
	public RealtimesuccVO() {
	}

	/** minimal constructor */
	public RealtimesuccVO(Long seq) {
		this.seq = seq;
	}

	/** full constructor */
	public RealtimesuccVO(Long seq, String opnid, String wayid, String oprcode,
	...
	@SequenceGenerator(name = "SeqGenerator", sequenceName = "CH_BBC_REALTIMESUCC_SEQ", allocationSize=1)
