...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="loadforiframe1();">
		<s:form name="formList" id="formList" action="uapreqfile_list.do"
			theme="simple">
								...
								<tr>
									<td colspan="6" align="right">
										<input type="button" class="l_bt48_gray"
												value="<s:text name="btn_sendload"/>"
												onmouseover="this.className='l_bt48'"
												onmouseout="this.className='l_bt48_gray'"
												onclick="doNew('/fee/billing/uapreqfile_new.do')" />
										<s:i18n name="public">
											...
											<input type="button" class="bt48_gray"
												...
												onmouseover="this.className='bt48'"
												onmouseout="this.className='bt48_gray'"
												onclick="doCancel('/fee/billing/uapreqfile_update.do','<s:text name="cancelinfo"/>')" />
										</s:i18n>
									</td>
								</tr>
							</table>
