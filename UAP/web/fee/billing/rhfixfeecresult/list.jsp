...
<html>
	...
	<body>
		<s:form name="formList" id="formList" action="rhfixfeecresult_list.do"
			theme="simple">
									...
									<td colspan="8" align="right">											
										<s:i18n name="public">
											<input type="button" class="bt48_gray"
												...
												onclick="doExcelOut('/fee/billing/rhfixfeecresult_excel.do?target=${requestScope.target}')" />
						...
						<!-- width根据实际的宽度设置如： width=100%、width=2000px -->
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
								...
								<tr>
                                        ...
                                        <!-- <td nowrap><s:text name="isaccount"/></td>   -->   
								...
								<s:else>
									<tr class="trbg_2" align="center" onMouseOver="this.className='trbg_1';" onMouseOut="this.className='trbg_2';">
                                        ...
                                        <!-- <td nowrap><j:code2Name definition="YES_NO" code="isaccount" /></td>  -->  
                                        <td nowrap><j:code2Name definition="$IB_REQ_UAP" code="resulttype" /></td>
								</s:iterator>
		                        </tr>
								</tbody>
							</table>
