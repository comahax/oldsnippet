...
<html>
	<head>			
        ...
        function ev_check() {
         ...
         function showStartLog(cityid,startstep) {   
 			...
 			var batchnum = "01"	;
    		if (startstep != null && "" != startstep && validbillcyc != null && "" != validbillcyc && cityid != null && "" != cityid && batchnum != null && "" != batchnum){    				
        ...
        function showLog(cityid,billingphase,ruleid,batchnum,validbillcyc) {         
    		...
    		if (cityid != null && "" != cityid && batchnum != null && "" != batchnum && validbillcyc != null && "" != validbillcyc){
	...
	<body onload="loadforiframe();">
			<s:form action="/fee/billing/billstatus_SetPrepaidFee.do" key="formList" cssStyle="formList" theme="simple"  method="post" onsubmit="return ev_check();">	
			...
			<iframe frameborder="0" class="loadframe" onload="document.all['loadframe1'].style.height=loadframe1.document.body.scrollHeight"
				...
				src="<%=contextPath%>/fee/billing/billstatus_ShowPrepaidFee.do?form._ne_validbillcyc=<s:property value='#request._ne_validbillcyc'/>&form.regiongroup=<s:property value='#request.regiongroup'/>" />
