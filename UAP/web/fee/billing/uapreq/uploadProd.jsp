...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <th>文件类型：</th>
        <td colspan="3">txt文本文件（文本里不要留空行和多余的空格）</td>
    </tr>
    <tr>
        <th>文件格式：</th>
        <td colspan="3"><input style="width:350px;background:#ebf2f8;border:none;color:red;font-size:12px " value="产品标识|产品名称|用户标识|用户号码|计费编码"/></td>
    </tr>
    <tr>
        <th>举例说明：</th>
        <td colspan="3"><input style="width:400px;background:#ebf2f8;border:none;color:red;font-size:12px " value="prod.001|GPRS套餐|75750002418561|13800138000|PKG.123456"/></td>
    </tr>
...
<div style="float: right;">
	<input type="button" id="btnSave" onmouseover=this.className="bt48" onMouseOut=this.className="bt48_gray"
           name="btnSave" value="<s:text name="button_upload"/>" class="bt48_gray" onclick="return doSave('/fee/billing/uapreq_upProd.do')"/>
    <input type="button" id="btnSave" onmouseover=this.className="bt48" onMouseOut=this.className="bt48_gray"
