...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="loadforiframe1()">
		<s:form name="formList" id="formList" action="uapstatistic_list.do"
			theme="simple">
					...
					<div class="content">
									...
									<td colspan="8" align="right">											
										<s:i18n name="public">
											<input type="button" class="bt48_gray"
												...
												onclick="doExcelOut('/fee/billing/uapstatistic_excel.do?description=${requestScope.description}')" />
										</s:i18n>
									</td>
								</tr>
							</table>
						...
						<!-- width根据实际的宽度设置如： width=100%、width=2000px -->
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
								<thead>
									<tr>
										<td nowrap><s:text name="sreqtype"/></td>
										...
										<td nowrap><s:text name="svalidbillcyc"/></td>
										<td nowrap><s:text name="count"/></td>
										<td nowrap><s:text name="amt"/></td>
										<td nowrap><s:text name="stime"/></td>
								...
								<s:else>
									<tr class="trbg_2" align="center" onMouseOver="this.className='trbg_1';" onMouseOut="this.className='trbg_2';">
										...
										<td nowrap><s:property value="#item.cnt"/></td>
										<td nowrap><fmt:formatNumber value="${item.amt/100}" type="currency" /></td>
