...
public class SelectorTag extends AbstractUITag {
	...
	private void useSelector(){
		...
		selector.setSelectorMaxNum(selectorMaxNum);
		selector.setOrderby(orderby);
	}
	
	private void usePicker(){
		PickerDialog pickerDialog = (PickerDialog)component;		
		pickerDialog.setDefinition(definition);
		pickerDialog.setCondition(condition);	
		pickerDialog.setReadonly(readonly);			
		pickerDialog.setDbFlag(dbFlag);
//		PickerDialog.setOrderby(orderby);
	}
