	...
	public String code2Name(String def, String codeValue,String dbFlag) {
		...
		try{
			if (def.startsWith("#")) {  
				...
				Code2NameControl code2NameControl = (Code2NameControl) BOFactory.build(Code2NameBO.class,getUser(dbFlag)) ;
...
//			dp = commonControl.doQuery(param); //查询
	...
	private static String getConditionString(Class voClass, String field, String vlalue) throws Exception {
		try {
			...
			if (pType == String.class) {
				...
				prefix = vlalue == null ? "_sn_" : "_ski_"; //忽略大小写 change by pmf 2014-03-07
			} else if (Number.class.isAssignableFrom(pType)) {
