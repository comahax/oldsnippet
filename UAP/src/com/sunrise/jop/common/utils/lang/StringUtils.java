...
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    */
    ...
    /**
     * 锟斤拷锟截讹拷锟街凤拷锟斤拷锟截讹拷锟街革拷锟街革拷锟斤拷锟斤拷锟\uFFFD
    ...
    /**
     *锟叫讹拷一锟斤拷锟街凤拷锟角凤拷为null锟斤拷锟角匡拷锟街凤拷<p>
     *
    ...
    public static boolean blurEquals(String src, String dec) {
      ...
      if (dec.startsWith("%") && dec.endsWith("%")) { //前锟斤拷锟叫ｏ拷
    ...
    /**
     * 锟斤拷锟街凤拷锟�SO锟斤拷式转锟斤拷为gb2312锟斤拷式
     * @param str
     * @return
     */
    ...
    /**
     * 锟斤拷锟街凤拷锟�b2312锟斤拷式转锟斤拷为ISO锟斤拷式
     * @param str
     * @return
     */
...
//    		throw new Exception("手机号包含字母！");
    	}
    	return result;
    }
    
    /**
     * 重命名isValuedString,同apache一致
     * @param str
     * @return
     * @author Canigar
     */
