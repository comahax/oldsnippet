...
import com.sunrise.jop.business.base.dictitem.IDictitemDAO;
import com.sunrise.jop.business.base.dictitem.IDictitemVO;
...
public class Code2NameBO extends AbstractControlBean implements Code2NameControl {
	private static Logger log = LoggerFactory.getLogger(Code2NameBO.class);
