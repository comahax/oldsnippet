...
public class BlTouchRuleVO extends BaseVO  {
	...
	// begin 
	private Long precfmstate; 
	
	private Timestamp precfmtime;
	
	private Long grpwoffstate; 
	
	private Timestamp grpwoffstime;

	private Timestamp grpwoffetime;
	
	private Long grpfixcfmstate; 
	
	private Timestamp grpfixcfmtime;
	...
	public Long getPrecfmstate() {
		return precfmstate;
	}

	public void setPrecfmstate(Long precfmstate) {
		this.precfmstate = precfmstate;
	}

	

	public Timestamp getPrecfmtime() {
		return precfmtime;
	}

	public void setPrecfmtime(Timestamp precfmtime) {
		this.precfmtime = precfmtime;
	}

	public Long getGrpfixcfmstate() {
		return grpfixcfmstate;
	}

	public void setGrpfixcfmstate(Long grpfixcfmstate) {
		this.grpfixcfmstate = grpfixcfmstate;
	}

	public Timestamp getGrpfixcfmtime() {
		return grpfixcfmtime;
	}

	public void setGrpfixcfmtime(Timestamp grpfixcfmtime) {
		this.grpfixcfmtime = grpfixcfmtime;
	}

	public Long getGrpwoffstate() {
		return grpwoffstate;
	}

	public void setGrpwoffstate(Long grpwoffstate) {
		this.grpwoffstate = grpwoffstate;
	}

	public Timestamp getGrpwoffstime() {
		return grpwoffstime;
	}

	public void setGrpwoffstime(Timestamp grpwoffstime) {
		this.grpwoffstime = grpwoffstime;
	}

	public Timestamp getGrpwoffetime() {
		return grpwoffetime;
	}

	public void setGrpwoffetime(Timestamp grpwoffetime) {
		this.grpwoffetime = grpwoffetime;
	}
