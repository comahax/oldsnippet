...
public class AcctVO extends BaseVO{
    ...
    private Integer acct_res_type = new Integer("0");
   // Constructors

   public Integer getAcct_res_type() {
		return acct_res_type;
	}


	public void setAcct_res_type(Integer acct_res_type) {
		this.acct_res_type = acct_res_type;
	}
...
/** default constructor */
   ...
   /** full constructor */
   public AcctVO(String acctname, Integer accttype, Integer acctstate, Date starttime, Date stoptime, Integer acctlevel, String limitflag, Integer woffpri, String acctcode, String printname, Integer acct_res_type) {
   ...
   public String toString() {
	   StringBuffer buf = new StringBuffer();
		...
		.append(this.getAcct_res_type()).append("~");
		return buf.toString();
   }
