...
//		 print title
    ...
    /**
     * modify by zhaobingsong 20100106
     *修改为 protected 流通单查询-导出TXT 中不需要”序号“这一列
     * 导出为TXT文件格式的文件
     * @param os OutputStream
     * @param vo Class
     */
    protected void writeTxt(OutputStream os, Iterator itt, Class[] vo)
            throws Exception {
        try {
