...
public class SaleActiveStatisticsProcess extends BgBase {

private static Logger log = Logger.getLogger(SaleActiveStatisticsProcess.class);
	
	public static void main(String[] args){
		SaleActiveStatisticsProcess saleActiveStatisticsProcess = new SaleActiveStatisticsProcess();
		...
		saleActiveStatisticsProcess.setMyProfilePath("/sales/bgHandle/saleactivestatistics.properties");
		// 初始化
		try {
			saleActiveStatisticsProcess.init(args);
			
			/* ------------------------------------------------------------------------------- */
			log.info("=========【套卡收集数据收集程序】=====初始化完成，开始处理==========");
...
//				log.info("endtime = "+endtime);
			...
			log.info("======【套卡收集数据收集程序】========处理完成，正常退出===========");
			
		} catch (Exception e) {e.printStackTrace();
			log.error(e);
			log.error("=====【套卡收集数据收集程序】=========异常退出===============\n"+e.getMessage());
		}
	}
