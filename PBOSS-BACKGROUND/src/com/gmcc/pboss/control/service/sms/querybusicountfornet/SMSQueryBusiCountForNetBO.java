...
public class SMSQueryBusiCountForNetBO extends AbstractControlBean implements SMSQueryBusiCountForNet {
	private static Logger logger = Logger.getLogger(SMSQueryBusiCountForNetBO.class);
	 ...
	 * @throws Exception
	 */
	private QueryBusiCountForNetResult doRecordSmshisAndReturnSuccVal (String mobile,String cityid,String smscontent,String templateid,Short success)
			throws Exception {
