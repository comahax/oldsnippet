...
public class SMSQueryBusiCountForEmployeePrBO extends AbstractControlBean implements SMSQueryBusiCountForEmployeePr {
	private static Logger logger = Logger.getLogger(SMSQueryBusiCountForEmployeePrBO.class);
