...
public class WayDAO extends AbstractDAO {
	...
	public DataPackage queryRvwaycnt(WayListVO params, String baseWayid)
		...
		return queryBySql(queryString.toString(), params);
	}
	...
	public List querySharedUpperWay(String wayid) throws Exception {
		DBQueryParam listVO = new DBQueryParam();
...
//	}
//	
//	public void registerLog(String methodName, Object vo ) throws Exception {				
...
//			registerOperationLog(methodName, vo, logvo);
//		}		
//	}
