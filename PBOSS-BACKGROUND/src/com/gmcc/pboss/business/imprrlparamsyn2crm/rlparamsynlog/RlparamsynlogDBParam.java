...
/**
 * <p>Title: RlparamsynlogDBParam </p>;
 * <p>Description: </p>
 ...
 * @version 1.0
 */
public class RlparamsynlogDBParam extends DBQueryParam {
    ...
    private String _se_receiveway;
    private String _ne_synstate;
    private String _se_synmemo;
	...
	/**
     * @return Returns the _de_oprtime.
     */
    public String get_de_oprtime() {
        return this._de_oprtime;
    }
    /**
     * @param _sk_companyname The _de_oprtime to set.
     */
	...
	/**
     * @return Returns the _ne_opract.
     */
    public String get_ne_opract() {
        return this._ne_opract;
    }
    /**
     * @param _sk_companyname The _ne_opract to set.
     */
	...
	/**
     * @return Returns the _se_receiveway.
     */
    public String get_se_receiveway() {
        return this._se_receiveway;
    }
    /**
     * @param _sk_companyname The _se_receiveway to set.
     */
    public void set_se_receiveway(String _se_receiveway) {
        this._se_receiveway = _se_receiveway;
    }

	/**
     * @return Returns the _ne_synstate.
     */
    public String get_ne_synstate() {
        return this._ne_synstate;
    }
    /**
     * @param _sk_companyname The _ne_synstate to set.
     */
    public void set_ne_synstate(String _ne_synstate) {
        this._ne_synstate = _ne_synstate;
    }

	/**
     * @return Returns the _se_synmemo.
     */
    public String get_se_synmemo() {
        return this._se_synmemo;
    }
    /**
     * @param _sk_companyname The _se_synmemo to set.
     */
    public void set_se_synmemo(String _se_synmemo) {
        this._se_synmemo = _se_synmemo;
    }
