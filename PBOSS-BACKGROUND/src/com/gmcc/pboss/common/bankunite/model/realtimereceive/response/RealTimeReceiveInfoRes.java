...
public class RealTimeReceiveInfoRes {
	...
	public RealTimeReceiveInfoRes(String trx_code, String version,
			Short data_type, String req_sn, String ret_code, String err_msg,
			String signed_msg) {
		super();
