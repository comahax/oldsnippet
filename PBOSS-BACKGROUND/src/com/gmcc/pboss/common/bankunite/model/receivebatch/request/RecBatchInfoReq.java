...
public class RecBatchInfoReq{
	...
	public RecBatchInfoReq(String trx_code, String version, Short data_type,
			Short level, String user_name, String user_pass, String req_sn,
			String signed_msg) {
		super();
