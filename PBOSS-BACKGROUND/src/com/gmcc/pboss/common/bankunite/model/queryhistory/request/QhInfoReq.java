...
public class QhInfoReq {
	...
	public QhInfoReq(String trx_code, String version, Short data_type,
			String user_name, String user_pass, String req_sn, String signed_msg) {
		super();
