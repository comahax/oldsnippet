...
public class EboxChgLogVO  implements java.io.Serializable {
	...
	/** minimal constructor */
    public EboxChgLogVO(Long eboxid, Long eboxunitid, Long eboxunitdetid) {
        this.eboxid = eboxid;
    ...
    public EboxChgLogVO(Long logid, Long eboxid, Long eboxunitid, Long eboxunitdetid, Double beforechgamt, Double afterchgamt, String opercode, String reason, String reason2, Date chgtime, String source, Long yxplanid) {
		super();
	...
	public boolean equals(Object other) {
		if (!(other instanceof EboxChgLogVO))
			return false;
		EboxChgLogVO castOther = (EboxChgLogVO) other;
