...
/**
 * <p>Title: VChZjtyNogotonedetailDAO</p>
 * <p>Description: Data Access Object for VChZjtyNogotonedetailVO</p>
 * <p>Copyright: Copyright (c) 2006</p>
 * <p>Company: sunrise Tech Ltd.</p>
 * @author hejw
 * @version 1.0
 */
public class VChZjtyNogotonedetailDAO extends BaseDAO {

    /**
     * default constructor
     */
    public VChZjtyNogotonedetailDAO(){
        super(VChZjtyNogotonedetailVO.class);
    }
    
    public void delete(VChZjtyNogotonedetailListVO params) throws Exception {
		...
		try {
			String querySQL = "select mark, city, rewardreporttime from (select mark, " +
				...
				"CH_ZJTY_NOGOTONEDETAIL group by mark) t where t.city like '%" 
				+ params.get_sk_city() + "%' and t.rewardreporttime = '" 
				+ params.get_se_rewardreporttime() + "'";
			...
			String deleteSQL = "delete CH_ZJTY_NOGOTONEDETAIL where mark in (" + marks + ")";
    ...
    public long doFindMaxMark() throws Exception {
    	long maxmark = 0;
		try {
			String querySQL = "select nvl(max(mark), 0) maxmark from CH_ZJTY_NOGOTONEDETAIL";
			Session session = SessionUtil.currentSession(getDbFlag());
			SQLQuery query = session.createSQLQuery(querySQL)
