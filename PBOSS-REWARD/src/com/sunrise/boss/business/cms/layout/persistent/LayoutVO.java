...
public class LayoutVO implements OperationLog {
    ...
    /** minimal constructor */
    public LayoutVO(java.lang.String layoutid, java.lang.String layoutname, java.lang.String layoutcompany, java.sql.Timestamp layouttime) {
        this.layoutid = layoutid;
        this.layoutname = layoutname;
        this.layoutcompany = layoutcompany;
        this.layouttime = layouttime;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof LayoutVO) ) return false;
        LayoutVO castOther = (LayoutVO) other;
        return new EqualsBuilder()
            .append(this.getLayoutid(), castOther.getLayoutid())
            .isEquals();
    }
