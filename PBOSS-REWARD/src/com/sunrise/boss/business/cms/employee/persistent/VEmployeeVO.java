...
public class VEmployeeVO implements OperationLog {
	...
	/** full constructor */
	public VEmployeeVO(java.lang.String employeeid, java.lang.String oprcode,
			...
			Short right, Short isnet, Short isopen, String netpass, 
			java.sql.Date regdate, String subname, Short empattr2) {
	...
	/** minimal constructor */
	public VEmployeeVO(java.lang.String employeeid) {
		this.employeeid = employeeid;
	}
	...
	public boolean equals(Object other) {
		if (!(other instanceof VEmployeeVO))
			return false;
		VEmployeeVO castOther = (VEmployeeVO) other;
