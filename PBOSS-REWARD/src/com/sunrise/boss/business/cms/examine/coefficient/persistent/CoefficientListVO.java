 ...
 * @version 1.0
 */
public class CoefficientListVO extends BaseListVO {
    ...
    private String _ne_coefficientsum;

    public String get_ne_coefficientsum() {
		return _ne_coefficientsum;
	}

	public void set_ne_coefficientsum(String _ne_coefficientsum) {
		this._ne_coefficientsum = _ne_coefficientsum;
	}
