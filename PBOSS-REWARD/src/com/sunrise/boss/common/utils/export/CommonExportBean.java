 ...
 * 		commonExportBean.setFileName("营业点参数管理");
 * 		commonExportBean.addOutputProperty("wayid","渠道代码",CommonExportBean.CODE2NAME, "#WAY");
 * 		commonExportBean.addOutputProperty(0,"business","营业点",null,null);
 * 		commonExportBean.addOutputProperty("busicode","营业点代码");
 * 		commonExportBean.addOutputProperty("businame","简称");
 *      //以下演示不规则行情况
...
public class CommonExportBean  extends ExportDataCreator {
     ...
     * @param titleCol 设置标题，调用了此方法不应该再调用setTitle重复设置标题
     * @param format String
     *        DATE   YYYY-MM-DD
     *        NUMBER ##.00
