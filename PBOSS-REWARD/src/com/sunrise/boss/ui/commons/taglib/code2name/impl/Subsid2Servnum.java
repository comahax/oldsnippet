 ...
 * 
 */
public class Subsid2Servnum implements Code2name {

	/** Logger for this class * */
	private static final Logger log = Logger.getLogger(Subsid2Servnum.class);

	public String translate(Object code, User user) throws Exception {

		try {
			SubscriberDelegate delegate = new SubscriberDelegate();
			String name = delegate.GetServnumBySubsid(new Long(Long.parseLong(code.toString())), user);
			if (null == name) {
