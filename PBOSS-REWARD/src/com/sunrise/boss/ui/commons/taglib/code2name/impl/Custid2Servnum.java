...
public class Custid2Servnum implements Code2name{
	/**  Logger for this class **/
	private static final Logger log = Logger.getLogger(Custid2Servnum.class);
	public String translate(Object code, User user) throws Exception {
		
		try{
			SubscriberDelegate delegate = new SubscriberDelegate();
			String name = delegate.GetServnumByCustid(new Long(Long.parseLong(code.toString())), user);
			if (null == name) {
