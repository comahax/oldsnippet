...
public class Servnum2Acctid implements Code2name {
	/** Logger for this class * */
	private static final Logger log = Logger.getLogger(Servnum2Acctid.class);

	public String translate(Object code, User user) throws Exception {

		try {
			SubscriberDelegate delegate = new SubscriberDelegate();
			String name = delegate.GetAcctidByServnum(code.toString(), user).toString();
			if (null == name) {
