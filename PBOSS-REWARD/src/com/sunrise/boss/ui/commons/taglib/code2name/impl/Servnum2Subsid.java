...
public class Servnum2Subsid implements Code2name {

	/** Logger for this class * */
	private static final Logger log = Logger.getLogger(Servnum2Subsid.class);

	public String translate(Object code, User user) throws Exception {

		try {
			SubscriberDelegate delegate = new SubscriberDelegate();
			String name = delegate.GetSubsidByServnum((String) code, user).toString();
			if (null == name) {
