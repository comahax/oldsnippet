...
package com.sunrise.boss.ui.commons.batch.download;
...
import com.sunrise.boss.ui.commons.batch.download.*;
...
//                upload.File file = new upload.File();
        ...
        throws ServletException, IOException, SmartUploadException
    {
        ...
        if(s2 == null)
            m_response.setHeader("Content-Disposition", m_contentDisposition + " filename=" + new String(getFileName(s).getBytes(), "iso-8859-1"));
        else
        if(s2.length() == 0)
