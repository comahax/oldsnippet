 ...
 */
public class SubtractiAction extends BaseDelegateAction {

	public SubtractiAction() {
	...
	public ActionForward doSave(ActionMapping actionMapping,
		...
		SubtractiForm form = (SubtractiForm)actionForm;
		...
		try {
			...
			if (WebConstant.COMMAND_STRING_EDIT.equals(cmdState)) {
				...
				OperationVO nvo = opdelegate.doFindByPk(vo.getIntvopnid(), user);
				if (nvo == null) {
					request.setAttribute(
							WebConstant.REQUEST_ATTRIBUTE_CMDSTATE,
							WebConstant.COMMAND_STRING_EDIT);
					request.setAttribute(WebConstant.PAGE_ATTRIBUTE_MESSAGE, "[分月支付酬金业务编码]不存在");
	...
	public ActionForward doList(ActionMapping actionMapping,
		...
		String sql = " intvopnid is not null ";//查询分月支付酬金业务数据
