 ...
 * @version 1.0
 */
public class OpnacctmapForm extends BaseActionForm {
    /** identifier field */
	...
	public String getBatchacctid() {
		return batchacctid;
	}
	public void setBatchacctid(String batchacctid) {
		this.batchacctid = batchacctid;
	}
