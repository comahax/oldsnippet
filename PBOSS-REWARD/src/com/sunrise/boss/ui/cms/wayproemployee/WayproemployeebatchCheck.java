...
public class WayproemployeebatchCheck extends BaseCheckFormat {
	public WayproemployeebatchCheck() {
	...
	public void checkLine(String line, int rowCount, User user) throws Exception {
		...
		if (content.length != 17) {//16
			throw new Exception("上传数据列数不对,应为16列,请查看说明帮助!");
		}
