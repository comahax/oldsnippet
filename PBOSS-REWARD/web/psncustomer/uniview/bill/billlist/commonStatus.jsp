...
<%if (task!=null || "true".equals(show)) {%>
 ...
 <table border="0" class="form_table">
  ...
  <tr>
    <td>
      <div align="right"><bean:message bundle="upload" key="checkFile"/>:</div>
    </td>
	<td>
		<div align="left" id="checkFile">
		   &nbsp;
		</div>
	</td>
  </tr>
...
function sendit(){
  var url = "<%=contextPath%>/psncustomer/uniview/bill/billlist/response.jsp?beanname="+beanname;
...
function showProgress(){
  ...
  if(percent==null || percent==-1 || (array.length!=6)){
    return;
  }
  ...
  var hrefCheckFile="<a href='<%=contextPath%>/commons/batch/download.jsp?filename="+array[5]+
	"'><font color=blue>check.txt(<bean:message bundle="upload" key="downLoad"/>) </font> </a>";					
  ...
  if( percent>=0 && percent<100){
    ...
    document.getElementById("checkFile").innerHTML = hrefCheckFile;
  }
}
</script>
<%}%>
