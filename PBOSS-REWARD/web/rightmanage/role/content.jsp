...
<html:html>
<head>
	<title><bean:message bundle="role" key="titleUpdate" /></title>
	<script language="JavaScript">
        function ev_checkval() {
			addfield('roleid', '<bean:message bundle="role" key="roleid"/>', 'c', false, 32);
            addfield('operid', '<bean:message bundle="role" key="operid"/>', 'c', false, 32);
            addfield('createdate2', '<bean:message bundle="role" key="createdate"/>', 't', false);
            addfield('status', '<bean:message bundle="role" key="status"/>', 'i', false, 1);
            addfield('statusdate2', '<bean:message bundle="role" key="statusdate"/>', 't', true);
...
<div class="table_container">
	<html:form action="/role.do?CMD=SAVE" styleId="formItem" method="post">
		...
		<table class="top_table" border=0>
					<tr>
						<td>
							<bean:message bundle="role" key="titleUpdate" />
						</td>
					</tr>
		</table>
		</div>
		...
		<table class="form_table">
				...
				<tr>
					...
					<td width="30%" align="left" class="form_table_left">
						<c:choose>
							<c:when test="${newState}">
								<html:text styleClass="form_input_1x" property="roleid" onblur="this.value=ignoreSpaces(this.value);"/>
								<bean:message bundle="fee" key="redStar" />
							</c:when>
							<c:when test="${edtState}">
								<html:text styleClass="form_input_1x" property="roleid" disabled="true" onblur="this.value=ignoreSpaces(this.value);"/>
								<bean:message bundle="fee" key="redStar" />
							</c:when>
							<c:otherwise>
								<html:text styleClass="form_input_1x" property="roleid" disabled="true" onblur="this.value=ignoreSpaces(this.value);"/>
					...
					<td width="30%" align="left" class="form_table_left">
						<c:choose>
							<c:when test="${newState}">
								<html:text styleClass="form_input_1x" property="rolename" onblur="this.value=ignoreSpaces(this.value);"/>
								<bean:message bundle="fee" key="redStar" />
							</c:when>
							<c:when test="${edtState}">
								<html:text styleClass="form_input_1x" property="rolename" onblur="this.value=ignoreSpaces(this.value);"/>
							...
							<c:otherwise>
								<html:text styleClass="form_input_1x" property="rolename" disabled="true" onblur="this.value=ignoreSpaces(this.value);"/>
								<bean:message bundle="fee" key="redStar" />
							</c:otherwise>
						</c:choose>
					</td>
				...
				<tr>
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">    
							<bean:message bundle="role" key="operid" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
					...
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">   
							<bean:message bundle="role" key="orgid" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
				...
				<tr>
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">  
							<bean:message bundle="role" key="createdate" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
					...
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">  
							<bean:message bundle="role" key="status" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
				...
				<tr>
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">  
							<bean:message bundle="role" key="statusdate" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
					...
					<td width="20%" align="right" class="form_table_right">
						<div class="field-require">  
							<bean:message bundle="role" key="ispublic" />
							:
						</div>
					</td>
					<td width="30%" align="left" class="form_table_left">
						<c:choose>
							<c:when test="${newState}">
								<html:text styleClass="form_input_1x" property="ispublic" />
								<bean:message bundle="fee" key="redStar" />
							</c:when>
							<c:when test="${edtState}">
								<html:text styleClass="form_input_1x" property="ispublic"  />
							...
							<c:otherwise>
								<html:text styleClass="form_input_1x" property="ispublic" disabled="true" />
								<bean:message bundle="fee" key="redStar" />
							</c:otherwise>
						</c:choose>
					</td>
				...
				<tr>
					<td>
								...
								<c:when test="${newState or edtState}">
									<s:PurChk controlid="<%=ID_1%>">
										<input type="button" onmouseover="buttonover(this);"
										  	 ...
										  	 class="submit"
										  	 onclick="doSave('/role.do?CMD=SAVE')" />
									</s:PurChk>
								</c:when>
							</c:choose>		
						...
						<input type="button" onmouseover="buttonover(this);"
						       ...
						       class="close"
							   onclick="doReturn('/role.do?CMD=LIST')"/>
						</s:PurChk>
