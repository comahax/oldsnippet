		...
		<div class="table_iframe">
			...
			<div class="iframemenu">
				...
				<script language="javascript">
					addmenuleft();
					addmenu("<%=contextPath%>/rightmanage/operrole/list.jsp","角色操作员关联查询");	
					addmenu("<%=contextPath%>/rightmanage/operrole/batchin/batchin.jsp","角色操作员关联入库");
			...
			<div class="iframewindow" id="message">
				<iframe framespacing="0" frameborder="NO" Scrolling="no"
					name="IFRM_MAIN" id="IFRM_MAIN" class="IFRM_MAIN_on" src="<%=contextPath%>/rightmanage/operrole/list.jsp"></iframe>
			</div>
