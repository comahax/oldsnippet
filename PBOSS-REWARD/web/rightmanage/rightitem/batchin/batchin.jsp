...
<script language="JavaScript" type="text/JavaScript">
		...
		function ev_checkval() {
		   if (checkfilename() == false){
			...
			addfield('createdate', '<bean:message bundle="rightitem" key="createdate"/>', 't', false);
            addfield('status', '<bean:message bundle="rightitem" key="status"/>', 'i', false, 1);
            addfield('statusdate', '<bean:message bundle="rightitem" key="statusdate"/>', 't', true);
	  ...
	  function checkfilename(){
		...
		if(filename != null || filename != ""){
	      ...
	      window.location.href="<%= contextPath%>/rightitembatchtask.do?filename="+filename+"&beanname=com.sunrise.boss.ui.rightmanage.rightitem.batchin.BatchinRightitemTaskBean";
			}
		}
...
<html:form action="/batchinrightitem.do" enctype="multipart/form-data" styleId="formItem">
	<input type="hidden" name="filename"
		value="<c:out value='${requestScope.ITEM.inFile}'/>">
	<div class="table_div">
		<table class="top_table">
			<tr>
				<td><bean:message bundle="rightitem" key="batchinTitle" /></td>
			</tr>
		</table>
	</div>
	<div class="table_div">
	...
	<table class="form_table" width="95%">
		...
		<tr>
			...
			<td align=left colspan=4>
				<bean:message bundle="rightitem" key="filestyle" />
			</td>
		</tr>
		<tr>
			<td align=right height=25>
				<bean:message bundle="rightitem"key="batchinfilehead" />
			</td>
		...
		<tr>
			...
			<td align="left" >
				<html:text styleClass="form_input_1x" property="rightgroup" value="1" readonly="true">GZ</html:text><font color=red>&nbsp;*</font>
			</td>
			<td align=right >
				<div class="field-require">
		...
		<tr>			
			...
			<td align="left">
				<html:text styleClass="form_input_1x" property="createdate" onclick="this.value=selectDate()" value="2009-12-31"/><font color=red>&nbsp;*</font>
			</td>
			<td align="right" height=25>
				<bean:message bundle="rightitem" key="statusdate" />
			</td>
			<td align="left">
				<html:text styleClass="form_input_1x" property="statusdate" onclick="this.value=selectDate()" value="2009-12-31"/><font color=red>&nbsp;*</font>
			</td>
		</tr>
		<tr>
		<td width="20%" align="right" class="form_table_right">
			...
			<td align="left">
				<html:select property="ispublic" >
							<html:option value="0">·ñ</html:option>
							<html:option value="1">ÊÇ</html:option>
							</html:select>	
								<bean:message bundle="fee" key="redStar" />
			</td>
		</tr>
		<tr>
			...
			<td align="left" colspan=3>
				<html:textarea styleClass="form_textarea_on" property="notes" /><font color=red>&nbsp;*</font>
			</td>
		</tr>
		<c:choose>
   ...
   <iframe
		src="<%= contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.rightmanage.rightitem.batchin.BatchinRightitemTaskBean"
