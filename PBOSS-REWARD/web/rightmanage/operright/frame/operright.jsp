		...
		<div class="table_iframe">
			...
			<div class="iframemenu">
				...
				<script language="javascript">
					addmenuleft();
					addmenu("<%=contextPath%>/rightmanage/operright/list.jsp","操作员权限查询");	
					addmenu("<%=contextPath%>/rightmanage/operright/batchin/batchin.jsp","操作员权限入库");
			...
			<div class="iframewindow" id="message">
				<iframe framespacing="0" frameborder="NO" Scrolling="no"
					name="IFRM_MAIN" id="IFRM_MAIN" class="IFRM_MAIN_on" src="<%=contextPath%>/rightmanage/operright/list.jsp"></iframe>
			</div>
