...
<html>
<head>
<title><bean:message bundle="operright" key="batchinTitle" /></title>
<script language="JavaScript" type="text/JavaScript">
	  ...
	  function checkfilename(){
		...
		if(filename != null || filename != ""){
	      ...
	      window.location.href="<%= contextPath%>/operrightbatchtask.do?filename="+filename+"&beanname=com.sunrise.boss.ui.rightmanage.operright.batchin.BatchinOperrightTaskBean";
			}
		}
...
<html:form action="/batchinoperright" enctype="multipart/form-data" styleId="formItem">
	<input type="hidden" name="filename"
		value="<c:out value='${requestScope.ITEM.inFile}'/>">
	<div class="table_div">
		<table class="top_table">
			<tr>
				<td><bean:message bundle="operright" key="batchinTitle" /></td>
			</tr>
		</table>
	</div>
	<div class="table_div">
	...
	<table class="form_table" width="95%">
		...
		<tr>
			<td align=right height=25>
				<bean:message bundle="operright" key="filestyle" />
			</td>
			<td align=left colspan=4>
				<bean:message bundle="Comrescard" key="stylevalue" />
			</td>
		</tr>
		<tr>
			<td align=right height=25>
			...
			<td align=left colspan=4><font color=red>operid|AA|</font></td>
		</tr>
		<tr>
			<td align=right >
   ...
   <iframe
		src="<%= contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.rightmanage.operright.batchin.BatchinOperrightTaskBean"
