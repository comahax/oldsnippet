		...
		<div class="table_iframe">
			...
			<div class="iframemenu">
				...
				<script language="javascript">
					addmenuleft();
					addmenu("<%=contextPath%>/rightmanage/roleright/list.jsp","角色权限查询");	
					addmenu("<%=contextPath%>/rightmanage/roleright/batchin/batchin.jsp","角色权限入库");
			...
			<div class="iframewindow" id="message">
				<iframe framespacing="0" frameborder="NO" Scrolling="no"
					name="IFRM_MAIN" id="IFRM_MAIN" class="IFRM_MAIN_on" src="<%=contextPath%>/rightmanage/roleright/list.jsp"></iframe>
			</div>
