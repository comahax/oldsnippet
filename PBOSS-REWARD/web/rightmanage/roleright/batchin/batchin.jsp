...
<html>
<head>
<title><bean:message bundle="roleright" key="batchinTitle" /></title>
<script language="JavaScript" type="text/JavaScript">
	  ...
	  function checkfilename(){
		...
		if(filename != null || filename != ""){
	      ...
	      window.location.href="<%= contextPath%>/rolerightbatchtask.do?filename="+filename+"&beanname=com.sunrise.boss.ui.rightmanage.roleright.batchin.BatchinRolerightTaskBean";
			}
		}
...
<html:form action="/batchinroleright" enctype="multipart/form-data" styleId="formItem">
	<input type="hidden" name="filename"
		value="<c:out value='${requestScope.ITEM.inFile}'/>">
	<div class="table_div">
		<table class="top_table">
			<tr>
				<td><bean:message bundle="roleright" key="batchinTitle" /></td>
			</tr>
		</table>
	</div>
	<div class="table_div">
	...
	<table class="form_table" width="95%">
		...
		<tr>
			...
			<td align=left colspan=4>
				<bean:message bundle="roleright" key="batchinfilehead" />
			</td>
		</tr>
		<tr>
			<td align=right height=25>
   ...
   <iframe
		src="<%= contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.rightmanage.roleright.batchin.BatchinRolerightTaskBean"
