		...
		<div class="table_iframe">
			...
			<div class="iframemenu">
				...
				<script language="javascript">
					addmenuleft();
					addmenu("<%=contextPath%>/rightmanage/operator/list.jsp","操作员查询");	
			...
			<div class="iframewindow" id="message">
				<iframe framespacing="0" frameborder="NO" Scrolling="no"
					name="IFRM_MAIN" id="IFRM_MAIN" class="IFRM_MAIN_on" src="<%=contextPath%>/rightmanage/operator/list.jsp"></iframe>
			</div>
