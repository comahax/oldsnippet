...
<html>
	<head>
		<title><bean:message bundle="acctgroup" key="titleList2" />
		</title>
        ...
        function doSet(){
        	if(ev_check()){
        		formList.action="<%=contextPath%>/qsmanage/paramsmanage/eboxgroup.do?CMD=SET";
        		formList.submit();
        	}
        }
				...
				<DIV class=table_div>
					<TABLE class=top_table>
						<TBODY>
							<TR>
								<TD>
									<bean:message bundle="acctgroup" key="titleList2" />
								</TD>
							</TR>
						</TBODY>
					</TABLE>
