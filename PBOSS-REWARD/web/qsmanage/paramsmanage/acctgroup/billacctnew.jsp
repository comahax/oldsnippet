...
<%
	String ID_1 = "BILLACCTNEW_1_NEW";
	String ID_2 = "BILLACCTNEW_1_EDIT";
%>
<html:html>
<head>
	<title>新<bean:message bundle="billacct" key="title" /></title>
...
<body onload="loadforiframe();">
	<div class="table_container">
		<html:form
			action="/qsmanage/paramsmanage/acctgroup.do?CMD=BILLACCTNEW"
			...
			<c:set var="edtState" scope="request"
				value="${!empty CMD and CMD eq 'BILLACCTNEW'}" />
							...
							<c:choose>
								<c:when test="${edtState}">
									<input type="button" onmouseover="buttonover(this);"
										...
										class="submit"
										onclick="doSave('/qsmanage/paramsmanage/acctgroup.do?CMD=BILLACCTNEW')" />
								</c:when>
								<c:otherwise>
									<input type="button" onmouseover="buttonover(this);"
										onmouseout="buttonout(this);" name="btnSave"
