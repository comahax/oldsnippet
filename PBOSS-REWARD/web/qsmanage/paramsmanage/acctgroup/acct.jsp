...
<body onload="init_limitflag();loadOldAcctLev();loadforiframe();">
	<div class="table_container">
		<html:form action="/qsmanage/paramsmanage/acctgroup.do?CMD=ACCT"
			styleId="formItem" method="post" onsubmit="return ev_check();">
			...
			<c:set var="edtState" scope="request"
				value="${!empty CMD and CMD eq 'ACCT'}" />

			<div class="table_div">
				<table class="top_table">
					<tr>
						<td>
							<bean:message bundle="acct" key="custMsg" />
						</td>
				</table>
			</div>
			<div class="table_div">
			...
			<div class="table_div">
				<table class="form_table">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctid" />
								:
							</div>
						</td>
						<td class="form_table_left">
							<html:text styleClass="form_input_1x" property="acctid"
								maxlength="14" />
							<font color=red>&nbsp;*</font>
						</td>
					</tr>
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctname" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="accttype" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctstate" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="starttime" />
								:
							</div>
						</td>
						<td class="form_table_left">
							<html:text styleClass="form_input_1x" property="starttime"
								onclick="this.value=selectDate()" maxlength="10" />
							<font color=red>&nbsp;*</font>
						</td>
					</tr>
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="stoptime" />
								:
							</div>
						</td>
						<td class="form_table_left">
							<html:text styleClass="form_input_1x" property="stoptime"
								onclick="this.value=selectDate()" maxlength="10" />
							<font color=red>&nbsp;*</font>
						</td>
					</tr>
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctlevel" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="limitflag" />
								:
							</div>
						</td>
						<td class="form_table_left">
							...
							<c:choose>
								<c:when test="${edtState}">
									<span> <input type="checkbox" name="limitbox"
											class="table_checkbox" value="0"> <bean:message
											bundle="acct" key="limitflag1" /> <input type="checkbox"
											name="limitbox" class="table_checkbox" value="1"> <bean:message
											bundle="acct" key="limitflag2" /> <input type="checkbox"
											name="limitbox" class="table_checkbox" value="2"> <bean:message
											bundle="acct" key="limitflag3" /> <input type="checkbox"
											name="limitbox" class="table_checkbox" value="3"> <bean:message
											bundle="acct" key="limitflag4" /> </span>
								</c:when>
								<c:otherwise>
									<span> <input type="checkbox" name="limitbox"
											class="table_checkbox" value="0" disabled="disabled">
										<bean:message bundle="acct" key="limitflag1" /> <input
											type="checkbox" name="limitbox" class="table_checkbox"
											value="1" disabled="disabled"> <bean:message
											bundle="acct" key="limitflag2" /> <input type="checkbox"
											name="limitbox" class="table_checkbox" value="2"
											disabled="disabled"> <bean:message bundle="acct"
											key="limitflag3" /> <input type="checkbox" name="limitbox"
											class="table_checkbox" value="3" disabled="disabled">
										<bean:message bundle="acct" key="limitflag4" /> </span>
								</c:otherwise>
							</c:choose>
						</td>
					</tr>
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="woffpri" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctcode" />
								:
							</div>
						</td>
						<td class="form_table_left">
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="printname" />
								:
							</div>
						</td>
						<td class="form_table_left">
							<c:choose>
								<c:when test="${edtState}">
									<html:text styleClass="form_input_1x" property="printname"
										maxlength="128" />
								</c:when>
								<c:otherwise>
									<html:text styleClass="form_input_1x" property="printname"
					...
					<tr>
						<td class="form_table_right">
							<div class="field-require">
								<bean:message bundle="acct" key="acctsetid" />
								:
							</div>
						</td>
						<td class="form_table_left">
								...
								<c:choose>
									<c:when test="${edtState}">
										<input type="button" onmouseover="buttonover(this);"
											...
											class="submit"
											onclick="doSave('/qsmanage/paramsmanage/acctgroup.do?CMD=ACCT')" />
									</c:when>
									<c:otherwise>
										<input type="button" onmouseover="buttonover(this);"
											onmouseout="buttonout(this);" disabled="disabled"
