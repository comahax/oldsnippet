...
<%
	...
	if (beanMap != null && beanname != null) {
		...
		System.out.println("task initial");
		System.out.println("task is :" + task);
	} else {
		System.out.println("task initial fail.........");
	}
%>
<HTML>
	<HEAD>
  ...
  body {
	...
	<BODY onload="loadforiframe()">
		<div class="table_div">
			<%if(task!=null){
			System.out.println("task.isRunning():"+task.isRunning());
			...
			<TABLE ALIGN="CENTER" BORDER=0 CELLPADDING=0 CELLSPACING=1
				...
				<tr>
					<td width="12%" align="right">
						<bean:message bundle="upload" key="progressBar" />
						:
					</td>
					<td id="status"></td>
			...
			<table border="0" class="form_table">
				<tr>
					<td align="center" colspan="2">
						<font color=blue size=+1><bean:message bundle="upload"
								key="report" /> </font>
					</td>
				</tr>
				<tr>
					<td width="12%">
						<div align="right">
							<bean:message bundle="upload" key="countRecord" />
							:
						</div>
					</td>
					<td width="88%">
				...
				<tr>
					<td>
						<div align="right">
							<bean:message bundle="upload" key="okRecord" />
							:
						</div>
					</td>
					<td>
				...
				<tr>
					<td>
						<div align="right">
							<bean:message bundle="upload" key="failRecord" />
							:
						</div>
					</td>
					<td>
				...
				<tr>
					<td>
						<div align="right">
							<bean:message bundle="upload" key="resultFile" />
							:
						</div>
					</td>
					<td>
