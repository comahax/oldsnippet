...
function brinmenumother () {
	if (document.all("menumother") == null){
		var addl;
		addl = document.createElement("<iframe id=\"menumother\" class=\"menumotherc\" onmouseout=\"closemotherdoor()\" style=\"display:block;\" frameborder=\"0\" scrolling=\"yes\"></iframe>");
...
function MadeTableAuto() {
	...
	if(mybossline%2 == 0) {
		...
		if (myboss.offsetWidth > mybosswidtha){
			mybosswidthb = myboss.offsetWidth - mybosswidtha;
			mybosswidtha = myboss.offsetWidth;
			if (myboss.offsetWidth > myboss.childNodes[1].firstChild.offsetWidth) {
				myboss.childNodes[1].firstChild.firstChild.firstChild.lastChild.style.posWidth = myboss.childNodes[1].firstChild.firstChild.firstChild.lastChild.width*1 + mybosswidthb;
				myboss.childNodes[1].style.posWidth += mybosswidthb;
				myboss.childNodes[0].firstChild.firstChild.childNodes[0].lastChild.style.posWidth = myboss.childNodes[0].firstChild.firstChild.childNodes[0].lastChild.width*1 + mybosswidthb;
				myboss.childNodes[0].style.posWidth += mybosswidthb;
			}else{
				myboss.childNodes[1].style.posWidth += mybosswidthb;
				myboss.childNodes[0].style.posWidth += mybosswidthb;
				}
		}else{
			mybosswidthb = mybosswidtha - myboss.offsetWidth;
			mybosswidtha = myboss.offsetWidth;
			myboss.childNodes[1].style.posWidth -= mybosswidthb;
			myboss.childNodes[0].style.posWidth -= mybosswidthb;
			}
