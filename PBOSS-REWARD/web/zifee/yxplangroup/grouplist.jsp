...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function ev_check() {
            addfield('_ne_yxplanid', '<bean:message bundle="yxplan" key="groupyxplanid"/>', 'l', true, 14);
            addfield('_sk_yxplanname', '<bean:message bundle="yxplan" key="groupyxplanname"/>', 'c', true, 64);
...
<html:form action="/zifee/yxplan.do?CMD=GROUPLIST" styleId="formList" method="post" onsubmit="return ev_check();">
		...
		<table class="table_button_list">
			<tr>
				<td>
                     ...
                     value="<bean:message bundle="public" key="button_new"/>" onClick="doSubmit('/zifee/yxplan.do?CMD=NEWGROUP')">
              </s:PurChk> 
              <s:PurChk controlid="<%=ID_2%>">
                     <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                     onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                     value="<bean:message bundle="public" key="button_delete"/>" onClick="doSubmit('/zifee/yxplan.do?CMD=DELETEGROUP')">
              </s:PurChk>
    ...
    <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td>
                    <a href="javascript:doOrderby('yxplanid')"><bean:message bundle="yxplan" key="groupyxplanid"/></a>
            ...
            <c:forEach var="item" items="${requestScope.LIST.datas}">            	 
                 <c:url value="/zifee/yxplan.do?CMD=EDITGROUP" var="urlContent">
                     <c:param name="PK" value="${item.yxplanid}"/>
                 </c:url>
                   
                 <tr class="table_style_content" align="center">
                     <td>
                         <input type="checkbox" name="_selectitem" value="<c:out value='${item.yxplanid}' />"
