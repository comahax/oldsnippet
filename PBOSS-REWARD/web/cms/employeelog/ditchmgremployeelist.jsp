...
<%
String ID_query = "CH_PW_WAYMANAGER_LOGQUERY";
%>
<html>
	<head>
		<title><bean:message bundle="logquery"
				key="ditchmgremployeelog" />
		</title>
	...
	<body onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/employeelog.do?CMD=DITCHMGRLIST"
				...
				<div class="table_div">
					<table class="top_table">
						<tr>
							<td>
								<bean:message bundle="logquery" key="ditchmgremployeelog" />
							</td>
						</tr>
					</table>
				</div>
							...
							<tr class="table_style_head">
								...
								<td>
									<a href="javascript:doOrderby('gradschool')"><bean:message
											bundle="employee" key="gradschool" />
									</a>
									<s:OrderImg form="/cms/employeelog/employeelogForm"
										field="gradschool" />
								</td>
								...
								<td>
									<a href="javascript:doOrderby('speciality')"><bean:message
											bundle="employee" key="speciality" />
									</a>
									<s:OrderImg form="/cms/employeelog/employeelogForm"
										field="speciality" />
								</td>
