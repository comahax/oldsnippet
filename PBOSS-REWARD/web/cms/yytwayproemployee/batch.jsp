	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/yytwayproemployee/batch.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.yytwayproemployee.YYTWayproemployeeTaskBean";                                                                                        
			}
		}
		function doReturnList(){
    		window.location.href="<%=contextPath%>/cms/yytwayproemployee.do?CMD=LIST";
    	}	
    </script>
</head>
<body  onload£½" loadforiframe()">
<div class="table_container">
	<html:form action="/cms/yytwayproemployee/batch.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
		<input type="hidden" name="filename" value="<c:out value='${requestScope.ITEM.inFile}'/>">		
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/yytwayproemployee/wayproemployeeimport.xls"><bean:message bundle="Wayproemployee" key="modelname" /></a>
						<bean:message bundle="Wayproemployee" key="hint" /></td>
				</tr>
			</table>
		</div>
		<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.yytwayproemployee.YYTWayproemployeeTaskBean"
