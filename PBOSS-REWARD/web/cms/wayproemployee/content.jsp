...
<html>
<head>
    <title><bean:message bundle="Wayproemployee" key="titleUpdate"/></title>
...
<html:form action="/cms/wayproemployee.do?CMD=SAVE" styleId="formItem" method="post">
    ...
    <c:set var="form" scope="request" value="${requestScope['/cms/wayproemployee/WayproemployeeForm']}"/>
    <!--##################################添加标题内容##################################################-->
    <div class="table_div">
            ...
            <tr>
                ...
                <td width="30%" align="left" class="form_table_left">
                    <c:choose>
                        <c:when test="${edtState||errorState}">
	                        <c:if test="${updateState}">
	                        	<s:zoom definition="#WAY" property="wayid" condition="waytype:AG;" styleClass="form_input_1x" nameOnly="false" disabled="true"/>
	                            <font color="red">*</font>
	                        </c:if>
	                        <c:if test="${!updateState}">
	                        	<s:zoom definition="#WAY" property="wayid" condition="waytype:AG;" styleClass="form_input_1x" nameOnly="false" readonly="true"/>
	                            <font color="red">*</font>
	                        </c:if>
                        </c:when>
                        <c:otherwise>
                	...
                	<c:choose>
                        <c:when test="${edtState||errorState}">
                            <input type="button" onmouseover="buttonover(this);" onmouseout="buttonout(this);"
	                           ...
	                           onclick="doSave('/cms/wayproemployee.do?CMD=SAVE')"/>
                        </c:when>
                        <c:otherwise>
                            <input type="button" onmouseover="buttonover(this);" onmouseout="buttonout(this);"
		                           name="btnSave" onfocus="buttonover(this)" onblur="buttonout(this)"
		                           value="<bean:message bundle="public" key="button_save"/>" class="submit"
		                           onclick="doSave('/cms/wayproemployee.do?CMD=SAVE')" disabled="disabled"/>
                        </c:otherwise>
                    </c:choose>
                    <input type="button" onmouseover="buttonover(this);" onmouseout="buttonout(this);"
                           name="btnReturn" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<bean:message bundle="public" key="button_return"/>" class="close"
                           onclick="doReturn('/cms/wayproemployee.do?CMD=LIST')">
                </td>
            </tr>
        </table>
    </div>
