...
<html:form action="/cms/waystarmonth.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
		<table class="table_button_list">
			<tr> 
                <td align=right>
                		<input type="button" name="btnNew2" class="button_8" value="关联套卡销量设置" onClick="goTo('/cms/waystarcsale.do?CMD=LIST&_orderby=')">
						<input type="button" name="btnAuditing" class="button_2" value='审核' onClick="goTo('/cms/waitaudit.do?CMD=LIST&ISAUDIT=WAYSTARMONTH')">
						<input type="button" name="btnQuery" class="button_2" value="导入" onclick="goTo('/cms/waystarmonth/batchupfile.jsp');" />
                		<input type="button" name="btnQuery" class="button_2" value="导出" onclick="exports();" />
                        <input type="button" class="query" onmouseover="buttonover(this);" onclick="doQuery();"
                                onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                                value="<bean:message bundle="public" key="button_search"/>" />
                        <input type="button" name="btnQuery" class="back" value="返回" onclick="goTo('/cms/wayhznx.do?CMD=LIST&_orderby=');" />
                </td>
			</tr>
		</table>
	</div>
