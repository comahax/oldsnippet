...
<body>	 
    ...
    <div class="table_iframe">  
	    ...
	    <div class="iframetop">
	    	 <bean:message bundle="index" key="messageTitle"/>
	    </div>
	    
	    <div class="iframemenu">
			<script language="javascript">
			    <s:PurChk controlid="<%=ID_1%>"> addmenu("<%=contextPath%>/cms/message.do?CMD=LIST","<bean:message bundle="index" key="managemsg"/>");</s:PurChk>
			    <s:PurChk controlid="<%=ID_2%>"> addmenu("<%=contextPath%>/cms/message.do?CMD=NEW","<bean:message bundle="index" key="newmsg"/>");</s:PurChk>
			    <s:PurChk controlid="<%=ID_3%>"> addmenu("<%=contextPath%>/cms/folder/index.jsp","<bean:message bundle="index" key="folder"/>");</s:PurChk>
			    <s:PurChk controlid="<%=ID_4%>"> addmenu("<%=contextPath%>/cms/group/index.jsp","<bean:message bundle="index" key="group"/>");</s:PurChk>
			</script>
		</div>
