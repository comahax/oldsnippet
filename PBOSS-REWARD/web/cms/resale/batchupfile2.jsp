...
<html>
	...
	<body  onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/resale/batchtask.do" enctype="multipart/form-data" styleId="formItem">
					...
					<table class="top_table">
						<tr>
							<td width="210" class="AreaName" align="left" valign=middle>
								<bean:message bundle="resale" key="titledel" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="table_div">
					<table class="form_table">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<bean:message bundle="resale" key="resaleexample1"/>
							</td> 
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
							...
							<td align=left>
								<bean:message bundle="resale" key="example1" />
							</td> 
						</tr>
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<a href="<%= contextPath %>/cms/resale/resaledel.xls"><bean:message bundle="resale" key="exceldel" />.xls</a>&nbsp;&nbsp;
