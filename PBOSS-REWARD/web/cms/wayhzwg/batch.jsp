...
function checkProcess(){
	...
	if(filename != null || filename != ""){
    	...
    	window.location.href="<%=contextPath%>/cms/wayhzwg/upload.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.wayhzwg.WayhzwgTaskBean";
    }
}
function doReturn(cmdReturn) {
	...
	<body onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/wayhzwg/upload.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
				<input type="hidden" name="filename" value="<c:out value='${requestScope.ITEM.inFile}'/>">
				<div class="table_div">
					<table class="top_table">
						<tr>
							<td >
								<bean:message bundle="wayhzwg" key="titleList1" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="table_div">
					<table class="table_style" width="95%">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<bean:message bundle="wayhzwg" key="wayhzwgformat" /></td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
							...
							<td align=left>
							<bean:message bundle="wayhzwg" key="wayhzwgexample" /></td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
								<bean:message bundle="wayhzwg" key="societysay" />
							</td>
							<td align=left>
								<bean:message bundle="wayhzwg" key="wayhzwgasenote1" /><br>
							</td>
						</tr>
					</table>
				</div>
			<iframe src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.wayhzwg.WayhzwgTaskBean"  frameborder="0" class="loadframe" id="loadframe"  scrolling="no"></iframe>
			<div class="table_div">
					...
					<tr>
						<td>			
							...
							<input type="button" onmouseover="buttonover(this);"
								...
								class="back" onclick="doReturn('/cms/wayhzwg.do?CMD=LIST')">							
						</td>
					</tr>
				</table>
			</div>
