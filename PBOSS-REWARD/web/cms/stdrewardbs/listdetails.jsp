...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doSave() {
        	...
        	*/
        	...
        	if (sis.length == undefined) {
       		 ...
       		 formList.action ="<%=contextPath%>/cms/stdrewardbs.do?CMD=SAVE2&a="+a;
       		 formList.submit();
   			// }
   		 //	return false;
		}
        ...
        function doBack(){
	    	...
	    	formList.action="<%=contextPath%>/cms/stdrewardbs.do?CMD=EDIT&str=content1&PK="+rewardid;
	    	formList.submit();
	    }
...
<html:form action="/cms/stdrewardbs.do?CMD=SAVE" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <c:set var="form" scope="request" value="${requestScope['/cms/stdrewardbs/StdrewardbsForm']}"/>
