...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doQuery() {
        	var url = contextPath + '/cms/zjty/zjtydataquery.do?CMD=Bosssucc';
        	formList.action = url;
		    formList.submit();
        }
    </script>
...
<html:form action="/cms/zjty/zjtydataquery.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="zjtydataquery" key="titleListBosssucc"/>
   			</td>
    	</tr>
    </table>
    </div>
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                <td>
                    <a href="javascript:doOrderby('seq')"><bean:message bundle="zjtydataquery" key="seq"/></a>
                ...
                <td>
                    <bean:message bundle="zjtydataquery" key="adtttime"/>
                </td>
                <td>
