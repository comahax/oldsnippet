...
<html>
<head>
    <title><bean:message bundle="chzjtylocalrewardbusiness" key="titleList"/></title>
        ...
        function doExport(url){
        	if (ev_check()) {
				...
				formList.action = contextPath + url + "?CMD=EXCEL";
	  			formList.submit();
	  			formList.action="<%=contextPath%>/cms/zjty/chzjtylocalrewardbusiness.do?CMD=LIST";
			}
		}
    </script>
</head>
...
<html:form action="/cms/zjty/chzjtylocalrewardbusiness.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="form_table">
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="chzjtylocalrewardbusiness" key="_se_rewardreporttime"/>:</td>
			...
			<tr> 
                <td align=right>
                    ...
                    <input type="button" class="button_4" onmouseover="buttonover(this);" 
            			onclick="doExport('/cms/zjty/chzjtylocalrewardbusiness.do')" 
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                    ...
                    <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                        ...
                        onClick="doDelete('/cms/zjty/chzjtylocalrewardbusiness.do')">
                    </c:if>
                </td>
			</tr>
		</table>
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <c:if test="${!protoken}">
                <td><bean:message bundle="chzjtylocalrewardbusiness" key="wayname"/></td>
                <td><bean:message bundle="chzjtylocalrewardbusiness" key="companytype"/></td>
                </c:if>
                <td><bean:message bundle="chzjtylocalrewardbusiness" key="cityid"/></td>
                <c:if test="${!protoken}">
                <td><bean:message bundle="chzjtylocalrewardbusiness" key="zjtyname"/></td>
                </c:if>
            ...
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms/zjty/chzjtylocalrewardbusiness.do?CMD=EDIT" var="urlContent">
