...
<html>
<head>
    <title><bean:message bundle="chzjtylocalperconfigtotal" key="titleList"/></title>
        ...
        function doExport(url){
			if (ev_check()) {
				...
				formList.action = contextPath + url + "?CMD=EXCEL";
	  			formList.submit();
	  			formList.action="<%=contextPath%>/cms/zjty/chzjtylocalperconfigtotal.do?CMD=LIST";
			}
		}
    </script>
</head>
...
<html:form action="/cms/zjty/chzjtylocalperconfigtotal.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="form_table">
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="chzjtylocalperconfigtotal" key="_se_rewardreporttime"/>:</td>
			...
			<tr> 
                <td align=right>
                    ...
                    <input type="button" class="button_4" onmouseover="buttonover(this);" 
            			onclick="doExport('/cms/zjty/chzjtylocalperconfigtotal.do')" 
                        onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                    ...
                    <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                        ...
                        onClick="doDelete('/cms/zjty/chzjtylocalperconfigtotal.do')">
                    </c:if>
                </td>
			</tr>
		</table>
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="recid"/></td>
                <c:if test="${!protoken}">
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="wayname"/></td>
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="companytype"/></td>
                </c:if>
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="cityid"/></td>
                <c:if test="${!protoken}">
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="zjtyname"/></td>
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="connecttime"/></td>
                </c:if>
                <td><bean:message bundle="chzjtylocalperconfigtotal" key="total"/></td>
            </tr>
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms/zjty/chzjtylocalperconfigtotal.do?CMD=EDIT" var="urlContent">
