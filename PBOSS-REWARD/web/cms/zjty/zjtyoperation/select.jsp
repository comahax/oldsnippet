...
<html>
<head>
    <title><bean:message bundle="zjtyoperation" key="titleList"/></title>
    <base target="_self">
...
<html:form action="/cms/zjty/operation.do?CMD=SELECT" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
		<table class="top_table">
			<tr>
				<td><bean:message bundle="zjtyoperation" key="titleList" /></td>
            </tr>
        </table>
    </div>
    <div class="table_div">
	...
	<div class="table_div">
        <table class="form_table">
            <tr>
            	<td class="form_table_right"><bean:message bundle="zjtyoperation" key="opnid"/>:</td>
                <td class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_se_opnid"  maxlength="18"></html:text>
                </td>
                <td class="form_table_right"><bean:message bundle="zjtyoperation" key="name"/>:</td>
                <td class="form_table_left">
    ...
    <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head"  >
                <td>
                    <a href="javascript:doOrderby('opnid')"><bean:message bundle="zjtyoperation" key="opnid"/></a>
                    <s:OrderImg form="/cms/zjty/zjtyoperation/ZjtyOperationForm" field="opnid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('name')"><bean:message bundle="zjtyoperation" key="name"/></a>
