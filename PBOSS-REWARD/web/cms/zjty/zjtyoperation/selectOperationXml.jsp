<%@ page language="java" contentType="text/xml;charset=GBK"%><%@ page import="org.apache.commons.lang.StringUtils" %><% com.sunrise.boss.ui.cms.zjty.zjtyoperation.ZjtyOperationTreeBean wayTreeBean = new com.sunrise.boss.ui.cms.zjty.zjtyoperation.ZjtyOperationTreeBean(); 
	try {
		...
		String result=wayTreeBean.outputXml(request);
		out.println(result);
	}catch(Exception e) {
		e.printStackTrace();
	}
