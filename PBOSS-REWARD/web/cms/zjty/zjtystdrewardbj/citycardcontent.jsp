					...
					<table class="form_table">
						...
						<tr>
							...
							<td width="30%" colspan="3" class="form_table_left">
								...
								<font color=red>*</font>
								(省公司酬金上限:<font color="red"><fmt:formatNumber pattern="0.00" value="${requestScope['/cms/zjty/zjtystdrewardbj/ZjtyStdrewardbjForm'].rewardstd_fixed_limited}" /></font>元/百分比)
							</td>
						</tr>
						<tr>
							<td width="20%" align="right" class="form_table_right">
					...
					<table class="form_table">
						...
						<tr>
							...
							<td width="30%" colspan="3" class="form_table_left">
								...
								<font color=red>*</font>
								(省公司酬金上限:<font color="red"><fmt:formatNumber pattern="0.00" value="${requestScope['/cms/zjty/zjtystdrewardbj/ZjtyStdrewardbjForm'].rewardstd_integral_limited}" /></font>元/百分比)
							</td>
						</tr>
						<tr>
							<td width="20%" align="right" class="form_table_right">
					...
					<table class="form_table">
						...
						<tr>
							...
							<td width="30%" colspan="3" class="form_table_left">
								...
								<font color=red>*</font>
								(省公司酬金上限:<font color="red"><fmt:formatNumber pattern="0.00" value="${requestScope['/cms/zjty/zjtystdrewardbj/ZjtyStdrewardbjForm'].rewardstd_allowance_limited}" /></font>元/百分比)
							</td>
						</tr>
						<tr>
							<td width="20%" class="form_table_right">
