...
<head>
	...
	<script language="JavaScript" type="text/JavaScript">
        function ev_check() {
            formList.action=contextPath+"/cms/bbc/bbcfaildataquery.do?CMD=SELECT";
...
<body>
	<div class="table_container">
		<html:form action="/cms/bbc/bbcfaildataquery.do?CMD=SELECT"
			...
			<div class="table_div">
				<table class="top_table">
					<tr>
						<td>
							<bean:message bundle="bbcfaildataquery" key="adtremarkquery" />
						</td>
					</tr>
				</table>
			</div>
				...
				<table class="form_table">
					<tr>
						<td class="form_table_right">
							<bean:message bundle="bbcfaildataquery" key="adtcode" />
							:
						</td>
