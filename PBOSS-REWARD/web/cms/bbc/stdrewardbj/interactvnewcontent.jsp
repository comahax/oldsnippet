	...
	<body onload="loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/bbc/stdrewardbj.do?CMD=SAVE" styleId="formItem" method="post">
				...
				<html:hidden property="rewardproj" value="2" />
				...
				<c:set var="interfactor" scope="session" value="${sessionScope.INTERFACTOR}" />	
				<!--##################################添加标题内容##################################################-->
				<div class="table_div">
						...
						<tr>
							...
							<td width="30%" class="form_table_left" colspan=3>
								...
								<c:if test="${form.acctype_basic eq '1'}">
									<font color=red>(省公司酬金上限:<fmt:formatNumber value='${form.max_rewardstd*interfactor}' pattern='0.0000' />元)</font>
								</c:if>
								<c:if test="${form.acctype_basic eq '2'}">
									<font color=red>(省公司酬金上限:<fmt:formatNumber value='${form.max_rewardstd*100*interfactor}' pattern='0.0000' />%)</font>
								</c:if>
							</td>
						</tr>
					</table>
					...
					<table class="form_table">
						...
						<tr>
							...
							<td width="30%" class="form_table_left" colspan=3>
								...
								<font color=red>*&nbsp;(省公司上限:<fmt:formatNumber value='${form.max_city_rewardstd*interfactor}' pattern='0.0000' />元)</font>
							</td>
						</tr>
					</table>
