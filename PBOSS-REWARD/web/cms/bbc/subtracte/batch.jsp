	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/bbc/subtracte/batch.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.bbc.subtracte.SubtracteTaskBean";                                                                                        
			}
		}
		function doReturnList(){
    		window.location.href="<%=contextPath%>/cms/bbc/subtracte/list.jsp";
    	}	
    </script>
</head>
<body  onload＝" loadforiframe()">
<div class="table_container">
	<html:form action="/cms/bbc/subtracte/batch.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						<font color=red>内部员工号码</font>|<font color=red>计酬月份</font>|
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/bbc/subtracte/subtractebatch.xls">内部员工号码设置导入</a>
						（注：填写后请将数据转换为txt格式，去掉标题行，再上传导入）</td>
				</tr>
			</table>
		</div>
		<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.bbc.subtracte.SubtracteTaskBean"
