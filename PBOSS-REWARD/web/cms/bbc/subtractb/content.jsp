...
<html>
<head>
    <title><bean:message bundle="subtract" key="titleUpdate3"/></title>
    ...
    <script language="JavaScript">
        function ev_checkval() {
            ...
            addfield('blackmobile', '<bean:message bundle="subtract" key="blackmobile"/>', 'c', false, '15');
...
<html:form action="/cms/bbc/subtractb.do?CMD=SAVE" styleId="formItem" method="post">
    ...
    <html:hidden property="_sk_blackmobile"/>
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="subtract" key="titleUpdate3"/>
   			</td>
    	</tr>
    </table>
    </div>
    ...
    <div class="table_div">
        <table class="form_table">
        	<tr>
        	 ...
        	 <tr>
                <td width="20%" align="right" class="form_table_right"><div class="field-require"><bean:message bundle="subtract" key="blackmobile"/>:</div></td>
                <td width="30%" align="left" class="form_table_left">
                    <c:choose>
                        <c:when test="${edtState}">
                        	<c:if test="${!updateState}">
                        		<html:text styleClass="form_input_1x" property="blackmobile"/>
                        		<font color=red>&nbsp;*</font>
                        	</c:if>
                        	<c:if test="${updateState}">
                        		<html:text styleClass="form_input_1x" property="blackmobile" disabled="true"/>
							<font color=red>&nbsp;*</font>
                        	</c:if>         
                        </c:when>
                        <c:otherwise>
            ...
            <tr>
                <td width="100%" class="form_table_center">
                    <input type="button" onmouseover="buttonover(this);" onmouseout="buttonout(this);"
                           ...
                           onclick="doSave('/cms/bbc/subtractb.do?CMD=SAVE')"/>
                    <input type="button" onmouseover="buttonover(this);" onmouseout="buttonout(this);"
                           name="btnReturn" onfocus="buttonover(this)" onblur="buttonout(this)"
                           value="<bean:message bundle="public" key="button_return"/>" class="close"
                           onclick="doReturn('/cms/bbc/subtractb.do?CMD=LIST')">  
                </td>
            </tr>
        </table>
    </div>
