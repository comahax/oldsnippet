...
<html>
<head>
    <title><bean:message bundle="bbcadjust" key="titleList"/></title>
	...
	<script language="JavaScript" type="text/JavaScript">
        ...
        function upload(){
			var form=document.forms[0];
			form.action="<%=contextPath%>/cms/bbc/bbcadjust/batchupfile.jsp";
			form.submit();
		}
		
		function doAuditing(){
        		var url = '<%=contextPath%>/cms/waitaudit.do?CMD=LIST&_ne_subsystem=3';
		    	formList.action = url;
		    	formList.submit();
        }
    </script>
...
<html:form action="/cms/bbc/bbcadjust.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="bbcadjust" key="titleList"/>
   			</td>
    	</tr>
    </table>
    </div>
			...
			<tr>
				...
				<td class="form_table_left">
					<html:select property="_se_adjustkind"
						...
						<option />
						<option value="PUNISH">扣减</option>
						<option value="RETURN">返还</option>
					</html:select>
				</td>
				<td width="126" height="20" align="right"
					class="form_table_right">
			...
			<tr>
				<td align=right>
					...
					<input type="button" name="btnDelete" class="delete"
						...
						onClick="doDelete('/cms/bbc/bbcadjust.do')">
					</s:RewardPurChk>
					<s:RewardPurChk controlid="<%=ID_1%>" disableChild="true">
