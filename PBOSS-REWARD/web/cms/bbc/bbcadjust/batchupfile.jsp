...
<html>
	<head>
        ...
        function checkProcess(){
			...
			if(filename != null || filename != ""){
    			...
    			window.location.href="<%=contextPath%>/cms/bbc/bbcadjust/upload.do?CMD=BATCH&filename="+filename+"&beanname=com.sunrise.boss.ui.cms.bbc.bbcadjust.BbcadjustTaskBean";
    		}
		}
        function getpath(){
	...
	<body  onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/bbc/bbcadjust/upload.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
				...
				<div class="table_div">
					<table class="form_table">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<a href="<%= contextPath %>/cms/bbc/bbcadjust/bbcadjust.xls">B2M网站酬金调整导入模版.xls</a>&nbsp;&nbsp;
					...
					<table class="table_button_list">
						<tr>
							...
							<input type="button" value="返回" class="back"
								onmouseover="buttonover(this)" onmouseout="buttonout(this)" onfocus="buttonover(this)" onblur="buttonout(this)"
								ID="buttonProcess" NAME="buttonProcess" onClick="doReturn('/cms/bbc/bbcadjust.do?CMD=LIST')" />
							</td>
						</tr>
					</table>
				</div>
