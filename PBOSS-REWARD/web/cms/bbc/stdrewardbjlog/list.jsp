...
<html>
<head>
    <title><bean:message bundle="bbcstdrewardbjlog" key="titleList"/></title>
...
<html:form action="/cms.bbc/bbcstdrewardbjlog.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
		<table class="top_table">
			<tr> 
				...
				<td width="210" class="AreaName" align="left" valign=middle><bean:message bundle="bbcstdrewardbjlog" key="list"/></td>
				<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" ID="Table3">
                    ...
                    <td align=right>
                        <s:PurChk controlid="<%=ID_1%>">
                            ...
                            value="<bean:message bundle="public" key="button_new"/>" onClick="doNew('/cms.bbc/bbcstdrewardbjlog.do')">
                        </s:PurChk>
                        <s:PurChk controlid="<%=ID_2%>">
                            <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                            onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                            value="<bean:message bundle="public" key="button_delete"/>" onClick="doDelete('/cms.bbc/bbcstdrewardbjlog.do')">
                        </s:PurChk>
    ...
    <div class="table_div">
        <table class="table_style" ID="Table2">
            ...
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms.bbc/bbcstdrewardbjlog.do?CMD=EDIT" var="urlContent">
