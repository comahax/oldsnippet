...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
		...
		function doBatch()
		{
			var url="<%=contextPath%>/cms/bbc/mmopn/batchupfile.jsp";
			window.location.href=url;
			
		}function doExcel()
		{
			var url="<%=contextPath%>/cms/bbc/mmopn.do?CMD=EXCEL";
			formList.action=url;
			formList.submit();
			formList.action="<%=contextPath%>/cms/bbc/mmopn.do?CMD=LIST";
		}
    </script>
</head>
...
<html:form action="/cms/bbc/mmopn.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
		...
		<table class="table_button_list">
			<tr> 
                <td align=right>
                            ...
                            onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                            value="<bean:message bundle="public" key="button_new"/>" onClick="doNew('/cms/bbc/mmopn.do')">
                            <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                            onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                            value="<bean:message bundle="public" key="button_delete"/>" onClick="doDelete('/cms/bbc/mmopn.do')">
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td>
                    <a href="javascript:doOrderby('acctype')"><bean:message bundle="mmopn" key="acctype"/></a>
                    <s:OrderImg form="/cms/bbc/mmopn/MmopnForm" field="acctype"/>
                </td>
                <td>
                ...
                <td>
                    <a href="javascript:doOrderby('ossrc')"><bean:message bundle="mmopn" key="ossrc"/></a>
                    <s:OrderImg form="/cms/bbc/mmopn/MmopnForm" field="ossrc"/>
                </td>
                <td>
                ...
                <td>
                    <a href="javascript:doOrderby('opnmon')"><bean:message bundle="mmopn" key="opnmon"/></a>
                    <s:OrderImg form="/cms/bbc/mmopn/MmopnForm" field="opnmon"/>
                </td>
            </tr>
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms/bbc/mmopn.do?CMD=EDIT" var="urlContent">
