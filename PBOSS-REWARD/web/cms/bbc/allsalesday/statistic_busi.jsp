...
<html>
<head>
    <title><bean:message bundle="allsalesday" key="stat_busiTitle"/></title>
...
<html:form action="/cms/bbc/allsalesday.do?CMD=STATISTICBUSIDETAIL" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="allsalesday" key="stat_busiTitle"/>
   			</td>
    	</tr>
    </table>
    </div>
