...
<html>
<head>
    <title><bean:message bundle="allsalesday" key="stat_waybusiTitle"/></title>
...
<html:form action="/cms/bbc/allsalesday.do?CMD=STATISTICWAYBUSIDETAIL" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="allsalesday" key="stat_waybusiTitle"/>
   			</td>
    	</tr>
    </table>
    </div>
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
            	<td>
                    <bean:message bundle="allsalesday" key="wayid"/>
                </td>
                <td>
                    <bean:message bundle="allsalesday" key="wayname"/>
                </td>
            	<td>
                    <bean:message bundle="allsalesday" key="statistic_opnid"/>
                </td>
                <td>
                    <bean:message bundle="allsalesday" key="statistic_opnname"/>
                </td>
                <td>
