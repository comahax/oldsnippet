	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/terminalrewardstd/batch.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.terminalrewardstd.TerminalrewardstdTaskBean&region="+region;                                                                                        
			}
		}
		function doReturnList(){
    		window.location.href="<%=contextPath%>/cms/terminalrewardstd.do?CMD=LIST&region=000";
    	}	
    </script>
</head>
<body  onload＝" loadforiframe()">
<div class="table_container">
	<html:form action="/cms/terminalrewardstd/batch.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
		<input type="hidden" name="region"  value="000">
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						...
						<font color=red>酬金类型</font>|
						<font color=red>计酬类型</font>|备注|
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left">
						酬金类型:<br>
						1.合约终端酬金;2.零合约终端酬金;3.裸机终端基础酬金;4.裸机终端省激励酬金; 5.裸机终端市激励酬金;6.地市个性化裸机酬金;<br>
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/terminalrewardstd/Terminalrewardstd.xls">终端酬金标准参数管理导入</a>
						（注：填写后请将数据转换为txt格式，去掉标题行，再上传导入）</td>
				</tr>
			</table>
		</div>
		<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.terminalrewardstd.TerminalrewardstdTaskBean"
