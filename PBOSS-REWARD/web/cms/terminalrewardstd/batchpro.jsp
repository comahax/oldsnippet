	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/terminalrewardstd/batchpro.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.terminalrewardstd.TerminalrewardstdTaskBean&region="+region;                                                                                        
			}
		}
		function doReturnList(){
    		window.location.href="<%=contextPath%>/cms/terminalrewardstd.do?CMD=LIST&region=999";
    	}	
    </script>
</head>
<body  onload＝" loadforiframe()">
<div class="table_container">
	<html:form action="/cms/terminalrewardstd/batchpro.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
		<input type="hidden" name="region"  value="999">
		<input type="hidden" name="filename" value="<c:out value='${requestScope.ITEM.inFile}'/>">		
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left">
						酬金类型:<br>
						1.合约终端酬金;2.零合约终端酬金;3.裸机终端基础酬金;4.裸机终端省激励酬金;<br>
