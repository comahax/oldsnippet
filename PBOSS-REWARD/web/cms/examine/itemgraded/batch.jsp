...
<html>
	<head>
        ...
        function checkProcess(){
			...
			if(filename != null || filename != ""){
    			...
    			window.location.href="<%=contextPath%>/cms/examine/itemgraded/upload.do?CMD=BATCH&filename="+filename+"&beanname=com.sunrise.boss.ui.cms.examine.itemgraded.ItemgradedTaskBean";
    		}
		}
        function getpath(){
	...
	<body onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/examine/itemgraded/upload.do?CMD=UPLOAD"
					...
					<table class="form_table">
						<tr>
							<td width="126" height="20" align="right"
								...
								<bean:message bundle="itemgraded" key="selectfile" />
								:
							</td>
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<p>
									<font color="red">渠道代码|考核标识|指标标识|考核周期|扣罚分数|</font>考核说明|
								</p>
							</td>
						</tr>
						<tr class="table_style_content">
							...
							<td align=left>
								JFJM00000|5|201|200911|5.20|说明|
							</td>
						</tr>
			...
			<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.examine.itemgraded.ItemgradedTaskBean"
