...
<html>
<head>
    <title><bean:message bundle="waylog" key="strttitleList"/></title>
...
<html:form action="/cms/waylog.do?CMD=STRTLIST" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="waylog" key="strttitleList"/>
   			</td>
    	</tr>
    </table>
    </div>
