...
<html:form action="/cms/employee.do?CMD=SOCIETYLIST" styleId="formList" method="post" onsubmit="return ev_check();">
	...
	<div class="table_div">
        <table class="form_table">
            <tr>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="_ne_employeeid"/>:</td>
                <td class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_ne_employeeid"></html:text>
                </td>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="_sk_employeename"/>:</td>
                <td class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_sk_employeename"></html:text>
                </td>
            </tr>
            <tr>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="_dnl_intime"/>:</td>
                <td class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_dnl_intime" onclick="this.value=selectDate()"></html:text>
                </td>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="_dnm_intime"/>:</td>
                <td class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_dnm_intime" onclick="this.value=selectDate()"></html:text>
                </td>
            </tr>
            <tr>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="wayid3"/>:</td>
                <td class="form_table_left">
                    <html:hidden property="_sk_wayid"/>
                	<input type="text" name="way_name" value='<c:out value="${requestScope['/cms/employee/EmployeeForm']._sk_wayid}"/> <s:Code2Name code="${requestScope['/cms/employee/EmployeeForm']._sk_wayid}" definition="#WAY"/>'  onclick="showSelectWay(this,'_sk_wayid')" disabled="true" class="form_input_1x">
                </td>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="_se_svccode"/>:</td>
                <td class="form_table_left">
                    <html:text property="_se_svccode" styleClass="form_input_1x"></html:text>
					<input type="button" name="button1" value="..." onclick="showOrgTree(this,'_se_svccode','Svc');">
                </td>
            </tr>
             <tr>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="officetel2"/>:</td>
                <td class="form_table_left">
                	<html:text property="_se_officetel" styleClass="form_input_1x"></html:text>
                </td>
                <td width="126" height="20" align="right" class="form_table_right" ><bean:message bundle="employee" key="isnet"/>:</td>
                <td class="form_table_left">
			...
			<tr> 
                <td align=right>
                        ...
                        <input type="button" class="query"onmouseover="buttonover(this);"
                                onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                                value="<bean:message bundle="employee" key="batchExport"/>" onclick="doExport()"/>
                        </s:PurChk2>
                        <s:PurChk2 controlid="<%=ID_add%>">
                            <input type="button" name="btnNew"  class="add" onmouseover="buttonover(this);"
                            onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                            value="<bean:message bundle="public" key="button_new"/>" onClick="doNewSociety()">
                        </s:PurChk2>
                        <s:PurChk2 controlid="<%=ID_import%>">
                        <input type="button" class="query"onmouseover="buttonover(this);"
                                onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                                value="<bean:message bundle="employee" key="import"/>"  onClick="doBatch('/cms/societyemployee.do?CMD=SOCIETYBATCH');"/>
                        </s:PurChk2>
                        <s:PurChk2 controlid="<%=ID_delete%>">
                            <input type="button" name="btnDelete" class="delete" onmouseover="buttonover(this);"
                            onmouseout="buttonout(this);" onfocus="buttonover(this)" onblur="buttonout(this)"
                            value="<bean:message bundle="public" key="button_delete"/>" onClick="societydelete();">
                        </s:PurChk2>
                </td>
			</tr>
		</table>
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td>
                    <a href="javascript:doOrderby('birthday')"><bean:message bundle="employee" key="birthday"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="birthday"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('sex')"><bean:message bundle="employee" key="sex"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="sex"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('empstatus')"><bean:message bundle="employee" key="empstatus"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="empstatus"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('cardid')"><bean:message bundle="employee" key="cardid"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="cardid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('telephone')"><bean:message bundle="employee" key="telephone"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="telephone"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('cityid')"><bean:message bundle="employee" key="cityid"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="cityid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('countyid')"><bean:message bundle="employee" key="countyid"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="countyid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('svccode')"><bean:message bundle="employee" key="svccode"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="svccode"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('wayid')">网点编码</a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="wayid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('wayid')"><bean:message bundle="employee" key="wayid3"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="wayid"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('intime')"><bean:message bundle="employee" key="intime"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="intime"/>
                </td>


                <td>
                    <a href="javascript:doOrderby('employtype')"><bean:message bundle="employee" key="employtype"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="employtype"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('bail')"><bean:message bundle="employee" key="bail"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="bail"/>
                </td>
              <td>
                    <a href="javascript:doOrderby('officetel')"><bean:message bundle="employee" key="officetel2"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="officetel"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('isnet')"><bean:message bundle="employee" key="isnet"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="isnet"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('isopen')"><bean:message bundle="employee" key="isopen"/></a>
                    <s:OrderImg form="/cms/employee/employeeForm" field="isopen"/>
                </td>
                <td>
                    <a href="javascript:doOrderby('netpass')"><bean:message bundle="employee" key="netpass"/></a>
                      <s:OrderImg form="/cms/employee/employeeForm" field="netpass"/>
                </td>
            </tr>
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms/employee.do?CMD=SOCIETYEDIT" var="urlContent">
                 ...
                 <tr class="table_style_content" align="center">
                     ...
                     <td><s:Code2Name code="${item.employtype}" definition="$CH_EMPLOYTYPE"/></td>
                     <td><c:out value="${item.bail}"/></td>
