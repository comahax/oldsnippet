...
function checkProcess(){
	...
	if(filename != null || filename != ""){
    	...
    	window.location.href="<%=contextPath%>/cms/batchsocietyemployee/process.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.batchsocietyemployee.BatchTaskBean";
    }
}
function doReturn(cmdReturn) {
	...
	<body onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/batchsocietyemployee/process.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
				...
				<div class="table_div">
					<table class="table_style" width="95%">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<bean:message bundle="employee" key="societyformat" />
							</td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
							...
							<td align=left>
								<bean:message bundle="employee" key="societyexample" />
							</td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
							...
							<td align=left>
								<bean:message bundle="employee" key="societynote" />
							</td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<a href="<%=contextPath%>/cms/societyemployee/societyimport.xls"><bean:message bundle="employee" key="societymodelname" /></a>
								<bean:message bundle="employee" key="hint" /></td>
						</tr>
					</table>
				</div>
			<iframe src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.batchsocietyemployee.BatchTaskBean"  frameborder="0" class="loadframe" id="loadframe"  scrolling="yes"></iframe>
			<div class="table_div">
					...
					<tr>
						<td>
							...
							<input type="button" onmouseover="buttonover(this);"
								...
								class="comfir" onclick="doReturn('/cms/employee.do?CMD=SOCIETYLIST')">	
