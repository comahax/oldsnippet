			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						<font color=red>渠道编码|VI形象|面积|门头广告（宣传）|手机背板（宣传）|基础宣传类（宣传）|</font>
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left">
						<table class="form_table">
						  <tr class="table_style_content">
							<td>类别</td><td>项目</td><td>专营</td><td>兼营</td>
						  </tr>
						  <tr class="table_style_content">
							<td rowspan=4>VI形象</td><td>全门头</td><td>0.6</td><td>--</td>
						  </tr>
						  <tr class="table_style_content">
							<td>联合门头</td><td>0.5</td><td>0.3</td>
						  </tr>
						  <tr>
							<td>专区</td><td>0.4</td><td>0.2</td>
						  </tr>
						  <tr>
							<td>专柜或无形象</td><td>0.1</td><td>--</td>
						  </tr>
						  <tr>
							<td rowspan=5>面积</td><td>300平米以上</td><td>0.6</td><td>0.3</td>
						  </tr>
						  <tr>
							<td>120平米-300平米</td><td>0.5</td><td>0.2</td>
						  </tr>
						  <tr>
							<td>60平米-120平米</td><td>0.4</td><td>0.1</td>
						  </tr>
						  <tr>
							<td>30平米-60平米</td><td>0.3</td><td>--</td>
						  </tr>
						  <tr>
							<td>10平米-30平米</td><td>0.2</td><td>--</td>
						  </tr>
						  <tr>
							<td rowspan=3>宣传</td><td>门头广告</td><td>0.2</td><td>0.2</td>
						  </tr>
						  <tr>
							<td>手机背板</td><td>0.1</td><td>0.1</td>
						  </tr>
						  <tr>
							<td>基础宣传类</td><td>0.1</td><td>0.1</td>
						  </tr>
						</table>
					</td>
				</tr>
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/chadtwaymod/chadtwaymod.xls">商圈门店补贴调节系数导入</a>
