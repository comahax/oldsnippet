...
<html>
	<head>
		<title>宽带客户资料批量导入</title>
		<script language="JavaScript" type="text/JavaScript">
        function checkProcess(){
			var filename = formItem.filename.value;
			if(filename != null || filename != ""){
        		formItem.buttonProcess.disabled=true;
    			window.location.href="<%=contextPath%>/cms/kdkhzl/chpwregisterbroad/upload.do?CMD=BATCH&filename="+filename+"&beanname=com.sunrise.boss.ui.cms.kdkhzl.chpwregisterbroad.ChPwRegisterbroadTaskBean";
    		}
		}
	...
	<body  onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/kdkhzl/chpwregisterbroad/upload.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
				...
				<div class="table_div">
					<table class="form_table">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<font color=red>公务机号码|联系电话|宽带数量|登记时间|</font>
						</td>
						</tr>
						<tr class="table_style_content">
							<td align=right height=25>
							...
							<td align=left>
								<font color=red>13502001234|13602001234|57|2099-09-09 10:24:56|</font>
							</td>
						</tr>
						<tr class="table_style_content">
					...
					<table class="table_button_list">
						<tr>
							...
							<input type="button" value="返回" class="back"
								onmouseover="buttonover(this)" onmouseout="buttonout(this)" onfocus="buttonover(this)" onblur="buttonout(this)"
								ID="buttonProcess" NAME="buttonProcess" onClick="doReturn('/cms/kdkhzl/chpwregisterbroad.do?CMD=LIST')" />
							</td>
						</tr>
					</table>
				</div>
			</html:form>
			<iframe src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.kdkhzl.chpwregisterbroad.ChPwRegisterbroadTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
			</iframe>
		</div>
	</body>
</html>
