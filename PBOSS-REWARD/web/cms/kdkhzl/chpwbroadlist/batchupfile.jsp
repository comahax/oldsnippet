...
<html>
	<head>
		<title>宽带客户白名单登记批量导入</title>
		<script language="JavaScript" type="text/JavaScript">
        function checkProcess(){
			var filename = formItem.filename.value;
			if(filename != null || filename != ""){
        		formItem.buttonProcess.disabled=true;
    			window.location.href="<%=contextPath%>/cms/kdkhzl/chpwbroadlist/upload.do?CMD=BATCH&filename="+filename+"&beanname=com.sunrise.boss.ui.kdkhzld.chpwbroadlist.ChPwBroadlistTaskBean";
    		}
		}
	...
	<body  onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/kdkhzl/chpwbroadlist/upload.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
				...
				<div class="table_div">
					<table class="form_table">
						...
						<tr class="table_style_content">
							...
							<td align=left>
								<font color=red>13502001234|</font>
							</td>
						</tr>
						<tr class="table_style_content">
					...
					<table class="table_button_list">
						<tr>
							...
							<input type="button" value="返回" class="back"
								onmouseover="buttonover(this)" onmouseout="buttonout(this)" onfocus="buttonover(this)" onblur="buttonout(this)"
								ID="buttonProcess" NAME="buttonProcess" onClick="doReturn('/cms/kdkhzl/chpwbroadlist.do?CMD=LIST')" />
							</td>
						</tr>
					</table>
				</div>
			</html:form>
			<iframe src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.kdkhzld.chpwbroadlist.ChPwBroadlistTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
			</iframe>
		</div>
	</body>
</html>
