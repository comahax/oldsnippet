    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doSave() { 
        	...
        	if (sis.length == undefined) {
       		 ...
       		 formList.action ="<%=contextPath%>/cms/et/chetstdreward.do?CMD=SAVERULEDETAIL&a="+a+"&PK=<%=pk%>";
       		 formList.submit(); 
		}
        ...
        function doBack(){     
	    	formList.action="<%=contextPath%>/cms/et/chetstdreward.do?CMD=LIST";
	    	formList.submit();
	    }
                 ...
                 <tr class="table_style_content" align="center">
                 	  <td >
       					<c:if test="${item2.isdefault == 1}">
				               ...
				               checked="checked"  disabled="true"    onclick="checkRuleitem(this);" class="table_checkbox" disabled="disabled">
               			...
               			<c:if test="${empty item2.isdefault }" >
		        			...
		        			<input type="checkbox" name="ruleitemids"  <c:out value='${item2.ruleitemid}' /> value="<c:out value='${item2.ruleitemid}' />"
				                checked="checked"      onclick="checkRuleitem(this);" class="table_checkbox" disabled="disabled">
				        	</c:when>
				        	<c:otherwise>
			        			<input type="checkbox" name="ruleitemids"  <c:out value='${item2.ruleitemid}' /> value="<c:out value='${item2.ruleitemid}' />"
					                     onclick="checkRuleitem(this);" class="table_checkbox" disabled="disabled">
				        	</c:otherwise>
				        	</c:choose>
				        </c:if>
