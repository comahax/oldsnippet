...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function ev_check() {
         ...
         function doExport(){
			formList.action = "<%=contextPath%>/cms/et/chetadtrecord.do?CMD=FAILTXT";
  			formList.submit();
  			formList.action="<%=contextPath%>/cms/et/chetadtrecord.do?CMD=FAILLIST";
		}
    </script>
</head>
...
<html:form action="/cms/et/chetadtrecord.do?CMD=FAILLIST" styleId="formList" method="post" onsubmit="return ev_check();">
		...
		<table class="table_button_list">
			<tr> 
                <td align=right>
                            ...
                            <input type="button" class="query" onmouseover="buttonover(this);" onclick="doQuery('/cms/et/chetadtrecord.do?CMD=FAILLIST');"
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            ...
            <c:forEach var="item" items="${requestScope.LIST.datas}">
                 <c:url value="/cms/et/chetadtrecord.do?CMD=EDIT" var="urlContent">
                     <%//this param name must "PK" %>
                     <c:param name="PK" value="${item.seq}|${item.srcseq}"/>
