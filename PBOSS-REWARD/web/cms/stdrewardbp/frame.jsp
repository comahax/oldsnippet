...
<html>
	...
	<body>
		...
		<div class="table_container">
		  ...
		  addmenuleft();	
		  <s:PurChk2 controlid="<%=ID_1%>">   addmenu('<%=contextPath%>/cms/stdrewardbp.do?CMD=<c:out value="${cmds}"/>&str=content&PK=<c:out value="${framerewardid}"/>','项目启动金上限设置'); </s:PurChk2>  
		  <s:PurChk2 controlid="<%=ID_2%>">   addmenu('<%=contextPath%>/cms/stdrewardbp.do?CMD=<c:out value="${cmds}"/>&str=content1&PK=<c:out value="${framerewardid}"/>','市公司项目启动金标准设置')  </s:PurChk2> 
