    ...
    <div>  
	    ...
	    <div class="iframemenu">
			<script language="javascript">
			    <s:PurChk2 controlid="<%=ID_1%>"> addmenu("<%=contextPath%>/cms/strtway/frame.jsp","<bean:message bundle="index" key="strtwaybase"/>");</s:PurChk2>
			    <s:PurChk2 controlid="<%=ID_1%>"> addmenu("<%=contextPath%>/cms/strtbchcontact.do?CMD=LIST&WAYSUBTYPE=STRT","<bean:message bundle="index" key="strtwaycon"/>");</s:PurChk2>
			    <s:PurChk2 controlid="<%=ID_1%>"> addmenu("<%=contextPath%>/cms/strtwaycompact.do?CMD=LIST&WAYSUBTYPE=STRT","<bean:message bundle="index" key="strtwaycom"/>");</s:PurChk2>
			    <s:PurChk2 controlid="<%=ID_1%>"> addmenu("<%=contextPath%>/cms/strtwayaccount.do?CMD=LIST&WAYSUBTYPE=STRT","<bean:message bundle="index" key="strtwayacc"/>");</s:PurChk2>
			</script>
		</div>
		
		<div id="message">
			<iframe framespacing="0" frameborder="NO" Scrolling="no"  name="IFRM_MAIN" id="IFRM_MAIN" class="IFRM_MAIN_on"  src="<%=contextPath%>/cms/strtway.do?CMD=LIST&WAYSUBTYPE=STRT"></iframe>
		</div>
