	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/chadtimportrecord/batch.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.reward.chadtimportrecord.ChAdtImportrecordTaskBean";                                                                                        
			}
		}
...
<div class="table_container">
	<html:form action="/cms/chadtimportrecord/batch.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						...
						业务编码|办理时间|
						<font color=red>导入类型</font>|办理金额|系数|备注|
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						KCFLLKJ|13879067890|0606010100004|2008-09-01|21|5|1|ok|
					</td>
				</tr>
				<tr class="table_style_content">
					<td width="20%" align="right" class="form_table_right">
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/reward/chadtimportrecord/chadtimportrecord.xls">地市办理业务数据导入</a>
						（注：填写后请将数据转换为txt格式，去掉标题行，再上传导入）</td>
				</tr>
			</table>
		</div>
		<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.reward.chadtimportrecord.ChAdtImportrecordTaskBean"
