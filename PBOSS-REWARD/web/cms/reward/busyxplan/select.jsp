...
<head>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function ev_check() {
            ...
            formList._se_areacode.disabled=false;
            var hasRight=0;
        	<s:RewardPurChk controlid="<%=ID_1%>">hasRight=1;</s:RewardPurChk>
        	if(hasRight==0){
        		 formList.action=contextPath+"/cms/reward/busyxplan.do?CMD=SELECT&RIGHT=NO";
        		 formList.submit();
        	}else{
        		 formList.action=contextPath+"/cms/reward/busyxplan.do?CMD=SELECT&RIGHT=YES";
        		 formList.submit();
        	}
        }
...
<html:form action="/cms/reward/busyxplan.do?CMD=SELECT" styleId="formList" method="post" onsubmit="return ev_check();">
        ...
        <table class="form_table">
			...
			<tr>
				...
				<s:RewardPurChk controlid="<%=ID_1%>" disableChild="true" >
					<html:select property="_se_areacode">
						<option value=""  ></option>		                		
        ...
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td nowrap>
                    ...
                    <s:OrderImg form="/cms/reward/busyxplan/BusyxplanForm" field="yxplanname"/>
                </td>
                <td nowrap>
                    <a href="javascript:doOrderby('areacode')"><bean:message bundle="yxplan" key="areacode"/></a>
                    <s:OrderImg form="/cms/reward/busyxplan/BusyxplanForm" field="areacode"/>
                </td>
             </tr>
