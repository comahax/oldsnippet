			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						<font color=red>渠道编码</font>|<font color=red>渠道类型</font>|
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left">
						渠道类型：SN.苏宁渠道查询；GM.国美渠道（查询CH_WAYSPETYPE参数）。<br>
						渠道编码必须在渠道表有相关信息。<br>						
					</td>
				</tr>
				<tr class="table_style_content">
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/reward/chadtwayspecialreward/chadtwayspecialreward.xls">特殊计酬渠道设置导入</a>
