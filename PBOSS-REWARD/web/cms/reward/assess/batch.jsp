	...
	<script language="JavaScript">
		function checkProcess(){
			...
			if(filename != null || filename != ""){
	      		...
	      		window.location.href="<%= contextPath%>/cms/assess/batch.do?filename="+filename+"&beanname=com.sunrise.boss.ui.cms.reward.assess.AssessTaskBean";                                                                                        
			}
		}
		function doReturnList(){
    		window.location.href="<%=contextPath%>/cms/reward/assess/list.jsp";
    	}	
    </script>
</head>
<body  onload＝" loadforiframe()">
<div class="table_container">
	<html:form action="/cms/assess/batch.do?CMD=UPLOAD" styleId="formItem" method="post" enctype="multipart/form-data">
			...
			<table class="form_table">	
				...
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						<font color=red>渠道编码</font>|<font color=red>考核类型</font>|
						<font color=red>考核值</font>|
						<font color=red>考核月份</font>|说明备注|
						（注：红色字体为必须录入字段）
					</td>
				</tr>
				<tr class="table_style_content">
					...
					<td width="75%" align="left" class="form_table_left" nowrap="false">
						KCFLLKJ|1|57|201106|本期考核存在排它违规|
					</td>
				</tr>
				<tr class="table_style_content">
					<td width="20%" align="right" class="form_table_right">
					...
					<td width="75%" align="left" class="form_table_left">
						<% if ("yes".equals(flag)) { %><br>考核值不能大于80分 <%} %>
						<br>
						<%=
				...
				<tr class="table_style_content">
					...
					<td align=left>
						<a href="<%=contextPath%>/cms/reward/assess/assess.xls">考核分数导入</a>
						（注：填写后请将数据转换为txt格式，去掉标题行，再上传导入）</td>
				</tr>
			</table>
		</div>
		<iframe
				src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.reward.assess.AssessTaskBean"
