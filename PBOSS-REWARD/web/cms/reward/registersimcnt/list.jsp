...
<html>
<head>
    <title><bean:message bundle="registersimcnt" key="titleList"/></title>
    <script type="text/javascript" src="<%=contextPath%>/js/bus/waycommon.js"></script>
    <script language="JavaScript" type="text/JavaScript">
        function ev_check() {
            addfield('_se_wayid', '<bean:message bundle="registersimcnt" key="wayid"/>', 'c', 'false', '18');
            addfield('_se_waymagcode', '<bean:message bundle="registersimcnt" key="waymagcode"/>', 'c', 'false', '18');
            addfield('_ne_brand', '<bean:message bundle="registersimcnt" key="brand"/>', 'f', 'false', '3');
            addfield('_se_countyid', '<bean:message bundle="registersimcnt" key="countyid"/>', 'c', 'false', '14');
            addfield('_se_svccode', '<bean:message bundle="registersimcnt" key="svccode"/>', 'c', 'false', '14');
            addfield('_dnm_oprtime', '<bean:message bundle="registersimcnt" key="oprtime"/>', 'dt', 'false', '7');
            addfield('_dnl_oprtime', '<bean:message bundle="registersimcnt" key="oprtime"/>', 'dt', 'false', '7');
            addfield('_dnm_activedate', '<bean:message bundle="registersimcnt" key="activedate"/>', 'dt', 'false', '7');
            addfield('_dnl_activedate', '<bean:message bundle="registersimcnt" key="activedate"/>', 'dt', 'false', '7');
        ...
        function compareDate(){
	        ...
	        if (startTime2 == '') {
	        	var alertstr = '<span class=\'errorkey\'><span style=\'color:#F00; font-size:12px;\'>[<bean:message bundle="registersimcnt" key="_dnl_oprtime"/>]</span> 不能为空';
	        	errorMessageShow(alertstr);
		        return false;
	        }
	        if (endTime2 == '') {
	        	var alertstr = '<span class=\'errorkey\'><span style=\'color:#F00; font-size:12px;\'>[<bean:message bundle="registersimcnt" key="_dnm_oprtime"/>]</span> 不能为空';
	        	errorMessageShow(alertstr);
		        return false;
	        }
	        if(startTime1 != '' && endTime1 != '' &&  startTime1>endTime1){
		        var alertstr = '<span class=\'errorkey\'><span style=\'color:#F00; font-size:12px;\'>[<bean:message bundle="registersimcnt" key="_dnl_activedate"/> ]</span> 不能大于 <span style=\'color:#F00; font-size:12px;\'>[<bean:message bundle="registersimcnt" key="_dnm_activedate"/>]</span>';
				errorMessageShow(alertstr);
		        return false;
	   		}
	        if(startTime2 != '' && endTime2 != '' &&  startTime2>endTime2){
		        var alertstr = '<span class=\'errorkey\'><span style=\'color:#F00; font-size:12px;\'>[<bean:message bundle="registersimcnt" key="_dnl_oprtime"/> ]</span> 不能大于 <span style=\'color:#F00; font-size:12px;\'>[<<bean:message bundle="registersimcnt" key="_dnm_oprtime"/>]</span>';
				errorMessageShow(alertstr);
		        return false;
	       	}
	   		return true;	
    	...
    	function doExcel(){
	    	formList.action="<%=contextPath%>/cms/reward/registersimcnt.do?CMD=EXCEL";
	    	formList.submit();
	    	formList.action="<%=contextPath%>/cms/reward/registersimcnt.do?CMD=LIST";
    	}
    	function openPicker(control,codeid) {
            if(codeid == '_se_svccode') {
                if(document.all('_se_countyid').value == "") {
    	            // 选择“服务销售中心编码”前要先指定“分公司” 
    	            alert("请先输入"+'<bean:message bundle="registersimcnt" key="countyid"/>');
    	            return;
                }else {
        ...
        function doshowDetail(str, str1, str2){
        	formList.action = "<%=contextPath%>/cms/reward/registersimcnt.do?CMD=SELECTLIST&wayid="+str+"&countyid=" + str1 + "&starlevel="+str2 + "&flg=false";
        	formList.submit();
		}
    </script>
</head>
...
<html:form action="/cms/reward/registersimcnt.do?CMD=LIST" styleId="formList" method="post" onsubmit="return ev_check();">
    ...
    <table class="top_table">
    	<tr>
    		<td>
    			<bean:message bundle="registersimcnt" key="titleList"/>
   			</td>
    	</tr>
    </table>
    </div>
	...
	<div class="table_div">
        <table class="form_table">
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="waymagcode"/>:</td>
                ...
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="wayid"/>:</td>
                <td width="30%" class="form_table_left">
            ...
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="countyid"/>:</td>
                <td width="30%" class="form_table_left">
                ...
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="svccode"/>:</td>
                <td width="30%" class="form_table_left">
            ...
            <tr><td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="_dnl_oprtime"/>:</td>
                <td width="30%" class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_dnl_oprtime" onclick="selectDatetime();"></html:text>
                    <font color="red">*</font>
                </td>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="_dnm_oprtime"/>:</td>
                <td width="30%" class="form_table_left">
            ...
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="_dnl_activedate"/>:</td>
                <td width="30%" class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_dnl_activedate" onclick="selectDatetime();"></html:text>
                </td>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="_dnm_activedate"/>:</td>
                <td width="30%" class="form_table_left">
                    <html:text styleClass="form_input_1x" property="_dnm_activedate" onclick="selectDatetime();"></html:text>
                </td>
            </tr>
            <tr>
                <td width="20%" height="20" align="right" class="form_table_right" ><bean:message bundle="registersimcnt" key="brand"/>:</td>
                <td width="30%" class="form_table_left">
      ...
      <div class="table_LongTable">
        <table class="table_style" ID="Table2">
            <tr class="table_style_head">
                ...
                <td>
                    <a href="javascript:doOrderby('cnt')"><bean:message bundle="registersimcnt" key="cnt"/></a>
                    <s:OrderImg form="/cms/reward/registersimcnt/RegistersimcntForm" field="cnt"/>
                </td>
                <td>操作</td>
            </tr>
