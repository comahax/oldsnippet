    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function doSave() {
        	...
        	*/
        	...
        	for(var i=1;i<=rownumint;i++){
       		 ...
       		 formList.action ="<%=contextPath%>/cms/reward/creditstd.do?CMD=SAVE2&rewardtype=54&a="+a+"&slv="+<%=slv%>+"&adtypecode="+<%=adtypecode%>+"&slvlev="+<%=slvlev%>+"&id="+<%=id%>;
       		 formList.submit();
   			// }
   		 //	return false;
		}
		...
		function doShowRuleDetail(slv,slvlev,adtypecode,id){
			...
			// alert("<%=contextPath%>/cms/reward/creditstd.do?CMD=SHOWRULEDETAIL&PK="+slv+"|"+slvlev+"|"+adtypecode+"|"+54+"|"+document.getElementById(id).value);
			 formList.action ="<%=contextPath%>/cms/reward/creditstd.do?CMD=SHOWRULEDETAIL&PK="+slv+"|"+slvlev+"|"+adtypecode+"|"+54+"|"+document.getElementById(id).value;
			 formList.submit();
		}
        ...
        <table class="table_style" ID="Table2">
            ...
            <c:forEach var="item" items="${requestScope.dp.datas}" varStatus="s">
                 ...
                 <tr class="table_style_content" align="center">
                     <td>
                         <input type="checkbox" name="selectedseqs" <c:out value='${item.seq}' /> value="<c:out value='${item.seq}' />"
