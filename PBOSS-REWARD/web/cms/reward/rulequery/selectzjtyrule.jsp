...
<html>
	...
	<body onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/reward/rule2.do?CMD=SELECTZJTYRULE" styleId="formList" method="post" onsubmit="return ev_check();">
				...
				<div class="table_div">
					<table class="table_button_list">
						<tr>
							<td align=right>
								<input type="button" value="<bean:message bundle="public" key="button_search"/>" onclick="doQuery();" class="query" onmouseover="buttonover(this);" onmouseout="buttonout(this);" onfocus="buttonover(this);" onblur="buttonout(this)"  />
							</td>
						</tr>
					</table>
				</div>
