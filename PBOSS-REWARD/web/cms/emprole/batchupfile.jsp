...
<html>
	<head>
        ...
        function checkProcess(){
			...
			if(filename != null || filename != ""){
    			...
    			window.location.href="<%=contextPath%>/cms/emprole/upload.do?CMD=BATCH&filename="+filename+"&beanname=com.sunrise.boss.ui.cms.emprole.BatchEmproleTaskBean";
    		}
		}
        function getpath(){
	...
	<body  onload="if(window.loadforiframe) loadforiframe();">
		<div class="table_container">
			<html:form action="/cms/emprole/upload.do?CMD=UPLOAD" enctype="multipart/form-data" styleId="formItem">
					...
					<table class="table_button_list">
						<tr>
							...
							<input type="button" value="返回" class="button_4"
								onmouseover="buttonover(this)" onmouseout="buttonout(this)" onfocus="buttonover(this)" onblur="buttonout(this)"
								ID="buttonProcess" NAME="buttonProcess" onClick="doReturn('/cms/emprole.do?CMD=LIST')" />
							</td>
						</tr>
					</table>
				</div>
			</html:form>
			<iframe src="<%=contextPath%>/commons/batch/commonStatus.jsp?beanname=com.sunrise.boss.ui.cms.emprole.BatchEmproleTaskBean" frameborder="0" class="loadframe" id="loadframe" scrolling="no">
			</iframe>
		</div>
	</body>
</html>
