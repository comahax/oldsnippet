...
public class UIPServiceIF_CommonLogin_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public UIPServiceIF_CommonLogin_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        UIPServiceIF_CommonLogin_RequestStruct instance = new UIPServiceIF_CommonLogin_RequestStruct();
        UIPServiceIF_CommonLogin_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<4; i++) {
            ...
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new UIPServiceIF_CommonLogin_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.skywin.webserviceclients.uip.UIPServiceIF_CommonLogin_RequestStruct instance = (com.skywin.webserviceclients.uip.UIPServiceIF_CommonLogin_RequestStruct)obj;
