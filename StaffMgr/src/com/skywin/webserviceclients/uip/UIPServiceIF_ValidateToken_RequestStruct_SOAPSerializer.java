...
public class UIPServiceIF_ValidateToken_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public UIPServiceIF_ValidateToken_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        UIPServiceIF_ValidateToken_RequestStruct instance = new UIPServiceIF_ValidateToken_RequestStruct();
        UIPServiceIF_ValidateToken_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new UIPServiceIF_ValidateToken_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.skywin.webserviceclients.uip.UIPServiceIF_ValidateToken_RequestStruct instance = (com.skywin.webserviceclients.uip.UIPServiceIF_ValidateToken_RequestStruct)obj;
