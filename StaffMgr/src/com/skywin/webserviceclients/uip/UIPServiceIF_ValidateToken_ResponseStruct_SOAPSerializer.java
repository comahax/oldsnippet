...
public class UIPServiceIF_ValidateToken_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public UIPServiceIF_ValidateToken_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        UIPServiceIF_ValidateToken_ResponseStruct instance = new UIPServiceIF_ValidateToken_ResponseStruct();
        UIPServiceIF_ValidateToken_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new UIPServiceIF_ValidateToken_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.skywin.webserviceclients.uip.UIPServiceIF_ValidateToken_ResponseStruct instance = (com.skywin.webserviceclients.uip.UIPServiceIF_ValidateToken_ResponseStruct)obj;
