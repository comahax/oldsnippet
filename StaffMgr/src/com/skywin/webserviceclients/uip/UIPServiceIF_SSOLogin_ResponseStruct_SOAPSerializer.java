...
public class UIPServiceIF_SSOLogin_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public UIPServiceIF_SSOLogin_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        UIPServiceIF_SSOLogin_ResponseStruct instance = new UIPServiceIF_SSOLogin_ResponseStruct();
        UIPServiceIF_SSOLogin_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new UIPServiceIF_SSOLogin_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.skywin.webserviceclients.uip.UIPServiceIF_SSOLogin_ResponseStruct instance = (com.skywin.webserviceclients.uip.UIPServiceIF_SSOLogin_ResponseStruct)obj;
