...
public class UIPServiceIF_CommonLogin_ResponseStruct {
    private com.skywin.webserviceclients.uip.AuthResult result;
    
    public UIPServiceIF_CommonLogin_ResponseStruct() {
    }
    
    public UIPServiceIF_CommonLogin_ResponseStruct(com.skywin.webserviceclients.uip.AuthResult result) {
        this.result = result;
    }
